[
  {
    "messages": [
      ...
      [
        "¿Tienes experiencia en el trading de productos CFD? (Solo quiero asegurarme de que te den las cosas correctas. Ya sabes, materiales educativos, capacitación individual, bono de bienvenida, etc.)",
        1
      ],
      [
        "...",
  ...
  },
  {
    ...
    "messages": [
      ...
      [
        "Bien, lo primero que debes saber es que necesitas entender lo que está haciendo. La mejor manera de convertirse en un trader exitoso es tomar decisiones de mercado informadas. De esa manera, podrás disfrutar aprovechando las oportunidades de mercado en tus propios términos.",
        12
      ],
      [
        "...",
      ...
      "Antes de empezar a invertir, necesitas algunas cosas…",
      [
        "...",
        2
      ],
  ...
  },
  {
    "messages": [
      [
        "Accede a los <b>materiales educativos</b> de iFOREX para construir tu conocimiento",
        3
      ],
      [
        "...",
      ...
      [
        "<b>Entrenamiento gratuito 1-a-1</b> para un toque personal o para hacer preguntas",
        3
      ],
      [
        "...",
      ...
      "<b>Una cuenta demo sin riesgos</b> en la que puedes comenzar a practicar.",
      [
        "...",
        3
      ],
      [
        "Ten en cuenta que también obtienes un bono adicional del <b> 50% en tu depósito</b> para ser utilizado en cualquier transacción real que abras, así que tenlo en consideración.",
        5
      ],
      [
        "...",
      ...
      "Dispones de todo esto con tu paquete de depósito.<br> Espera, eso vendrá más tarde, todavía tienes algunas cosas más que aprender para operar con confianza.",
      [
        "...",
        3
      ],
  ...
  },
  {
    "messages": [
      ...
      [
        "Por lo tanto, hemos sentado las bases para su comprensión. Ahora tiene los elementos básicos sobre los que puede empezar a construir, una vez que reciba su paquete de depósito, que incluye <br><br> materiales educativos gratuitos, <br> capacitación individual 1 en 1 y una cuenta de demostración libre de riesgos MÁS un bono trading de hasta el 50% </b> en su primer depósito.",
        4
      ],
      [
        "...",
  ...
  },
  {
    "messages": [
      ...
      [
        "Debes sentirte seguro con tu bróker, así que comencemos con nuestras credenciales: somos un bróker con licencia con más de 22 años en el mercado.",
        3
      ],
      [
        "...",
      ...
      "...",
      [
        "Hasta un <b> 50% de bono trading</b> en tu primer depósito"
      ],
      "...",
      [
  ...
  },
  {
    "messages": [
      ...
      "...",
      [
        "Esto es solo el comienzo, porque con nuestro paquete de depósito, también te brindamos <b> señales de trading, una cuenta demo de 5.000 dólares para practicar,  materiales educativos para una capacitación avanzada </b> y mucho, mucho más.",
        4
      ],
      "...",
      {
  ...
  },
  {
    "messages": [
      "...",
      "¿Te gusta lo que ves? <br>Obtén nuestro kit de depósito ahora y disfruta usando la gama completa de herramientas dinámicas y características únicas disponibles en nuestra plataforma para capitalizar los mercados.",
      "...",
      {
        "blockId": 141,
        "type": "goto"
