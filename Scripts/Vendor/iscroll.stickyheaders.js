...
(function(iScroll) {
    ...
    //iscroll 5 doesn't have a checkDOMChanges option so we have to 
    //add manualy and clear the interval on destroy
    iScroll.prototype.checkDOMChanges = function () {
        var iscroll = this;
        iscroll.checkDOMTimeout = setInterval(function () {
            if(iscroll.isInTransition || iscroll.isAnimating) return;
            iscroll.refresh();
        }, 500);
    };
    ...
    iScroll.prototype.destroy = function() {
        ...
        clearInterval(this.checkDOMTimeout);
        this.checkDOMTimeout = null;
    };
