...
function ProChart_Initindicators(B){function Z(){for(var a=jQuery.extend({},null,f.objParams),c=a.id,b=e.apiinit.savedIndicatorsSetting,d=0;d<b.length;d++)if(b[d].id==c){b.splice(d,1);break}d=e.chart.StudiesById[c];d.hasOwnProperty("panel")&&(a.panel=d.panel);a.hasOwnProperty("UID")&&delete a.UID;a.hasOwnProperty("group")&&delete a.group;try{b.push(a)}catch(h){}if(typeof e.events.study.onChangeDefaultSettings==typeof Function)e.events.study.onChangeDefaultSettings(b,c)}function aa(){for(var a=f.objParams.UID,
