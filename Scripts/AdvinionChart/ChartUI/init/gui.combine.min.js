function ProChart_InitApi(q){function n(){var e=null;k(a.currenlayout)&&k(a.currenlayout.chart_panels)&&(e=a.currenlayout.chart_panels,v(e,arguments))}function p(){if(k(a.currenlayout)&&k(a.currenlayout.chart_panels))return w(a.currenlayout.chart_panels,arguments)}function v(e,c){for(var a=0;a<c.length-2;a++)e=x(c[a])?y(e,c[a]):e[c[a]];if(k(e)){var b=a=c[c.length-2];typeof a!=typeof String&&(b=a.toString());a=b.split("||");if(a instanceof Array){var f=b=c[c.length-1];typeof b!=typeof String&&(f=b.toString());
b=f.split("||");if(b instanceof Array&&a.length==b.length)for(f=0;f<a.length;f++)e[a[f]]=b[f],z(e,a[f],b[f])}else e[c[c.length-2]]=c[c.length-1],z(e,c[c.length-2],c[c.length-1])}}function w(e,a){for(var d=0;d<a.length;d++)if(x(a[d])){if(e=y(e,a[d]),null==e)return}else try{e=e[a[d]]}catch(b){return}if(k(e))return e}function z(e,c,d){if("undefined"==typeof e.fns)return null;this.objparent=e;this.objChartMain=a;for(var b=0;b<e.fns.length;b++){var f=e.fns[b];if(f.prop==c)for(var h=0;h<f.actions.length;h++){var t=
f.actions[h].replace(/%property%/g,c).replace(/%value%/g,d);try{eval(t)}catch(u){console.log(u)}}}}function k(e){return"undefined"!=typeof e&&null!=e}function x(e){var a=e.indexOf("[");e=e.indexOf("]");return-1!=a&&-1!=e&&a<e?!0:!1}function y(e,a){var d=a.indexOf("["),b=a.indexOf("]"),d=a.substring(d+1,b),b=a.replace(d,"").replace("[","").replace("]",""),f=d.split("="),d=f[0],f=f[1],b=e[b];if("undefined"!=typeof b&&null!=b&&b instanceof Array)for(var h=0;h<b.length;h++)if(b[h][d]==f)return b[h];return null}
var a=q,d={};a.api=d;d.debug={console:!1,mainlevel:0,getLogger:function(a){for(var c=0;c<d.debug.data.length;c++)if(d.debug.data[c].name==a)return d.debug.data[c];c=jQuery.extend(!0,{},A);c.name=a;d.debug.data.push(c);return c},setLevel:function(a){this.mainlevel=a},data:[],logging:{WARNING:1,ERROR:2,DEBUG:16,TIME:5,NONE:0,iNFO:3}};var A={name:"",setLevel:function(a){this.level=a},level:0,debug:function(){if(d.debug.mainlevel>=d.debug.logging.DEBUG&&this.level>=d.debug.logging.DEBUG){var a=Array.prototype.slice.call(arguments);
a.splice(0,0,"DEBUG:/"+this.name+"/>");a.push("<"+(new Date).toLocaleDateString()+" "+(new Date).toLocaleTimeString());console.log.apply(console,a)}},warn:function(a){if(d.debug.mainlevel>=d.debug.logging.WARNING&&this.level>=d.debug.logging.WARNING){var c=Array.prototype.slice.call(arguments);c.splice(0,0,"WARNING:/"+this.name+"/>");c.push("<"+(new Date).toLocaleDateString()+" "+(new Date).toLocaleTimeString());console.warn.apply(console,c)}},error:function(a){if(d.debug.mainlevel>=d.debug.logging.ERROR&&
this.level>=d.debug.logging.ERROR){var c=Array.prototype.slice.call(arguments);c.splice(0,0,"ERROR:/"+this.name+"/>");c.push("<"+(new Date).toLocaleDateString()+" "+(new Date).toLocaleTimeString());console.error.apply(console,c)}},info:function(a){if(d.debug.mainlevel>=d.debug.logging.INFO&&this.level>=d.debug.logging.INFO){var c=Array.prototype.slice.call(arguments);c.splice(0,0,"INFO:/"+this.name+"/>");c.push("<"+(new Date).toLocaleDateString()+" "+(new Date).toLocaleTimeString());console.info.apply(console,
c)}},timebegin:function(a){d.debug.mainlevel>=d.debug.logging.TIME&&this.level>=d.debug.logging.TIME&&console.time(this.name+"_",a)},timeend:function(a){d.debug.mainlevel>=d.debug.logging.TIME&&this.level>=d.debug.logging.TIME&&console.timeEnd(this.name+"_",a)}};Object.defineProperty(d,"utils",{value:{},writable:!1,configurable:!1});Object.defineProperty(d.utils,"SHA",{value:function(a){function c(a,b){return a<<b|a>>>32-b}function d(a){var b="",c,e;for(c=7;0<=c;c--)e=a>>>4*c&15,b+=e.toString(16);
return b}var b,f,h=Array(80),t=1732584193,u=4023233417,n=2562383102,p=271733878,q=3285377520,g,l,m,r,s;a=function(a){a=a.replace(/\r\n/g,"\n");for(var b="",c=0;c<a.length;c++){var e=a.charCodeAt(c);128>e?b+=String.fromCharCode(e):(127<e&&2048>e?b+=String.fromCharCode(e>>6|192):(b+=String.fromCharCode(e>>12|224),b+=String.fromCharCode(e>>6&63|128)),b+=String.fromCharCode(e&63|128))}return b}(a);g=a.length;var k=[];for(b=0;b<g-3;b+=4)f=a.charCodeAt(b)<<24|a.charCodeAt(b+1)<<16|a.charCodeAt(b+2)<<8|
a.charCodeAt(b+3),k.push(f);switch(g%4){case 0:b=2147483648;break;case 1:b=a.charCodeAt(g-1)<<24|8388608;break;case 2:b=a.charCodeAt(g-2)<<24|a.charCodeAt(g-1)<<16|32768;break;case 3:b=a.charCodeAt(g-3)<<24|a.charCodeAt(g-2)<<16|a.charCodeAt(g-1)<<8|128}for(k.push(b);14!=k.length%16;)k.push(0);k.push(g>>>29);k.push(g<<3&4294967295);for(a=0;a<k.length;a+=16){for(b=0;16>b;b++)h[b]=k[a+b];for(b=16;79>=b;b++)h[b]=c(h[b-3]^h[b-8]^h[b-14]^h[b-16],1);f=t;g=u;l=n;m=p;r=q;for(b=0;19>=b;b++)s=c(f,5)+(g&l|~g&
m)+r+h[b]+1518500249&4294967295,r=m,m=l,l=c(g,30),g=f,f=s;for(b=20;39>=b;b++)s=c(f,5)+(g^l^m)+r+h[b]+1859775393&4294967295,r=m,m=l,l=c(g,30),g=f,f=s;for(b=40;59>=b;b++)s=c(f,5)+(g&l|g&m|l&m)+r+h[b]+2400959708&4294967295,r=m,m=l,l=c(g,30),g=f,f=s;for(b=60;79>=b;b++)s=c(f,5)+(g^l^m)+r+h[b]+3395469782&4294967295,r=m,m=l,l=c(g,30),g=f,f=s;t=t+f&4294967295;u=u+g&4294967295;n=n+l&4294967295;p=p+m&4294967295;q=q+r&4294967295}s=d(t)+d(u)+d(n)+d(p)+d(q);return s.toLowerCase()},writable:!1,configurable:!1});
d.layout=ProChart_InitApitLayout(q);d.header=ProChart_InitAPIHeader(q);d.zoom=ProChart_InitAPIZoom(q);d.menu=ProChart_InitAPIMenu(q);d.toolbar=ProChart_InitAPIToolbar(q);d.panels=ProChart_InitAPIPanels(q);d.props=ProChart_InitAPIProps(q);d.localstorage=ProChart_InitApiLocalStorage(a);a.api.debug.setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.header").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.panels").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.layout").setLevel(a.api.debug.logging.NONE);
a.api.debug.getLogger("prochart.gui.zoom").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.draw").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.toolbar").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.menu").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.actions").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.community").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.messages").setLevel(a.api.debug.logging.NONE);
a.api.debug.getLogger("prochart.gui.systems").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.compare").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.trade").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.plugs").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.localization").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.indicators").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.alert").setLevel(a.api.debug.logging.NONE);
a.api.debug.getLogger("prochart.gui.msg").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.gui.patterns").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("htmldemo").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.signals.tradingcentral").setLevel(a.api.debug.logging.NONE);a.api.debug.getLogger("prochart.signals.sigmainvest").setLevel(a.api.debug.logging.NONE);d.indicators={getIndicatorObjectParams:function(e){return a.indicators.gui.getIndicatorObjectParam(e)},
add:function(e,c){a.chart.AddStudyWithParams(e,c)}};d.timeframes={getTimeframeView:function(){var e="icon";null==a.apiinit.timeframeview?"undefined"!=typeof a.currenlayout.timeframeview&&null!=a.currenlayout.timeframeview&&(e=a.currenlayout.timeframeview):e=a.apiinit.timeframeview;return e},getCaptionbyID:function(e){if("undefined"!=typeof a.gui.init.timeframe&&null!=a.gui.init.timeframe)try{for(var c=0;c<a.gui.init.timeframe.length;c++)if(a.gui.init.timeframe[c].id==e)return a.gui.init.timeframe[c].n}catch(d){return""}else if("undefined"!=
typeof a.init.timeframe&&null!=a.init.timeframe)try{for(c=0;c<a.init.timeframe.length;c++)if(a.init.timeframe[c].id==e)return a.init.timeframe[c].n}catch(b){return""}}};d.chart={set:n,get:p};d.chart.panels={price:new function(){Object.defineProperty(this,"grow",{get:function(){return p("price","grow")},set:function(a){n("price","grow",a)}});for(var a="axisy axisx main legend controlpanel zoom".split(" "),c="view width height right left top bottom".split(" "),d=0;d<a.length;d++){this[a[d]]={};Object.defineProperty(this,
a[d],{writable:!1,enumerable:!0});for(var b=0;b<c.length;b++)(function(a,b,c){Object.defineProperty(c[a],b,{get:function(){return p("price",a,b)},set:function(c){n("price",a,b,c)}})})(a[d],c[b],this)}},study:new function(){Object.defineProperty(this,"grow",{get:function(){return p("study","grow")},set:function(a){n("study","grow",a)}});for(var a=["axisy","axisx","main","legend","controlpanel"],c="view width height right left top bottom".split(" "),d=0;d<a.length;d++){this[a[d]]={};for(var b=0;b<c.length;b++)(function(a,
b,c){Object.defineProperty(c[a],b,{get:function(){return p("study",a,b)},set:function(c){n("study",a,b,c)}})})(a[d],c[b],this)}},splitterx:new function(){for(var a=["main"],c="view width height right left top bottom".split(" "),d=0;d<a.length;d++){this[a[d]]={};for(var b=0;b<c.length;b++)(function(a,b,c){Object.defineProperty(c[a],b,{get:function(){return p("splitterx",a,b)},set:function(c){n("splitterx",a,b,c)}})})(a[d],c[b],this)}},plugin:new function(){Object.defineProperty(this,"grow",{get:function(){return p("signal",
"grow")},set:function(a){n("signal","grow",a)}});for(var a=["main","legend","controlpanel","alert"],c="view width height right left top bottom".split(" "),d=0;d<a.length;d++){this[a[d]]={};for(var b=0;b<c.length;b++)(function(a,b,c){Object.defineProperty(c[a],b,{get:function(){return p("signal",a,b)},set:function(c){n("signal",a,b,c)}})})(a[d],c[b],this)}},set:n,get:p};d.zoom={set:function(){var d=null;k(a.currenlayout.zooms)&&(d=a.currenlayout,v(d,arguments))},get:function(){if(k(a.currenlayout.zooms))return w(a.currenlayout,
arguments)}};d.localization={changeLang:function(d){try{return"undefined"!=typeof a.localizationobj?a.localizationobj.gui.changeLocalization(d):null}catch(c){return null}},getCurrentLanguageObj:function(){try{return"undefined"!=typeof a.localizationobj?a.localizationobj.gui.returnCurrentLanguage():null}catch(d){return null}}};d.plugin={};return d};
...
studies:{visible:null},compares:{visible:null},localization:{visible:null},help:{visible:null,functionhelp:null},about:{visible:null}},toolbar:{visible:null,charttype:{visible:null},timeframe:{visible:null},systems:{visible:null},other:{visible:null}},zoom:{visible:null,zoomtoolbar:{visible:null}}};b.guiinit={rootpath:"",rootpathRelative:"",onlyliteload:!1,trade:!0,menu:!0,toolbaradv:!0,zoom:!0,system:!0,draw:!0,color:!0,header:!0,alert:!1,msg:!1,community:!0,compare:!0,messages:!0,signals:!0,indicators:!0,
props:!0,minifier:!1,cache:!0,plugs:!0,customLayoutFile:"",customPanelPatternFile:"",customHeaderPatternFile:"",customMenuPatternFile:"",customToolbarPatternFile:"",customZoomPatternFile:"",customTemplateFile:"",customJsonCssFile:"",customSVGSpriteFile:"",parentRelativeObjectID:null,timeupdateVersiongui:"",patterncombine:!0,layout:{timeframeview:null}};b.gui.fullscreensize={fullscreenstatus:!1,mainWidth:null,mainHeight:null,width:null,height:null,autoInnerWidth:!0,autoInnerHeight:!0,zoomWidth:null,
fixedSize:!0};b.gui.fullpagesize={fullpagestatus:!1,mainWidth:null,mainHeight:null,width:null,height:null,autoInnerWidth:!0,autoInnerHeight:!0,zoomWidth:null,fixedSize:!0,parentObject:null,fullpageHideScroll:!0};b.gui.init={majors:null,majors2:null,compares:null,timeframe:null,autotimescale:null,localization:null,localizationlang:null,charttype:null,indicators:null,signals:null,comparecharttype:null,StudiesToLoad:[],savedIndicatorsSetting:[]};c.main={set guirootpath(a){b.guiinit.rootpath=a},get guirootpath(){return b.guiinit.rootpath},
...
get:function(){return c.chart.price[a].radius}}})}var b=h,e={};Object.defineProperty(e,"design",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.design,"setStyle",{value:function(a,c){var e=b.chart.GetRecentStyleObject();return Object.setProchartByString(e,a,c)?(b.chart.SetStyleObject(e),!0):!1},writable:!1,configurable:!1});Object.defineProperty(e.design,"getStyle",{value:function(a,c){var e=b.chart.GetRecentStyleObject();return Object.getProchartByString(e,a)},writable:!1,configurable:!1});
Object.defineProperty(e,"alerts",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.alerts,"news",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.alerts,"candlestick_patterns",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.alerts,"events",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.alerts,"splits",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.alerts,"dividens",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.alerts,
"gui",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.alerts,"alertselected",{value:{},writable:!1,configurable:!1});var m="color background_color font_size symbol border_color border_width".split(" "),c={alerts:{alertselected:{},news:{},candlestick_patterns:{},events:{},splits:{},dividens:{},gui:{}}};Object.defineProperty(e,"chart",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart,"price",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.price,
"candlesticks",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.price,"hollowcandlesticks",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.price,"heikinashi",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.price,"ohlc",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.price,"hlc",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.price,"line",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.price,
"area",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.price,"dots",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.price,"histogram",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.price,"columns",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.price,"linedots",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart,"gui",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.gui,
"legend",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.gui,"grid",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.gui,"watermark",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.gui,"zoom",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.gui,"favorites",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.chart.gui,"layout",{value:{},writable:!1,configurable:!1});Object.defineProperty(e,"func",{value:{},
writable:!1,configurable:!1});Object.defineProperty(e.func,"chart",{value:{},writable:!1,configurable:!1});Object.defineProperty(e.func,"layout",{value:{},writable:!1,configurable:!1});e.func.chart.updateFromInit=function(a){l=Object.getOwnPropertyNames(c.chart.price);for(var d=0;d<l.length;d++){f=l[d];for(var g=Object.getOwnPropertyNames(c.chart.price[f]),h=0;h<g.length;h++){var k=g[h];switch(k){case "up_fill":try{a.price[f].up.fill=e.chart.price[f].up_fill}catch(m){}break;case "up_stroke":try{a.price[f].up.stroke=
e.chart.price[f].up_stroke}catch(n){}break;case "down_fill":try{a.price[f].down.fill=e.chart.price[f].down_fill}catch(p){}break;case "down_stroke":try{a.price[f].down.stroke=e.chart.price[f].down_stroke}catch(q){}break;case "flat_fill":try{a.price[f].flat.fill=e.chart.price[f].flat_fill}catch(r){}break;case "flat_stroke":try{a.price[f].flat.stroke=e.chart.price[f].flat_stroke}catch(s){}break;case "wick_stroke":try{a.price[f].wick.stroke=e.chart.price[f].wick_stroke}catch(t){}break;case "wick_visible":try{a.price[f].wick.visible=
e.chart.price[f].wick_visible}catch(u){}break;default:try{a.price[f][k]=e.chart.price[f][k]}catch(v){}}}}d=Object.getOwnPropertyNames(c.chart.gui.watermark);for(g=0;g<d.length;g++)switch(d[g]){case "view":try{"undefined"!=typeof e.chart.gui.watermark.view&&(b.chart.WaterMark=e.chart.gui.watermark.view)}catch(w){}break;case "font_fill":try{a.Screenshot.watermark.fontFill=e.chart.gui.watermark.font_fill}catch(x){}break;case "font_stroke":try{a.Screenshot.watermark.fontStroke=e.chart.gui.watermark.font_stroke}catch(y){}break;
case "font_name":try{a.Screenshot.watermark.fontName=e.chart.gui.watermark.font_name}catch(z){}break;case "min_font_size":try{a.Screenshot.watermark.minFontSize=e.chart.gui.watermark.min_font_size}catch(A){}break;case "max_font_size":try{a.Screenshot.watermark.maxFontSize=e.chart.gui.watermark.max_font_size}catch(B){}}d=Object.getOwnPropertyNames(c.chart.gui.grid);for(g=0;g<d.length;g++)switch(d[g]){case "vertical_stroke":try{a.AdvGridV.stroke=e.chart.gui.grid.vertical_stroke}catch(C){}break;case "vertical_stroke_width":try{a.AdvGridV.strokeWidth=
e.chart.gui.grid.vertical_stroke_width}catch(D){}break;case "horizontal_stroke":try{a.AdvGridH.stroke=e.chart.gui.grid.horizontal_stroke_width}catch(E){}break;case "horizontal_stroke_width":try{a.AdvGridH.strokeWidth=e.chart.gui.grid.background}catch(F){}break;case "background":try{a.Screenshot.background=e.chart.gui.grid.background}catch(G){}}d=Object.getOwnPropertyNames(c.chart.gui.zoom);for(g=0;g<d.length;g++)switch(d[g]){case "padding_left":try{a.zoomWidget.left=e.chart.gui.zoom.padding_left}catch(H){}break;
case "padding_right":try{a.zoomWidget.right=e.chart.gui.zoom.padding_right}catch(I){}break;case "handle_padding_top":try{a.zoomWidget.handle.radius=e.chart.gui.zoom.handle_padding_top}catch(J){}break;case "handle_padding_bottom":try{a.zzoomWidget.handle.bottom=e.chart.gui.zoom.handle_padding_bottom}catch(K){}break;case "handle_width":try{a.zoomWidget.handle.width=e.chart.gui.zoom.handle_width}catch(L){}break;case "handle_line_width":try{a.zoomWidget.handle.lineWidth=e.chart.gui.zoom.handle_line_width}catch(M){}break;
case " handle_fill":try{a.zoomWidget.handle.fill=e.chart.gui.zoom.handle_fill}catch(N){}break;case "handle_stroke":try{a.zoomWidget.handle.stroke=e.chart.gui.zoom.handle_stroke}catch(O){}break;case "filter_line_width":try{a.zoomWidget.filter.lineWidth=e.chart.gui.zoom.filter_line_width}catch(P){}break;case "filter_fill":try{a.zoomWidget.filter.fill=e.chart.gui.zoom.filter_fill}catch(Q){}break;case "filter_stroke":try{a.zoomWidget.filter.stroke=e.chart.gui.zoom.filter_stroke}catch(R){}break;case "chart_stroke":try{a.zoomWidget.chart.stroke=
e.chart.gui.zoom.chart_stroke}catch(S){}break;case "chart_line_width":try{a.zoomWidget.chart.lineWidth=e.chart.gui.zoom.handle_line_width}catch(T){}break;case "chart_fill":try{a.zoomWidget.chart.fill=e.chart.gui.zoom.chart_fill}catch(U){}break;case "chart_future_stroke":try{a.zoomWidget.chart.future.stroke=e.chart.gui.zoom.chart_future_stroke}catch(V){}}return a};e.func.chart.createComplete=function(){b.chart.vAxis.vPadInPixelsTopStudy=20;b.chart.vAxis.vPadInPixelsBottomStudy=10};e.func.layout.initComplete=
function(){try{b.chart.UseCorePadding=!0,b.chart.vAxis.vPadInPixelsTopStudy=20,b.chart.vAxis.vPadInPixelsBottomStudy=10,b.chart.NumVisibleBars=50,b.chart.NumOfDefaultVisibleFutureBars=2}catch(a){}};Object.defineProperties(e.alerts.gui,{alert_size:{set:function(a){c.alerts.gui.alert_size=a;"undefined"!=typeof b.alertobj&&b.alertobj.gui.refreshAlerts()},get:function(){return c.alerts.gui.alert_size}},top_padding:{set:function(a){c.alerts.gui.top_padding=a;"undefined"!=typeof b.alertobj&&b.alertobj.gui.refreshAlerts()},
get:function(){return c.alerts.gui.top_padding}},font_size:{set:function(a){c.alerts.gui.font_size=a;c.alerts.news.font_size=a;c.alerts.candlestick_patterns.font_size=a;c.alerts.events.font_size=a;c.alerts.splits.font_size=a;c.alerts.dividens.font_size=a;"undefined"!=typeof b.alertobj&&b.alertobj.gui.refreshAlerts()},get:function(){return c.alerts.gui.font_size}},font_bold:{set:function(a){c.alerts.gui.font_bold=a;c.alerts.news.font_bold=a;c.alerts.candlestick_patterns.font_bold=a;c.alerts.events.font_bold=
a;c.alerts.splits.font_bold=a;c.alerts.dividens.font_bold=a;"undefined"!=typeof b.alertobj&&b.alertobj.gui.refreshAlerts()},get:function(){return c.alerts.gui.font_bold}},border_width:{set:function(a){c.alerts.gui.border_width=a;c.alerts.news.border_width=a;c.alerts.candlestick_patterns.border_width=a;c.alerts.events.border_width=a;c.alerts.splits.border_width=a;c.alerts.dividens.border_width=a;"undefined"!=typeof b.alertobj&&b.alertobj.gui.refreshAlerts()},get:function(){return c.alerts.gui.border_width}},
shadow_color:{set:function(a){c.alerts.gui.shadow_color=a;b.alertobj&&b.alertobj.gui.refreshAlerts()},get:function(){return c.alerts.gui.shadow_color}},shadow_blur:{set:function(a){c.alerts.gui.shadow_blur=a;b.alertobj&&b.alertobj.gui.refreshAlerts()},get:function(){return c.alerts.gui.shadow_blur}},shadow_offset_x:{set:function(a){c.alerts.gui.shadow_offset_x=a;b.alertobj&&b.alertobj.gui.refreshAlerts()},get:function(){return c.alerts.gui.shadow_offset_x}},shadow_offset_y:{set:function(a){c.alerts.gui.shadow_offset_y=
a;b.alertobj&&b.alertobj.gui.refreshAlerts()},get:function(){return c.alerts.gui.shadow_offset_y}}});h="news candlestick_patterns events splits dividens alertselected".split(" ");for(var k=0;k<h.length;k++)n(h[k]);c.chart={price:{candlesticks:{},hollowcandlesticks:{},heikinashi:{},ohlc:{},hlc:{},line:{},area:{},dots:{},histogram:{},columns:{},linedots:{}},gui:{legend:{font_darklight_percent:0,font_darklight_auto:!1},grid:{},watermark:{},zoom:{},favorites:{},layout:{}}};var l=Object.getOwnPropertyNames(c.chart.price);
for(h=0;h<l.length;h++){var f=l[h];p(f)}Object.defineProperties(e.chart.gui.legend,{font_darklight_percent:{set:function(a){c.chart.gui.legend.font_darklight_percent=a},get:function(){return c.chart.gui.legend.font_darklight_percent}},font_darklight_auto:{set:function(a){c.chart.gui.legend.font_darklight_auto=a},get:function(){return c.chart.gui.legend.font_darklight_auto}}});Object.defineProperties(e.chart.gui.grid,{vertical_stroke:{set:function(a){c.chart.gui.grid.vertical_stroke=a;if(b.chart){var d=
b.chart.GetRecentStyleObject();d.AdvGridV.stroke=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.grid.vertical_stroke}},vertical_stroke_width:{set:function(a){c.chart.gui.grid.vertical_stroke_width=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.AdvGridV.strokeWidth=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.grid.vertical_stroke_width}},horizontal_stroke:{set:function(a){c.chart.gui.grid.horizontal_stroke=a;if(b.chart){var d=b.chart.GetRecentStyleObject();
d.AdvGridH.stroke=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.grid.horizontal_stroke=value}},horizontal_stroke_width:{set:function(a){c.chart.gui.grid.horizontal_stroke_width=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.AdvGridH.strokeWidth=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.grid.horizontal_stroke_width}},background:{set:function(a){c.chart.gui.grid.background=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.Screenshot.background=a;b.chart.SetStyleObject(d)}},
get:function(){return c.chart.gui.grid.background}}});Object.defineProperties(e.chart.gui.watermark,{view:{set:function(a){c.chart.gui.watermark.view=a;b.chart&&(a=b.chart.GetRecentStyleObject(),c.chart.gui.watermark.view?(c.chart.gui.watermark.font_fill||(c.chart.gui.watermark.font_fill=a.Screenshot.watermark.fontFill),c.chart.gui.watermark.font_stroke||(c.chart.gui.watermark.font_stroke=a.Screenshot.watermark.fontStroke),a.Screenshot.watermark.fontFill=c.chart.gui.watermark.font_fill,a.Screenshot.watermark.fontStroke=
c.chart.gui.watermark.font_stroke,b.chart.WaterMark=!0):(c.chart.gui.watermark.font_fill||(c.chart.gui.watermark.font_fill=a.Screenshot.watermark.fontFill),c.chart.gui.watermark.font_stroke||(c.chart.gui.watermark.font_stroke=a.Screenshot.watermark.fontStroke),a.Screenshot.watermark.fontFill="rgba(0,0,0,0)",a.Screenshot.watermark.fontStroke="rgba(0,0,0,0)",b.chart.WaterMark=!1),b.chart.SetStyleObject(a))},get:function(){return c.chart.gui.watermark.view}},font_fill:{set:function(a){c.chart.gui.watermark.font_fill=
a;if(b.chart){var d=b.chart.GetRecentStyleObject();c.chart.gui.watermark.view&&(d.Screenshot.watermark.fontFill=a);b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.watermark.font_fill}},font_stroke:{set:function(a){c.chart.gui.watermark.font_stroke=a;if(b.chart){var d=b.chart.GetRecentStyleObject();c.chart.gui.watermark.view&&(d.Screenshot.watermark.fontStroke=a);b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.watermark.fontStroke}},font_name:{set:function(a){c.chart.gui.watermark.font_name=
a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.Screenshot.watermark.fontName=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.watermark.font_name}},min_font_size:{set:function(a){c.chart.gui.watermark.min_font_size=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.Screenshot.watermark.minFontSize=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.watermark.min_font_size}},max_font_size:{set:function(a){c.chart.gui.watermark.max_font_size=a;if(b.chart){var d=b.chart.GetRecentStyleObject();
d.Screenshot.watermark.maxFontSize=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.watermark.max_font_size}}});Object.defineProperties(e.chart.gui.zoom,{padding_left:{set:function(a){c.chart.gui.zoom.padding_left=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.zoomWidget.left=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.padding_left}},padding_right:{set:function(a){c.chart.gui.zoom.padding_right=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.zoomWidget.right=
a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.padding_right}},handle_radius:{set:function(a){c.chart.gui.zoom.handle_radius=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.zoomWidget.handle.radius=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.handle_radius}},handle_padding_top:{set:function(a){c.chart.gui.zoom.handle_padding_top=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.zoomWidget.handle.top=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.handle_padding_top}},
handle_padding_bottom:{set:function(a){c.chart.gui.zoom.handle_padding_bottom=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.zoomWidget.handle.bottom=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.handle_padding_bottom}},handle_width:{set:function(a){c.chart.gui.zoom.handle_width=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.zoomWidget.handle.width=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.handle_width}},handle_line_width:{set:function(a){c.chart.gui.zoom.handle_line_width=
a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.zoomWidget.handle.lineWidth=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.handle_line_width}},handle_fill:{set:function(a){c.chart.gui.zoom.handle_fill=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.zoomWidget.handle.fill=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.handle_fill}},handle_stroke:{set:function(a){c.chart.gui.zoom.handle_stroke=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.zoomWidget.handle.stroke=
a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.handle_stroke}},filter_line_width:{set:function(a){c.chart.gui.zoom.filter_line_width=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.zoomWidget.filter.lineWidth=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.filter_line_width}},filter_fill:{set:function(a){c.chart.gui.zoom.filter_fill=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.zoomWidget.filter.fill=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.filter_fill}},
filter_stroke:{set:function(a){c.chart.gui.zoom.filter_stroke=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.zoomWidget.filter.stroke=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.filter_stroke}},chart_stroke:{set:function(a){c.chart.gui.zoom.chart_stroke=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.zoomWidget.chart.stroke=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.chart_stroke}},chart_line_width:{set:function(a){c.chart.gui.zoom.chart_line_width=
a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.zoomWidget.chart.lineWidth=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.chart_line_width}},chart_fill:{set:function(a){c.chart.gui.zoom.chart_fill=a;if(b.chart){var d=b.chart.GetRecentStyleObject();d.zoomWidget.chart.fill=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.chart_fill}},chart_future_stroke:{set:function(a){c.chart.gui.zoom.chart_future_stroke=a;if(b.chart){var d=b.chart.GetRecentStyleObject();
d.zoomWidget.chart.future.stroke=a;b.chart.SetStyleObject(d)}},get:function(){return c.chart.gui.zoom.chart_future_stroke}},interval_font_color:{set:function(a){c.chart.gui.zoom.interval_font_color=a;b.panels&&b.panels.gui.drawZoomIntervale()},get:function(){return c.chart.gui.zoom.interval_font_color}},interval_font_padding:{set:function(a){c.chart.gui.zoom.interval_font_padding=a;b.panels&&b.panels.gui.drawZoomIntervale()},get:function(){return c.chart.gui.zoom.interval_font_padding}},interval_font_size:{set:function(a){c.chart.gui.zoom.interval_font_size=
a;b.panels&&b.panels.gui.drawZoomIntervale()},get:function(){return c.chart.gui.zoom.interval_font_size}},interval_font_bold:{set:function(a){c.chart.gui.zoom.interval_font_bold=a;b.panels&&b.panels.gui.drawZoomIntervale()},get:function(){return c.chart.gui.zoom.interval_font_bold}}});Object.defineProperties(e.chart.gui.favorites,{indicators:{set:function(a){b.apiinit.timeframe=a;b.chart&&("undefined"!=typeof b.init&&b.init.gui.indicatorsUpdate(a),"undefined"!=typeof b.menuobj&&b.menuobj.gui.updateIndicatorFavorites())},
get:function(){return b.gui.init.timeframe}},majors:{set:function(a){b.apiinit.majors=a;b.chart&&("undefined"!=typeof b.init&&b.init.gui.majorsUpdate(a),"undefined"!=typeof b.menuobj&&b.menuobj.gui.updateMajorFavorites())},get:function(){return b.gui.init.majors}},compares:{set:function(a){b.apiinit.compares=a;b.chart&&("undefined"!=typeof b.init&&b.init.gui.compareUpdate(a),"undefined"!=typeof b.menuobj&&b.menuobj.gui.updateCompareFavorites())},get:function(){return b.gui.init.majors}},charttypes:{set:function(a){b.apiinit.charttypes=
a;b.chart&&("undefined"!=typeof b.menuobj&&b.menuobj.gui.changeTypeChartFavoritesStar(a),"undefined"!=typeof b.toolbaradvobj&&b.toolbaradvobj.gui.viewTypeChartButtons(a))},get:function(){return b.gui.init.charttypes}},timeframes:{set:function(a){b.apiinit.timeframe=a;b.chart&&("undefined"!=typeof b.toolbaradvobj&&b.toolbaradvobj.gui.viewTimeFrameButtons(a),"undefined"!=typeof b.menuobj&&b.menuobj.gui.updateTimesScale())},get:function(){return b.gui.init.timeframe}}});Object.defineProperties(e.chart.gui.layout,
{zindex:{set:function(a){c.chart.gui.layout.zindex=a},get:function(){return"undefined"!=typeof c.chart.gui.layout.zindex?c.chart.gui.layout.zindex:0}},zindex_fullpage:{set:function(a){c.chart.gui.layout.zindex_fullpage=a},get:function(){return"undefined"!=typeof c.chart.gui.layout.zindex_fullpage?c.chart.gui.layout.zindex_fullpage:1E4}},zindex_dialog:{set:function(a){c.chart.gui.layout.zindex_dialog=a},get:function(){return"undefined"!=typeof c.chart.gui.layout.zindex_dialog?c.chart.gui.layout.zindex_dialog:
e.chart.gui.layout.zindex_fullpage+1}},move_left_fullpage:{set:function(a){c.chart.gui.layout.move_left_fullpage=a},get:function(){return"undefined"!=typeof c.chart.gui.layout.move_left_fullpage?c.chart.gui.layout.move_left_fullpage:5}},move_right_fullpage:{set:function(a){c.chart.gui.layout.move_right_fullpage=a},get:function(){return"undefined"!=typeof c.chart.gui.layout.move_right_fullpage?c.chart.gui.layout.move_right_fullpage:5}},move_top_fullpage:{set:function(a){c.chart.gui.layout.move_top_fullpage=
a},get:function(){return"undefined"!=typeof c.chart.gui.layout.move_top_fullpage?c.chart.gui.layout.move_top_fullpage:5}},move_bottom_fullpage:{set:function(a){c.chart.gui.layout.move_bottom_fullpage=a},get:function(){return"undefined"!=typeof c.chart.gui.layout.move_bottom_fullpage?c.chart.gui.layout.move_bottom_fullpage:5}},background_color_fullpage:{set:function(a){c.chart.gui.layout.background_color_fullpage=a},get:function(){return"undefined"!=typeof c.chart.gui.layout.background_color_fullpage?
c.chart.gui.layout.background_color_fullpage:"#ffffff"}},move_left_backgroundfullpage:{set:function(a){c.chart.gui.layout.move_left_backgroundfullpage=a},get:function(){return"undefined"!=typeof c.chart.gui.layout.move_left_backgroundfullpage?c.chart.gui.layout.move_left_backgroundfullpage:0}},move_right_backgroundfullpage:{set:function(a){c.chart.gui.layout.move_right_backgroundfullpage=a},get:function(){return"undefined"!=typeof c.chart.gui.layout.move_right_backgroundfullpage?c.chart.gui.layout.move_right_backgroundfullpage:
0}},move_top_backgroundfullpage:{set:function(a){c.chart.gui.layout.move_top_backgroundfullpage=a},get:function(){return"undefined"!=typeof c.chart.gui.layout.move_top_backgroundfullpage?c.chart.gui.layout.move_top_backgroundfullpage:0}},move_bottom_backgroundfullpage:{set:function(a){c.chart.gui.layout.move_bottom_backgroundfullpage=a},get:function(){return"undefined"!=typeof c.chart.gui.layout.move_bottom_backgroundfullpage?c.chart.gui.layout.move_bottom_backgroundfullpage:0}},fullpage:{set:function(a){c.chart.gui.layout.fullpage=
a;b.gui&&b.gui.fullScreen(a)},get:function(){return b.currenlayout.workmode.fullscreen}},alwaysfullscreen:{set:function(a){b.currenlayout.workmode&&(b.currenlayout.workmode.alwaysfullscreen=a)},get:function(){return b.currenlayout.workmode.alwaysfullscreen}}});e.alerts.news.place="alertbar";e.alerts.candlestick_patterns.place="price";e.alerts.events.place="alertbar";e.alerts.splits.place="alertbar";e.alerts.dividens.place="alertbar";e.alerts.splits.place="price";e.alerts.gui.shadow_color="rgba(0,0,0,0.3)";
e.alerts.gui.shadow_blur=3;e.alerts.gui.shadow_offset_x=2;e.alerts.gui.shadow_offset_y=2;e.chart.gui.zoom.interval_font_bold=!0;e.chart.gui.legend.font_darklight_auto=!0;e.chart.gui.legend.font_darklight_percent=-20;e.alerts.fonts_bold=!0;return e};
function ProChart_InitApiLocalStorage(k){function f(a){if(!a.module||!a.key)return!1;b[a.module]||Object.defineProperty(b,a.module,{value:{},writable:!1,configurable:!1});"undefined"==typeof b[a.module][a.key]&&Object.defineProperty(b[a.module],a.key,{get:function(){var c="storage_"+a.key;if(!this[c]){var e=localStorage[b.key+"-"+a.module+"-"+a.key];this[c]=e?JSON.parse(e):null}return this[c]},set:function(c){var e=b.key+"-"+a.module+"-"+a.key;this["storage_"+a.key]=c;localStorage[e]=JSON.stringify(c)}});
return!0}function g(a,d){try{c.gui.localstorage_condition.pricestyle&&(localStorage[b.localstorage.key+a]=JSON.stringify(d))}catch(e){}}function h(a){try{if(c.gui.localstorage_condition.pricestyle&&"undefined"!=typeof localStorage[b.localstorage.key+a])return JSON.parse(localStorage[b.localstorage.key+a])}catch(d){return null}}var c=k,b={};c.api.localstorage=b;b={getPriceType:function(){try{if(c.gui.localstorage_condition.pricetype&&"undefined"!=typeof localStorage[b.localstorage.key+"pricetype"])return localStorage[b.localstorage.key+
"pricetype"]}catch(a){}return null},setPriceType:function(a){try{c.gui.localstorage_condition.pricetype&&(localStorage[b.localstorage.key+"pricetype"]=a)}catch(d){}return null},getPriceStyle:h,setPriceStyle:g,getPriceLine:function(){try{if(c.gui.localstorage_condition.priceline&&"undefined"!=typeof localStorage[b.localstorage.key+"priceline"])return localStorage[b.localstorage.key+"priceline"]}catch(a){}return null},setPriceLine:function(a){try{c.gui.localstorage_condition.priceline&&(localStorage[b.localstorage.key+
"priceline"]=a)}catch(d){}return null},getVolumeStyle:h,setVolumeStyle:g,getMajorsFavorites:function(){try{if(c.gui.localstorage_condition.majorsfavorites&&"undefined"!=typeof localStorage[b.localstorage.key+"majorsfavorites"])return JSON.parse(localStorage[b.localstorage.key+"majorsfavorites"])}catch(a){}return null},setMajorsFavorites:function(a){try{c.gui.localstorage_condition.majorsfavorites&&(localStorage[b.localstorage.key+"majorsfavorites"]=JSON.stringify(a))}catch(d){}},getCompareFavorites:function(){try{if(c.gui.localstorage_condition.comparefavorites&&
"undefined"!=typeof localStorage[b.localstorage.key+"comparefavorites"])return JSON.parse(localStorage[b.localstorage.key+"comparefavorites"])}catch(a){}return null},setCompareFavorites:function(a){try{c.gui.localstorage_condition.comparefavorites&&(localStorage[b.localstorage.key+"comparefavorites"]=JSON.stringify(a))}catch(d){}},getIndicatorsFavorites:function(){try{if(c.gui.localstorage_condition.indicatorsfavorites&&"undefined"!=typeof localStorage[b.localstorage.key+"indicatorsfavorites"])return JSON.parse(localStorage[b.localstorage.key+
"indicatorsfavorites"])}catch(a){}return null},setIndicatorsFavorites:function(a){try{c.gui.localstorage_condition.indicatorsfavorites&&(localStorage[b.localstorage.key+"indicatorsfavorites"]=JSON.stringify(a))}catch(d){}},getTimeFrameFavorites:function(){try{if(c.gui.localstorage_condition.timeframefavorites&&"undefined"!=typeof localStorage[b.localstorage.key+"timeframefavorites"])return JSON.parse(localStorage[b.localstorage.key+"timeframefavorites"])}catch(a){}return null},setTimeFrameFavorites:function(a){try{c.gui.localstorage_condition.timeframefavorites&&
(localStorage[b.localstorage.key+"timeframefavorites"]=JSON.stringify(a))}catch(d){}},getPriceTypeFavorites:function(){try{if(c.gui.localstorage_condition.pricetypefavorites&&"undefined"!=typeof localStorage[b.localstorage.key+"pricetypefavorites"])return JSON.parse(localStorage[b.localstorage.key+"pricetypefavorites"])}catch(a){}return null},setPriceTypeFavorites:function(a){try{c.gui.localstorage_condition.pricetypefavorites&&(localStorage[b.localstorage.key+"pricetypefavorites"]=JSON.stringify(a))}catch(d){}},
getDrawStyle:function(){},setDrawStyle:function(a){},clear:function(){for(var a=b.localstorage.key,c=0;c<b.localstorage_condition.save_list_name.length;c++)try{localStorage.removeItem(a+b.localstorage_condition.save_list_name[c])}catch(e){}},clearAll:function(){try{localStorage.clear()}catch(a){}}};Object.defineProperty(b,"localstorage",{value:{},writable:!1,configurable:!1});Object.defineProperty(b,"key",{get:function(){this.storage_key||(this.storage_key=c.api.utils.SHA(c.parent));return this.storage_key}});
Object.defineProperty(b,"readValue",{value:function(a){if(f(a))return b[a.module][a.key]},writable:!1,configurable:!1});Object.defineProperty(b,"saveValue",{value:function(a){f(a)&&(b[a.module][a.key]=a.value)},writable:!1,configurable:!1});b.localstorage_condition={save_list_name:"pricestyle indicatorsfavorites drawstyle timeframefavorites pricetypefavorites volumestyle pricetype majorsfavorites comparefavorites".split(" ")};Object.defineProperty(b.localstorage_condition,"pricestyle",{get:function(){return c.gui.localstorage_condition.pricestyle},
set:function(a){c.gui.localstorage_condition.pricestyle=a}});Object.defineProperty(b.localstorage_condition,"volumestyle",{get:function(){return c.gui.localstorage_condition.volumestyle},set:function(a){c.gui.localstorage_condition.volumestyle=a}});Object.defineProperty(b.localstorage_condition,"pricetype",{get:function(){return c.gui.localstorage_condition.pricetype},set:function(a){c.gui.localstorage_condition.pricetype=a}});Object.defineProperty(b.localstorage_condition,"majorsfavorites",{get:function(){return c.gui.localstorage_condition.majorsfavorites},
set:function(a){c.gui.localstorage_condition.majorsfavorites=a}});Object.defineProperty(b.localstorage_condition,"comparefavorites",{get:function(){return c.gui.localstorage_condition.comparefavorites},set:function(a){c.gui.localstorage_condition.comparefavorites=a}});Object.defineProperty(b.localstorage_condition,"indicatorsfavorites",{get:function(){return c.gui.localstorage_condition.indicatorsfavorites},set:function(a){c.gui.localstorage_condition.indicatorsfavorites=a}});Object.defineProperty(b.localstorage_condition,
"drawstyle",{get:function(){return c.gui.localstorage_condition.drawstyle},set:function(a){c.gui.localstorage_condition.drawstyle=a}});Object.defineProperty(b.localstorage_condition,"timeframefavorites",{get:function(){return c.gui.localstorage_condition.timeframefavorites},set:function(a){c.gui.localstorage_condition.timeframefavorites=a}});Object.defineProperty(b.localstorage_condition,"pricetypefavorites",{get:function(){return c.gui.localstorage_condition.pricetypefavorites},set:function(a){c.gui.localstorage_condition.pricetypefavorites=
a}});Object.defineProperty(b.localstorage_condition,"priceline",{get:function(){return c.gui.localstorage_condition.priceline},set:function(a){c.gui.localstorage_condition.priceline=a}});Object.defineProperty(b.localstorage,"key",{get:function(){return c.gui.localstorage_condition.storage_key},set:function(a){c.gui.localstorage_condition.storage_key=a}});return b};
(function(){if(!window.ProchartGlobalApi){var f={};Object.defineProperty(f,"showhide",{value:g,writable:!1,configurable:!1});var g=function(c){var a="";c.id&&(a="#"+c.id);(c=$(a))&&("none"==c.css("display")?c.css("display","block"):c.css("display","none"))};window.ProchartGlobalApi=f;Object.setProchartByString||(Object.setProchartByString=function(c,a,d){a=a.replace(/\[(\w+)\]/g,".$1");a=a.replace(/^\./,"");a=a.split(".");for(var b=0;b<a.length;b++){var e=a[b];switch(b){case 0:if(!(e in c))return!1;
if(a.length-1==b)return c[a[b]]=d,!0;break;case 1:if(!(e in c[a[b-1]]))return!1;if(a.length-1==b)return c[a[b-1]][a[b]]=d,!0;break;case 3:if(!(e in c[a[b-2]][a[b-1]]))return!1;if(a.length-1==b)return c[a[b-2]][a[b-1]][a[b]]=d,!0;break;case 4:if(!(e in c[a[b-2]][a[b-2]][a[b-1]]))return!1;if(a.length-1==b)return c[a[b-3]][a[b-2]][a[b-1]][a[b]]=d,!0}}return!1});Object.getProchartByString||(Object.getProchartByString=function(c,a){a=a.replace(/\[(\w+)\]/g,".$1");a=a.replace(/^\./,"");for(var d=a.split("."),
b=0,e=d.length;b<e;++b){var f=d[b];if(f in c)c=c[f];else return}return c})}})();
...
function ProChart_InitAPIToolbar(e){function h(a,b,c){if("undefined"==typeof a.fns)return null;this.objparent=a;this.objChartMain=f;for(var d=0;d<a.fns.length;d++){var e=a.fns[d];if(e.prop==b)for(var k=0;k<e.actions.length;k++){var g=e.actions[k].replace(/%property%/g,b).replace(/%value%/g,c);try{eval(g)}catch(h){console.log(h)}}}}function g(a){return"undefined"!=typeof a&&null!=a}function l(a){var b=a.indexOf("[");a=a.indexOf("]");return-1!=b&&-1!=a&&b<a?!0:!1}function m(a,b){var c=b.indexOf("["),
d=b.indexOf("]"),c=b.substring(c+1,d),d=b.replace(c,"").replace("[","").replace("]",""),e=c.split("="),c=e[0],e=e[1],d=a[d];if("undefined"!=typeof d&&null!=d&&d instanceof Array)for(var f=0;f<d.length;f++)if(d[f][c]==e)return d[f];return null}var f=e;e={changeIcon:function(a,b){"undefined"!=typeof f.toolbaradvobj&&f.toolbaradvobj.gui.changeIcon(a,b)},changeDatalocalize:function(a,b){"undefined"!=typeof f.toolbaradvobj&&f.toolbaradvobj.gui.changeDatalocalize(a,b)},set:function(){var a=null;if(g(f.currenlayout.toolbars)){for(var a=
f.currenlayout,b=arguments,c=0;c<b.length-2;c++)a=l(b[c])?m(a,b[c]):a[b[c]];if(g(a)){var d=c=b[b.length-2];typeof c!=typeof String&&(d=c.toString());c=d.split("||");if(c instanceof Array){if(d=b=b[b.length-1],typeof b!=typeof String&&(d=b.toString()),b=d.split("||"),b instanceof Array&&c.length==b.length)for(d=0;d<c.length;d++)a[c[d]]=b[d],h(a,c[d],b[d])}else a[b[b.length-2]]=b[b.length-1],h(a,b[b.length-2],b[b.length-1])}}},get:function(){if(g(f.currenlayout.toolbars)){var a;a:{a=f.currenlayout;
for(var b=arguments,c=0;c<b.length;c++)if(l(b[c])){if(a=m(a,b[c]),null==a){a=void 0;break a}}else try{a=a[b[c]]}catch(d){a=void 0;break a}a=g(a)?a:void 0}return a}}};Object.defineProperty(e,"props",{value:{},writable:!1,configurable:!1});Object.defineProperties(e.props,{fontsize:{set:function(a){this.stored_fontsize=a},get:function(){return this.stored_fontsize}},color:{set:function(a){this.stored_color=a},get:function(){return this.stored_color}},up_color:{set:function(a){this.stored_up_color=a},
get:function(){return this.stored_up_color?this.stored_up_color:"rgb(0,255,0)"}},down_color:{set:function(a){this.stored_down_color=a},get:function(){return this.stored_down_color?this.stored_down_color:"rgb(255,0,0)"}},backroundcolor:{set:function(a){this.stored_backroundcolor=a},get:function(){return this.stored_backroundcolor}},hover_color:{set:function(a){this.stored_hover_color=a},get:function(){return this.stored_hover_color}},hover_backroundcolor:{set:function(a){this.stored_hover_hover_backroundcolor=
a},get:function(){return this.stored_hover_hover_backroundcolor}},click_color:{set:function(a){this.stored_click_color=a},get:function(){return this.stored_click_color}},click_backroundcolor:{set:function(a){this.stored_hover_click_backroundcolor=a},get:function(){return this.stored_hover_click_backroundcolor}},noactive_color:{set:function(a){this.stored_noactive_color=a},get:function(){return this.stored_noactive_color}},active_color:{set:function(a){this.stored_active_color=a},get:function(){return this.stored_active_color}},
noactive_backroundcolor:{set:function(a){this.stored_noactive_backroundcolor=a},get:function(){return this.stored_noactive_backroundcolor}},disabled_color:{set:function(a){this.stored_disabled_color=a},get:function(){return this.stored_disabled_color}},disabled_backroundcolor:{set:function(a){this.stored_disabled_backroundcolor=a},get:function(){return this.stored_disabled_backroundcolor}},on_color:{set:function(a){this.stored_on_color=a},get:function(){return this.stored_on_color}},off_color:{set:function(a){this.stored_off_color=
a},get:function(){return this.stored_off_color}},on_backroundcolor:{set:function(a){this.stored_on_backroundcolor=a},get:function(){return this.stored_on_backroundcolor}},off_backroundcolor:{set:function(a){this.stored_off_backroundcolor=a},get:function(){return this.stored_off_backroundcolor}}});e.props["font-size"]="12px";e.props.noactive_color="#dddddd";e.props.active_color="red";e.props.disabled_color="#cccccc";e.props.color="#000000";e.props.off_color="#000000";e.props.on_color="#000000";e.props.off_backroundcolor=
"#F7F7F7";e.props.on_backroundcolor="#DFBFFF";return e};
...
function ProChart_Initindicators(B){function S(){for(var a=jQuery.extend({},null,f.objParams),c=a.id,b=e.apiinit.savedIndicatorsSetting,d=0;d<b.length;d++)if(b[d].id==c){b.splice(d,1);break}d=e.chart.StudiesById[c];d.hasOwnProperty("panel")&&(a.panel=d.panel);a.hasOwnProperty("UID")&&delete a.UID;a.hasOwnProperty("group")&&delete a.group;try{b.push(a)}catch(h){}if(typeof e.events.study.onChangeDefaultSettings==typeof Function)e.events.study.onChangeDefaultSettings(b,c)}function T(){for(var a=f.objParams.UID,
c=f.objParams.id,b=e.chart.Studies,d=0;d<b.length;d++)if(b[d].id==c){for(var h=Object.keys(f.objParams),k=0;k<h.length;k++)"UID"!=h[k]&&"group"!=h[k]&&"panel"!=h[k]&&delete f.objParams[h[k]];f.objParams=jQuery.extend(!0,f.objParams,b[d]);if(typeof e.events.study.onReset==typeof Function)e.events.study.onReset(c);break}C({change:!0});D({change:!0});E();U();I({change:!0});V({change:!0});F();"undefined"!=typeof a&&e.chart.UpdateStudyAll(f.objParams)}function ba(){e.chart.IsVolumeEnabled()?$(".properties-tabs").find(".volume-category-tab").css("display",
""):$(".properties-tabs").find(".volume-category-tab").css("display","none")}function z(){if(typeof e.events.onStudyCheckMax!=typeof Function)return!1;try{var a=e.chart.GetNumOfRootIndicators();return!0==e.events.onStudyCheckMax(a)?!1:!0}catch(c){return!1}}function la(a){$("#chart-dialog").html(a);a=e.chart.Studies;for(var c=0;c<a.length;c++){var b=e.patterns.indicators.indicatorsform_row.replace(/%icon-prefix%/g,p.icon_prefix).replace(/%icon-source%/g,p.icon_source).replace(/%id%/g,a[c].id).replace(/%caption%/g,
a[c].caption),d=a[c].category;ca(a[c].id)&&(b=b.replace(p.icon_prefix+"stardisabled-icon",p.icon_prefix+"startenabled-icon"));$("#indicatorsgroup-"+d+" > ul.indicators-list").append(b)}$(".indicators-list .openindicator").on("click",function(){if(!z()){var a=$(this).attr("idx").replace("indicator-",""),b=w(a);e.chart.AddStudyWithParams(a,b);if(typeof e.events.study.onDialogAddStudy==typeof Function)e.events.study.onDialogAddStudy(a,$("#chart-dialog"))}});$(".indicators-list .li-indicator .a-property-favorite").on("click",
function(){var a=$(this).parent().attr("id"),b=$(this).parent().find("span").html();W(a,b)});$(".indicators-list .li-indicator .star-button").on("click",function(){var a=$(this).parent().attr("id"),b=$(this).parent().find("span").html(),c=$(this).parent().find("a").attr("title");$(this).hasClass(p.icon_prefix+"stardisabled-icon")?($(this).addClass(p.icon_prefix+"startenabled-icon").removeClass("stardisabled-icon"),da(a.replace("indicator-",""),b,c)):($(this).removeClass(p.icon_prefix+"startenabled-icon").addClass(p.icon_prefix+
"stardisabled-icon"),X(a.replace("indicator-","")))});$(".indicators-list .li-indicator .a-add-favorite").on("click",function(){if(!z()){var a=$(this).parent().attr("id").replace("indicator-",""),b=w(a);e.chart.AddStudyWithParams(a,b);if(typeof e.events.study.onDialogAddStudy==typeof Function)e.events.study.onDialogAddStudy(a,$("#chart-dialog"))}});G();J();ea();$("#button-add-indicator").button();$("#button-add-indicator-to").button();$("#button-reset-settings-indicator").button();$("#button-save-settings-indicator").button();
fa();ba();$("#chart-dialog").dialog("open");"undefined"!=typeof e.localizationobj&&e.localizationobj.gui.updateFromDataLang($("#chart-dialog"))}function ma(a){var c=1;"-"===a[0]&&(c=-1,a=a.substr(1));return function(b,d){return(b[a]<d[a]?-1:b[a]>d[a]?1:0)*c}}function na(a){$("#chart-dialog").html(a);a=e.chart.Studies;e.chart.Studies.sort(ma("caption"));for(var c=0;c<a.length;c++){var b=e.patterns.indicators.indicatorsform_row.replace(/%icon-prefix%/g,p.icon_prefix).replace(/%icon-source%/g,p.icon_source).replace(/%id%/g,
a[c].id).replace(/%caption%/g,a[c].caption);ca(a[c].id)&&(b=b.replace(p.icon_prefix+"stardisabled-icon",p.icon_prefix+"startenabled-icon"));$("#indicatorsgroup-trend > ul.indicators-list").append(b)}$(".indicators-list .li-indicator").on("click",function(){if(!z()){var a=$(this).attr("id").replace("indicator-",""),b=w(a);e.chart.AddStudyWithParams(a,b);if(typeof e.events.study.onDialogAddStudy==typeof Function)e.events.study.onDialogAddStudy(a,$("#chart-dialog"))}});$(".indicators-list .li-indicator .a-property-favorite").on("click",
function(){var a=$(this).parent().attr("id"),b=$(this).parent().find("span").html();W(a,b)});$(".indicators-list .li-indicator .star-button").on("click",function(){var a=$(this).parent().attr("id"),b=$(this).parent().find("span").html(),c=$(this).parent().find("a").attr("title");$(this).hasClass(p.icon_prefix+"stardisabled-icon")?($(this).addClass(p.icon_prefix+"startenabled-icon").removeClass("stardisabled-icon"),da(a.replace("indicator-",""),b,c)):($(this).removeClass(p.icon_prefix+"startenabled-icon").addClass(p.icon_prefix+
...
break;case "study":k="Study panel"}for(var n="",m=ha(h[f].id,g),q=0;q<m.length;q++)n+="<span>%legend-title%</span>; ".replace(/%legend-title%/g,m[q]);d+=e.patterns.indicators.panelstr.replace(/%panel-type-title%/g,k).replace(/%panel-type%/g,h[f].type).replace(/%legends%/g,n).replace(/%button-title%/g,"Add here").replace(/%button%/g,"add-button").replace(/%tid%/g,a).replace(/%tguiid%/g,"").replace(/%panel-action-style%/g,"").replace(/%position%/g,"").replace(/%tpanelid%/g,h[f].id).replace(/%css%/g,
...
"none");$("#dialog-panels-page").css("display","block");G();N();Y(1,c,2);$("#li-browser-indicators").trigger("click");"undefined"!=typeof e.localizationobj&&e.localizationobj.gui.updateFromDataLang($("#dialog-indicator-page #indicator-inner"))});$("#button-reset-settings-indicator").off();$("#button-reset-settings-indicator").on("click",function(){x.debug("Reset settings");T()});$("#button-save-settings-indicator").off();$("#button-save-settings-indicator").on("click",function(){x.debug("Save as default settings");
S()})}function ia(a,c,b){ja();A=c.caption;f.id=c.id;f.objStudyInfo=c;f.objParams=c;f.editStatus=!0;e.commonutils.func.detectmob()?qa("",A):ra("",A);a=e.patterns.indicators.indicatorform;a=a.replace(/%style-link-panels%/g,"");var d=Z(a,c,b);a=a.replace(/%panels%/g,d);$("#chart-dlgindicator #indicator-inner").html(a);G();N(b);ga(c);$("#button-reset-settings-indicator").button();$("#button-save-settings-indicator").button();"undefined"!=typeof e.localizationobj&&e.localizationobj.gui.updateFromDataLang($("#chart-dlgindicator #indicator-inner"));
$("#chart-dlgindicator").dialog("open")}function ha(a,c){for(var b=[],d=0;d<c.length;d++){var e=c[d];if(a==e.id){for(d=0;d<e.fields.length;d++)"study"==e.fields[d].type&&b.push(e.fields[d].name);break}}return b}function Z(a,c,b){a="";if("undefined"!=typeof e.panels){var d=e.panels.core.returnPanels(),h="",f=e.chart.GetLegendInfo();a+=e.patterns.indicators.panelstr.replace(/%panel-type-title%/g,"New panel").replace(/%panel-type%/g,"new").replace(/%tid%/g,c.id).replace(/%tguiid%/g,c.UID).replace(/%legends%/g,
"").replace(/%button-title%/g,"Move here").replace(/%tpanelid%/g,"").replace(/%panel-action-style%/g,"").replace(/%button%/g,"move-button").replace(/%position%/g,"panel-top").replace(/%css%/g,"paneltype-new");for(var g=0;g<d.length;g++){switch(d[g].type){case "price":h="Price panel";break;case "study":h="Study panel"}for(var l="",n="",m=ha(d[g].id,f),q=0;q<m.length;q++)l+="<span>%legend-title%</span>; ".replace(/%legend-title%/g,m[q]);a:{for(q=0;q<f.length;q++)if(m=f[q],d[g].id==m.id){for(q=0;q<m.fields.length;q++)if(m.fields[q].uid==
b){m=!0;break a}m=!1;break a}m=!1}m&&(n="display:none;");a+=e.patterns.indicators.panelstr.replace(/%panel-type-title%/g,h).replace(/%panel-type%/g,d[g].type).replace(/%legends%/g,l).replace(/%button-title%/g,"Move here").replace(/%button%/g,"move-button").replace(/%tid%/g,c.id).replace(/%tguiid%/g,c.UID).replace(/%position%/g,"").replace(/%tpanelid%/g,d[g].id).replace(/%panel-action-style%/g,n).replace(/%css%/g,"paneltype-"+d[g].type)}a+=e.patterns.indicators.panelstr.replace(/%panel-type-title%/g,
...
(b+1)];switch(d.drawtype){case "columns":ka(k,h);for(var d={visible:!0},g=Object.keys(d),l=0;l<g.length;l++){var n=g[l];"undefined"==typeof h[n]&&(h[n]="undefined"!==typeof k[n]?k[n]:d[n])}break;default:for(d={stroke:"rgb(0,0,0)",strokeWidth:"1",strokeOpacity:"1",fill:"rgb(0,0,0)",fillOpacity:"1",visible:!0},g=Object.keys(d),l=0;l<g.length;l++)n=g[l],"undefined"==typeof h[n]&&(h[n]="undefined"!==typeof k[n]?k[n]:d[n])}}}}function U(){if(null!=f.objParams&&"undefined"!=typeof f.objParams.levels&&null!=
...
"undefined"==typeof h.visible&&(h.visible=!0)}}function ga(a){f.objParams=a;C();D();E();U();I();V();a=$("#indicator-inner .properties-tabs a");for(var c=$("#indicator-inner .main-properties"),b=0;b<a.length;b++)if("none"!=$(a[b]).css("display")){$(a[b]).addClass("active");$(c[b]).css("display","block");break}F()}function C(a){var c=$("#tbody-parameters");$(c).html("");var b=[];b.push('<td data-localize="dialogs.indicator.parameters.%capid%">%caption%</td><td><input id="%inputid%" class="param-spinner onlynumeric"/></td>');
b.push('<td data-localize="dialogs.indicator.parameters.%capid%">%caption2%</td><td><input id="%inputid2%" class="param-spinner onlynumeric"/></td>');var d=/%caption%/g,e=/%inputid%/g,k=/%caption2%/g,g=/%inputid2%/g,l=/%capid%/g,n=f.objParams.parameters;a=[];for(var m=0;m<n;m++){for(var q=f.objParams["param"+(m+1)],p="param"+(m+1),r=$("<tr></tr>"),s=q.values.length,v=0;v<s;v++){var t="param"+(m+1)+"_"+v,y="";switch(v){case 0:y=q.caption.toLowerCase().replace(/\s+/g,"");y=b[v].replace(d,q.caption).replace(e,
t).replace(l,y);$(r).append(y);break;case 1:y=q.caption2.toLowerCase().replace(/\s+/g,""),y=b[v].replace(k,q.caption2).replace(g,t).replace(l,y),$(r).append(y)}}a.push(!1!=q.editable);if(!1!=q.editable)for($(c).append(r),r=0;r<s;r++){var v="param"+(m+1)+"_"+r,t=1,y=0,aa=99999,u=0;try{u=q.values[r]}catch(w){u=0}try{t=q.steps[r]}catch(x){t=1}try{y=q.min[r]}catch(z){y=0}try{aa=q.max[r]}catch(A){aa=99999}K("#"+v,y,aa,t,u);L("#"+v,p,r)}}c=!1;for(m=0;m<a.length;m++)c=c||a[m];!1==c&&$("#tab-param").css("display",
...
k.replace(/%caption%/g,d.caption).replace(/%renderitem%/g,h);$(a).append(d);M("#"+h,h)}}function ca(a){if("undefined"!=typeof e.init.indicators)for(var c=e.init.indicators,b=0;b<c.length;b++)if(c[b].id==a)return!0;return!1}function da(a,c,b){"undefined"!=typeof e.init.indicators&&(e.init.gui.indicatorsAdd(a,c,b),J())}function X(a){"undefined"!=typeof e.init.indicators&&(e.init.gui.indicatorsRemove(a),J())}function ta(){$("ul.favorite-indicators-list .openindicator").on("click",function(){if(!z()){var a=
$(this).parent().attr("idx").replace("indicator-",""),c=w(a);e.chart.AddStudyWithParams(a,c);if(typeof e.events.study.onDialogAddStudy==typeof Function)e.events.study.onDialogAddStudy(a,$("#chart-dialog"))}});$("ul.favorite-indicators-list .li-indicator .a-property-favorite").on("click",function(){var a=$(this).parent().attr("idx"),c=$(this).parent().find("span").html();W(a,c)});$("ul.favorite-indicators-list .li-indicator .star-button").on("click",function(){var a=$(this).parent().attr("idx");X(a.replace("indicator-",
""));a=$('ul.indicators-list .li-indicator[id="'+a+'"] .star-button');$(a).removeClass(p.icon_prefix+"startenabled-icon").addClass(p.icon_prefix+"stardisabled-icon")});$("ul.favorite-indicators-list .li-indicator .add-favorite").on("click",function(){if(!z()){var a=$(this).parent().attr("idx").replace("indicator-",""),c=w(a);e.chart.AddStudyWithParams(a,c);if(typeof e.events.study.onDialogAddStudy==typeof Function)e.events.study.onDialogAddStudy(a,$("#chart-dialog"))}})}function J(){var a=$("ul.favorite-indicators-list");
$(a).html("");if("undefined"!=typeof e.init.indicators)for(var c=e.init.indicators,b=0;b<c.length;b++){var d=e.patterns.indicators.indicatorsform_favorites_row.replace(/%icon-source%/g,p.icon_source).replace(/%icon-prefix%/g,p.icon_prefix).replace(/%id%/g,c[b].id).replace(/%caption%/g,c[b].n).replace(/%title%/g,c[b].d);$(a).append(d)}ta();"undefined"!=typeof e.menuobj&&e.menuobj.gui.updateIndicatorFavorites()}function V(){var a=f.objParams.levels;if("undefined"==typeof a||null==a)$("#tab-level").css("display",
...
break;case r.Value:e.chart.UpdateStudyValues(f.objParams);break;case r.Style:e.chart.UpdateStudyStyle(f.objParams);break;default:e.chart.UpdateStudyAll(f.objParams)}}function M(a,c){var b="undefined"!=typeof f.objParams.base,d=f.objParams[c],h=d.style[0],k=$(a).find(".line-color"),g=h.stroke;O($(k),g);var l=$(a).find(".line-color-alt"),n=h.stroke;"undefined"!=typeof d.style[1]&&(n=d.style[1].stroke);O($(l),n);var m=$(a).find(".line-width"),n=h.strokeWidth;$(m).slider({min:1,max:6});$(m).slider("option",
"value",n);var q=$(a).find(".line-opacity");$(q).slider({min:0,max:100});n=100*h.fillOpacity;$(q).slider("option","value",n);$(q).find("div.gradient").css("background-image","linear-gradient(to left, "+g+" 0%, transparent 100% )");d=d.drawtype;g="Line Histogram Ch-Histogram C-Histogram Area Dots".split(" ");n="line histogram changehistogram centeredhistogram area dots".split(" ");switch(d){case "channel":g=["Channel"];n=["channel"];break;case "columns":g=["Columns"];n=["columns"];break;default:g=
"Line Histogram Ch-Histogram C-Histogram Area Dots".split(" "),n="line histogram changehistogram centeredhistogram area dots".split(" ")}for(var p=$(a).find(".linedesign-type"),w=/%val%/g,x=/%Val%/g,v=0;v<g.length;v++)if(!1!=b||"changehistogram"!=n[v]&&"centeredhistogram"!=n[v]){var sa='<option data-localize="dialogs.indicator.linetype.%val%" value="%val%">%Val%</option>'.replace(w,n[v]).replace(x,g[v]);$(p).append(sa)}"undefined"!=typeof d&&($(p).val(d),$(q).css("display","area"==d||"channel"==d?
...
(null!=k&&$(k).slider("enable"),null!=e&&$(e).slider("enable"),null!=c&&$(c).spectrum("enable"),null!=b&&$(b).spectrum("enable"),null!=d&&$(d).spectrum("enable")):(null!=k&&$(k).slider("disable"),null!=e&&$(e).slider("disable"),null!=c&&$(c).spectrum("disable"),null!=b&&$(b).spectrum("disable"),null!=d&&$(d).spectrum("disable"));for(var l=l.is(":checked"),n=$(this).attr("ritem"),m=0;m<u.length;m++)u[m].ctr==a&&(H(f.objParams[n].style[0],u[m].json,l?"true":"false"),t(r.Style))})}function ua(a,c){var b=
f.objParams.levels[c],d=$(a).find(".line-color"),e=b.stroke;O($(d),e);var k=$(a).find(".line-width"),g=b.strokeWidth;$(k).slider({min:1,max:6});$(k).slider("option","value",g);var l=$(a).find(".line-opacity");$(l).slider({min:0,max:100});g=100*b.fillOpacity;$(l).slider("option","value",g);$(l).find("div.gradient").css("background-image","linear-gradient(to left, "+e+" 0%, transparent 100% )");for(var e=b.strokeDasharray,g=["Solid","Doted","Dashed"],n=["solid","doted","dashed"],m=$(a).find(".linedesign-type"),
q=/%val%/g,p=/%Val%/g,s=0;s<g.length;s++){var u='<option <option data-localize="dialogs.common.linetype.%val%" value="%val%">%Val%</option>'.replace(q,n[s]).replace(p,g[s]);$(m).append(u)}"undefined"!=typeof e&&$(m).val(e);e=$(a).find(".levelinput");g=$(a).find(".line-visible");$(g).prop("checked",b.visible);$(l).slider(b.visible?"enable":"disable");$(d).spectrum(b.visible?"enable":"disable");$(k).slider(b.visible?"enable":"disable");$(m).prop("disabled",b.visible?!1:!0);$(e).prop("disabled",b.visible?
...
"Close"),g=e.localizationobj.gui.returnLocalizationString("dialogs.indicators.title",c));"undefined"!=typeof e.init.TemplateName&&(l=e.init.TemplateName);var n="";"rtl"==e.localizationobj.gui.returnCurrentLanguage().direction&&(n="dir-rtl");$('<div id="chart-dialog" title="'+g+'"></div>').insertAfter("body");$("#chart-dialog").dialog({dialogClass:"chart-ui-dialog chart-ui-mob-dialog indicators-dialog "+l+" "+n,draggable:!1,autoOpen:!1,resizable:!1,closeOnEscape:!0,width:window.innerWidth?window.innerWidth:
...
text:f,click:function(){$(this).dialog("close")}}]})}function ra(a,c,b){function d(a){$(a).find(".spectrum-color").each(function(){$(this).spectrum("destroy")})}function h(a){var b=e.patterns.indicators.indicator_button_settings;a=$(a).find(".ui-dialog-buttonset").prepend(b);$(a).find("#button-reset-settings-indicator").button().on("click",function(){x.debug("button-reset-settings-indicator");T()});$(a).find("#button-save-settings-indicator").button().on("click",function(){x.debug("button-save-settings-indicator");
S()})}function f(a){var b=e.patterns.common.eye_orange.replace(/%icon-source%/g,p.icon_source).replace(/%icon-prefix%/g,p.icon_prefix);a=$(a).find(".ui-dialog-buttonset").prepend(b);$(a).find(".eye-orange").on("click",function(){var a=$(".chart-ui-dialog.indicator-dialog").css("opacity"),a=1==a?.5:1,b=1==a?"":1;$(".chart-ui-dialog.indicator-dialog").css("opacity",a);$(this).css("opacity",b)})}a="Close";b="";"undefined"!=typeof e.localizationobj&&(a=e.localizationobj.gui.returnLocalizationString("dialogs.common.button-close",
...
c=c.attr("tguiid");x.debug("Move indicator",b,d,c);a:{for(var b=e.chart.GetLegendInfo(),k=0;k<b.length;k++)for(var g=b[k],l=0;l<g.fields.length;l++)if(g.fields[l].uid==a){b=g.id;break a}b=null}null==b&&(b=e.chart.GetPanelIDByDefID(a));e.chart.MoveStudyToOtherPanel(c,b,d,h);d=Z(null,f.objStudyInfo,a);$("#tbody-indicatorpanels").html(d);N(a)});$(".action-add-button-indicator").off();$(".action-add-button-indicator").on("click",function(){if(!z()){var a=$(this),b=a.attr("tid"),d=a.attr("tpanelid"),h=
a.attr("tguiid");x.debug("Add indicator",b,d,h);$("#button-add-indicator").button({disabled:!0});$("#button-add-indicator-to").button({disabled:!0});$("#dialog-panels-page").css("display","none");$("#dialog-indicator-page").css("display","block");$("#tab-panels").css("display","");h=1;"undefined"==typeof h&&(h=1);for(var k=$("#dlg-indicators .main-page").eq(1).find(".title_level"),g=0;g<k.length;g++)$(k[g]).removeClass("active"),g>h&&$(k[g]).css("display","none");$(k[h]).css("display","block").addClass("active");
h="";""==d&&(d=null,a.hasClass("panel-top")?h="top":a.hasClass("panel-bottom")&&(h="bottom"));f.id=b;f.objStudyInfo=e.chart.AddStudyWithParams(f.id,f.objParams,d,h);null!=f.objStudyInfo&&(f.objParams=f.objStudyInfo,f.editStatus=!0);a=e.chart.GetLegendIDByDefID(f.objStudyInfo.UID);b=Z(null,f.objStudyInfo,a);$("#tbody-indicatorpanels").html(b);N(a)}})}function Y(a,c,b){"undefined"==typeof b&&(b=a);a=$("#dlg-indicators .main-page").eq(a).find(".title_level");for(var d=0;d<a.length;d++)$(a[d]).removeClass("active"),
...
function(){var a=$("#main-indicator-browser > li").index(this),c=$(this).attr("id");$("#main-indicator-browser > li").removeClass("browser-item-selected");$("#main-indicator-browser #"+c).addClass("browser-item-selected");for(var c=$("#chart-dialog .main-page"),b=0;b<c.length;b++){var d=b==a?"block":"none";$(c[b]).css("display",d)}a=$(this).html();Y(0,a)})}function P(a,c){var b=c.split(".");return 1==b.length?a[b[0]]:"undefined"!=typeof a[b[0]]?P(a[b[0]],b.slice(1).join(".")):null}function H(a,c,
...
B;var x=e.api.debug.getLogger("prochart.gui.indicators"),A="",r={All:0,Style:1,Draw:2,Value:3},p=e.api.layout.getbuttonStyle(),R=null,s=[],u=[],f={id:"",objStudyInfo:null,objParams:null,editStatus:!1};B.gui={viewIndicators:function(a){"undefined"==typeof a&&(a="indicators");ja();A="Indicators form";var c=e.commonutils.func.detectmob();c?ya("gannfan",A):xa("gannfan",A);a=e.patterns.indicators.indicatorsform.replace(/%favorites-selected%/g,"favorites"==a?"browser-item-selected":"").replace(/%indicators-selected%/g,
...
function ProChart_InitProps(n){function x(){$("#borderwidth-area-line").slider({min:1,max:6});$("#borderwidth-line-line").slider({min:1,max:6});$("#borderwidth-histogram-line").slider({min:1,max:6});$("#borderwidth-linedots-line").slider({min:1,max:6});$("#color-opacity-area").slider({min:0,max:100})}function y(){var b=[];b.push('<option value="%charttypeid%" data-localize="dialogs.indicator.%charttypeid%">%charttypename%</option>');var d=$("#tbody-charttype-select").find("select"),c=/%charttypeid%/g,
h=/%charttypename%/g;if(null!=d)for(var g=0;g<a.init.charttype.length;g++){var l=a.init.charttype[g],l=b[0].replace(c,l.id).replace(h,a.localizationobj.gui.returnLocalizationString("dialogs.props."+l.id,l.n));d.append(l)}b=a.chart.GetPriceProperties().GetDrawType();$(d).val(b);$(".charttype-block").css("display","none");$("#charttype-block-"+b).css("display","block");b=a.chart.GetRTLineVisible();$("#control-priceline-visible").prop("checked",Boolean(b));$(d).on("change",function(){var b=$(this).val();
$(".charttype-block").css("display","none");$("#charttype-block-"+b).css("display","block");a.chart.GetPriceProperties().SetDrawType(b);a.chart.Redraw();u();var c=a.chart.GetPriceProperties().GetStyle();try{"undefined"!=typeof a.api.localstorage&&a.api.localstorage.setPriceType(b)}catch(d){}if(typeof a.events.globprop.onPriceTypeChange==typeof Function)a.events.globprop.onPriceTypeChange(b,c);m.debug(b,c)});$("#control-priceline-visible").on("click",function(b){b=!0;$(this).is(":checked")?(a.chart.SetRTLineVisible(!0),
b=!0):(a.chart.SetRTLineVisible(!1),b=!1);a.chart.Redraw();try{"undefined"!=typeof a.api.localstorage&&a.api.localstorage.setPriceLine(b)}catch(c){}if(typeof a.events.globprop.onPriceLineChange==typeof Function)a.events.globprop.onPriceLineChange(b);m.debug("SetRTLineVisible",b)})}function z(){f("#control-candlesticks-border","#color-candlesticks-up-border","#color-candlesticks-down-border","#color-candlesticks-flat-border",null,null);f("#control-candlesticks-wick","#color-candlesticks-wick",null,
null,null,null);f("#control-columns-border","#color-columns-up-border","#color-columns-down-border","#color-columns-flat-border",null,null);f("#control-hollowcandlesticks-border","#color-hollowcandlesticks-up-border","#color-hollowcandlesticks-down-border","#color-hollowcandlesticks-flat-border",null,null);f("#control-hollowcandlesticks-wick","#color-hollowcandlesticks-wick",null,null,null,null);f("#control-ohlc-border","#color-ohlc-up-border","#color-ohlc-down-border","#color-ohlc-flat-border",null,
null);f("#control-ohlc-wick","#color-ohlc-wick",null,null,null,null);f("#control-hlc-border","#color-hlc-up-border","#color-hlc-down-border","#color-hlc-flat-border",null,null);f("#control-hlc-wick","#color-hlc-wick","#color-hlc-border-flat",null,null,null);f("#control-dots-border","#color-dots-up-border","#color-dots-down-border","#color-dots-flat-border",null,null);f("#control-heikinashi-border","#color-heikinashi-up-border","#color-heikinashi-down-border","#color-heikinashi-flat-border",null,null);
f("#control-heikinashi-wick","#color-heikinashi-wick",null,null,null,null);$(".class-price-color").on("change",function(){for(var b=$(this).spectrum("get").toRgbString(),d=$(this).attr("id"),c=0;c<e.length;c++)if(e[c].ctr==d){var h=a.chart.GetPriceProperties(),g=h.GetStyle();t(g,e[c].json,b);h=h.GetDrawType();"undefined"!=typeof a.api.localstorage&&a.api.localstorage.setPriceStyle(h,g);if(typeof a.events.globprop.onPriceStyleChange==typeof Function)a.events.globprop.onPriceStyleChange(h,g);m.debug(h,
g);a.chart.Redraw();switch(d){case "color-area-up":var g=$("#color-area-up").spectrum("get").alpha,h=$("#color-area-up").spectrum("get").toHexString(),l=100;isNaN(parseFloat(g))||(l=100*g);$("#color-opacity-area").slider("option","value")!=l&&$("#color-opacity-area").slider("option","value",l);$("#"+e[c].opacityctr+" div.gradient").css("background-image","linear-gradient(to left, "+h+" 0%, transparent 100% )")}}});$("#borderwidth-line-line").on("slidechange",function(){var b=$(this).slider("option",
"value"),d=a.chart.GetPriceProperties(),c=d.GetStyle();c.strokeWidth=b;a.chart.Redraw();b=d.GetDrawType();"undefined"!=typeof a.api.localstorage&&a.api.localstorage.setPriceStyle(b,c);if(typeof a.events.globprop.onPriceStyleChange==typeof Function)a.events.globprop.onPriceStyleChange(b,c);m.debug(b,c)});$("#borderwidth-linedots-line").on("slidechange",function(){var b=$(this).slider("option","value"),d=a.chart.GetPriceProperties(),c=d.GetStyle();c.strokeWidth=b;a.chart.Redraw();b=d.GetDrawType();
"undefined"!=typeof a.api.localstorage&&a.api.localstorage.setPriceStyle(b,c);if(typeof a.events.globprop.onPriceStyleChange==typeof Function)a.events.globprop.onPriceStyleChange(b,c);m.debug(b,c)});$("#borderwidth-histogram-line").on("slidechange",function(){var b=$(this).slider("option","value"),d=a.chart.GetPriceProperties(),c=d.GetStyle();c.strokeWidth=b;b=d.GetDrawType();"undefined"!=typeof a.api.localstorage&&a.api.localstorage.setPriceStyle(b,c);if(typeof a.events.globprop.onPriceStyleChange==
typeof Function)a.events.globprop.onPriceStyleChange(b,c);m.debug(b,c);a.chart.Redraw()});$("#borderwidth-area-line").on("slidechange",function(){var b=$(this).slider("option","value"),d=a.chart.GetPriceProperties(),c=d.GetStyle();c.strokeWidth=b;b=d.GetDrawType();"undefined"!=typeof a.api.localstorage&&a.api.localstorage.setPriceStyle(b,c);if(typeof a.events.globprop.onPriceStyleChange==typeof Function)a.events.globprop.onPriceStyleChange(b,c);m.debug(b,c);a.chart.Redraw()});$("#color-opacity-area").on("slidechange",
function(){var a=$(this).slider("option","value"),d=$("#color-area-up").spectrum("get").toRgb(),a="rgba(%r%, %g%, %b%, %a%)".replace("%r%",d.r).replace("%g%",d.g).replace("%b%",d.b).replace("%a%",a/100);$("#color-area-up").spectrum("set",a)})}function u(){var b=a.chart.GetPriceProperties(),d=b.GetDrawType();e=[];k=[];switch(d){case "candlesticks":e.push({ctr:"color-candlesticks-up-candles",json:"up.fill"},{ctr:"color-candlesticks-down-candles",json:"down.fill"},{ctr:"color-candlesticks-up-border",
json:"up.stroke"},{ctr:"colorfont-candlesticks-up-candles",json:"up.fontColor"},{ctr:"colorfont-candlesticks-down-candles",json:"down.fontColor"},{ctr:"colorfont-candlesticks-flat-candles",json:"flat.fontColor"},{ctr:"color-candlesticks-down-border",json:"down.stroke"},{ctr:"color-candlesticks-flat-candles",json:"flat.fill"},{ctr:"color-candlesticks-flat-border",json:"flat.stroke"},{ctr:"color-candlesticks-wick",json:"wick.stroke"});k.push({ctr:"control-candlesticks-border",json:"borderVisible"},
{ctr:"control-candlesticks-wick",json:"wick.visible"});break;case "columns":e.push({ctr:"color-columns-up-column",json:"up.fill"},{ctr:"color-columns-down-column",json:"down.fill"},{ctr:"color-columns-up-border",json:"up.stroke"},{ctr:"color-columns-down-border",json:"down.stroke"},{ctr:"color-columns-flat-column",json:"flat.fill"},{ctr:"color-columns-flat-border",json:"flat.stroke"},{ctr:"colorfont-columns-up-column",json:"up.fontColor"},{ctr:"colorfont-columns-down-column",json:"down.fontColor"},
{ctr:"colorfont-columns-flat-column",json:"flat.fontColor"},{ctr:"color-columns-wick",json:"wick.stroke"});k.push({ctr:"control-columns-border",json:"borderVisible"});break;case "hollowcandlesticks":e.push({ctr:"color-hollowcandlesticks-up-candles",json:"up.fill"},{ctr:"color-hollowcandlesticks-down-candles",json:"down.fill"},{ctr:"color-hollowcandlesticks-up-border",json:"up.stroke"},{ctr:"color-hollowcandlesticks-down-border",json:"down.stroke"},{ctr:"color-hollowcandlesticks-flat-candles",json:"flat.fill"},
{ctr:"color-hollowcandlesticks-flat-border",json:"flat.stroke"},{ctr:"colorfont-hollowcandlesticks-up-candles",json:"up.fontColor"},{ctr:"colorfont-hollowcandlesticks-down-candles",json:"down.fontColor"},{ctr:"colorfont-hollowcandlesticks-flat-candles",json:"flat.fontColor"},{ctr:"color-hollowcandlesticks-wick",json:"wick.stroke"});k.push({ctr:"control-hollowcandlesticks-border",json:"borderVisible"},{ctr:"control-hollowcandlesticks-wick",json:"wick.visible"});break;case "ohlc":e.push({ctr:"color-ohlc-up-border",
json:"up.stroke"},{ctr:"color-ohlc-down-border",json:"down.stroke"},{ctr:"color-ohlc-flat-border",json:"flat.stroke"},{ctr:"colorfont-ohlc-up",json:"up.fontColor"},{ctr:"colorfont-ohlc-down",json:"down.fontColor"},{ctr:"colorfont-ohlc-flat",json:"flat.fontColor"});break;case "hlc":e.push({ctr:"color-hlc-up-border",json:"up.stroke"},{ctr:"color-hlc-down-border",json:"down.stroke"},{ctr:"color-hlc-flat-border",json:"flat.stroke"},{ctr:"colorfont-hlc-up",json:"up.fontColor"},{ctr:"colorfont-hlc-down",
json:"down.fontColor"},{ctr:"colorfont-hlc-flat",json:"flat.fontColor"});break;case "histogram":e.push({ctr:"color-histogram-up-border",json:"up.stroke"},{ctr:"color-histogram-down-border",json:"down.stroke"},{ctr:"color-histogram-flat-border",json:"flat.stroke"},{ctr:"colorfont-histogram-up",json:"up.fontColor"},{ctr:"colorfont-histogram-down",json:"down.fontColor"},{ctr:"colorfont-histogram-flat",json:"flat.fontColor"});break;case "dots":e.push({ctr:"color-dots-up-candles",json:"up.fill"},{ctr:"color-dots-down-candles",
json:"down.fill"},{ctr:"color-dots-up-border",json:"up.stroke"},{ctr:"color-dots-down-border",json:"down.stroke"},{ctr:"color-dots-flat-candles",json:"flat.fill"},{ctr:"color-dots-flat-border",json:"flat.stroke"},{ctr:"colorfont-dots-up",json:"up.fontColor"},{ctr:"colorfont-dots-down",json:"down.fontColor"},{ctr:"colorfont-dots-flat",json:"flat.fontColor"});break;case "heikinashi":e.push({ctr:"color-heikinashi-up-candles",json:"up.fill"},{ctr:"color-heikinashi-down-candles",json:"down.fill"},{ctr:"color-heikinashi-up-border",
json:"up.stroke"},{ctr:"color-heikinashi-down-border",json:"down.stroke"},{ctr:"color-heikinashi-flat-candles",json:"flat.stroke"},{ctr:"color-heikinashi-wick",json:"wick.stroke"},{ctr:"color-heikinashi-flat-border",json:"flat.fill"},{ctr:"colorfont-heikinashi-up-candles",json:"up.fontColor"},{ctr:"colorfont-heikinashi-down-candles",json:"down.fontColor"},{ctr:"colorfont-heikinashi-flat-candles",json:"flat.fontColor"});k.push({ctr:"control-heikinashi-border",json:"borderVisible"},{ctr:"control-heikinashi-wick",
json:"wick.visible"});break;case "line":e.push({ctr:"color-line-line",json:"stroke"},{ctr:"colorfont-line-line",json:"fontColor"});break;case "area":e.push({ctr:"color-area-line",json:"stroke"},{ctr:"colorfont-are-line",json:"fontColor"},{ctr:"color-area-up",json:"fill",opacityctr:"color-opacity-area"});break;case "linedots":e.push({ctr:"color-linedots-line",json:"stroke"},{ctr:"colorfont-linedots-line",json:"fontColor"})}for(var b=b.GetStyle(),c=0;c<e.length;c++)A($("#"+e[c].ctr),v(b,e[c].json),
!0);for(c=0;c<k.length;c++){var h=v(b,k[c].json);if(null==h)break;"true"==h.toString().toLowerCase()?$("#"+k[c].ctr).attr("checked",!0):$("#"+k[c].ctr).removeAttr("checked")}switch(d){case "line":d=b.strokeWidth;$("#borderwidth-line-line").slider("option","value",d);break;case "histogram":d=b.strokeWidth;$("#borderwidth-histogram-line").slider("option","value",d);break;case "area":d=b.strokeWidth;$("#borderwidth-area-line").slider("option","value",d);d=$("#color-area-up").spectrum("get").alpha;b=
100;isNaN(parseFloat(d))||(b=100*d);$("#color-opacity-area").slider("option","value")!=b&&$("#color-opacity-area").slider("option","value",b);break;case "linedots":d=b.strokeWidth,$("#borderwidth-linedots-line").slider("option","value",d)}}function f(b,d,c,h,g,l){$(b).on("click",function(b){var e=$(this);b=$(this).attr("id");e.is(":checked")?(null!=l&&$(l).slider("enable"),null!=g&&$(g).slider("enable"),null!=d&&$(d).spectrum("enable"),null!=c&&$(c).spectrum("enable"),null!=h&&$(h).spectrum("enable")):
(null!=l&&$(l).slider("disable"),null!=g&&$(g).slider("disable"),null!=d&&$(d).spectrum("disable"),null!=c&&$(c).spectrum("disable"),null!=h&&$(h).spectrum("disable"));for(var e=e.is(":checked"),p=0;p<k.length;p++)if(k[p].ctr==b){var f=a.chart.GetPriceProperties(),q=f.GetStyle();t(q,k[p].json,e?"true":"false");f=f.GetDrawType();"undefined"!=typeof a.api.localstorage&&a.api.localstorage.setPriceStyle(f,q);if(typeof a.events.globprop.onPriceStyleChange==typeof Function)a.events.globprop.onPriceStyleChange(f,
q);m.debug(f,q);a.chart.Redraw()}for(p=0;p<w.length;p++)if(w[p].ctr==b){q=a.chart.GetVolumeInfo().GetStyle();t(q,w[p].json,e?"true":"false");if(typeof a.events.globprop.onVolumeStyleChange==typeof Function)a.events.globprop.onVolumeStyleChange(q);m.debug(q);a.chart.Redraw()}})}function F(){var b=(new Date).getTimezoneOffset(),d=a.chart.GetTimeZone(),c=" UTC "+(0<b?"-":"+")+Math.abs(d/60);$("#current-time-zone-span").html(c);$("#button-update-timezone").button();$("#button-update-timezone").on("click",
function(){var b=$("#select-timezone").val(),d=$("#control-daylight-time").is(":checked")?1:0,e=-60*(parseFloat(b)+d);a.chart.SetTimeZone(e);if(typeof a.events.globprop.onVolumeStyleChange==typeof Function)a.events.globprop.onTimeZoneChange(e);m.debug(e);a.chart.Redraw();c=" UTC "+(0<e?"-":"+")+Math.abs(parseFloat(b)+d);$("#current-time-zone-span").html(c)})}function B(b,d){function c(a){$(a).find(".spectrum-color").each(function(){$(this).spectrum("destroy")})}function e(b){var c=a.patterns.common.eye_orange.replace(/%icon-source%/g,
r.icon_source).replace(/%icon-prefix%/g,r.icon_prefix);$(b).find(".ui-dialog-buttonset").prepend(c).on("click",function(){var a=$(".chart-ui-dialog.props-dialog").css("opacity"),a=1==a?.5:1,b=1==a?"":2;$(".chart-ui-dialog.props-dialog").css("opacity",a);$(this).css("opacity",b)})}var g="Close",f=d,k="";"undefined"!=typeof a.localizationobj&&(g=a.localizationobj.gui.returnLocalizationString("dialogs.common.button-close","Close"),f=a.localizationobj.gui.returnLocalizationString("dialogs.props.generalproperties-title",
d));"undefined"!=typeof a.init.TemplateName&&(k=a.init.TemplateName);var n="";"rtl"==a.localizationobj.gui.returnCurrentLanguage().direction&&(n="dir-rtl");$('<div id="chart-dialog" title="'+f+'"></div>').insertAfter("body");$("#chart-dialog").dialog({dialogClass:"chart-ui-dialog props-dialog "+k+" "+n,draggable:!0,autoOpen:!1,resizable:!1,closeOnEscape:!0,width:"auto",modal:!0,open:function(b,c){e($(this).parent());$(".ui-widget-overlay").last().addClass("chart-ui-widget-overlay");if(a.api.props){var d=
a.api.props.chart.gui.layout.zindex_dialog;$(".chart-ui-widget-overlay").css({"z-index":d});$(".chart-ui-dialog").css({"z-index":d})}$(".ui-widget-overlay").bind("click",function(){$("#chart-dialog").dialog("close")});if(typeof a.events.globprop.onOpenDialog==typeof Function)a.events.globprop.onOpenDialog();m.debug("Open dialog global properies");C()},close:function(b,d){c($(this).parent());$("#chart-dialog").remove();$("div.chart-ui-dialog.systems-dialog  adv-buttons."+r.icon_prefix+"eye-orange").off().remove();
$("div.chart-ui-dialog.systems-dialog").off().remove();$(this).off().empty().remove();if(typeof a.events.globprop.onCloseDialog==typeof Function)a.events.globprop.onCloseDialog();m.debug("Close dialog global properies")},buttons:[{id:"btn-dialogs-close",text:g,click:function(){$(this).dialog("close")}}]})}function D(b,d){function c(a){$(a).find(".spectrum-color").each(function(){$(this).spectrum("destroy")})}function e(b){var c=a.patterns.common.eye_orange.replace(/%icon-source%/g,r.icon_source).replace(/%icon-prefix%/g,
r.icon_prefix);$(b).find(".ui-dialog-buttonset").prepend(c).on("click",function(){var a=$(".chart-ui-dialog.props-dialog").css("opacity"),a=1==a?.5:1,b=1==a?"":2;$(".chart-ui-dialog.props-dialog").css("opacity",a);$(this).css("opacity",b)})}var f="Close",l=d,k="";"undefined"!=typeof a.localizationobj&&(f=a.localizationobj.gui.returnLocalizationString("dialogs.common.button-close","Close"),l=a.localizationobj.gui.returnLocalizationString("dialogs.props.generalproperties-title",d));"undefined"!=typeof a.init.TemplateName&&
(k=a.init.TemplateName);var n="";"rtl"==a.localizationobj.gui.returnCurrentLanguage().direction&&(n="dir-rtl");$('<div id="chart-dialog" title="'+l+'"></div>').insertAfter("body");$("#chart-dialog").dialog({dialogClass:"chart-ui-dialog props-dialog chart-ui-mob-dialog   "+k+" "+n,draggable:!1,autoOpen:!1,resizable:!1,closeOnEscape:!0,width:window.innerWidth?window.innerWidth:$(window).width(),height:window.innerHeight?window.innerHeight:$(window).height(),modal:!0,open:function(b,c){e($(this).parent());
$(".ui-widget-overlay").last().addClass("chart-ui-widget-overlay");if(a.api.props){var d=a.api.props.chart.gui.layout.zindex_dialog;$(".chart-ui-widget-overlay").css({"z-index":d});$(".chart-ui-dialog").css({"z-index":d})}$(".ui-widget-overlay").bind("click",function(){$("#chart-dialog").dialog("close")});if(typeof a.events.globprop.onOpenDialog==typeof Function)a.events.globprop.onOpenDialog();m.debug("Open dialog global properies");C()},close:function(b,d){c($(this).parent());$("#chart-dialog").remove();
$("div.chart-ui-dialog.systems-dialog  adv-buttons."+r.icon_prefix+"eye-orange").off().remove();$("div.chart-ui-dialog.systems-dialog").off().remove();$(this).off().empty().remove();if(typeof a.events.globprop.onCloseDialog==typeof Function)a.events.globprop.onCloseDialog();m.debug("Close dialog global properies")},buttons:[{id:"btn-dialogs-close",text:f,click:function(){$(this).dialog("close")}}]})}function G(){$(".properties-tabs").delegate("a","click",function(){var a=$(this).index();$(".main-properties").each(function(){$(this).css("display",
"none")});$(".properties-tabs-label").each(function(){$(this).removeClass("active")});$(".main-properties").eq(a).css("display","block");$(this).addClass("active")})}function E(){"undefined"!=typeof a.preloadobj&&a.preloadobj.startPreload()}function C(){"undefined"!=typeof a.preloadobj&&a.preloadobj.endPreload()}function v(a,d){var c=d.split(".");return 1==c.length?a[c[0]]:"undefined"!=typeof a[c[0]]?v(a[c[0]],c.slice(1).join(".")):null}function t(a,d,c){d=d.split(".");1==d.length&&(a[d[0]]=c);"undefined"!=
typeof a[d[0]]&&t(a[d[0]],d.slice(1).join("."),c)}function A(a,d,c,e){"undefined"==typeof e&&(e=!1);c=[];e&&c.push("rgba(0, 0, 0, 0);{rgba(0, 0, 0, 0.1);{rgba(0, 0, 0, 0.2);{rgba(0, 0, 0, 0.3);{rgba(0, 0, 0, 0.4);{rgba(0, 0, 0, 0.5);{rgba(0, 0, 0, 0.6);{rgba(0, 0, 0, 0.7);{rgba(0, 0, 0, 0.8);{rgba(0, 0, 0, 0.9);".split("{"));c.push("rgb(0, 0, 0);{rgb(66, 66, 66);{rgb(101, 101, 101);{rgb(152, 152, 152);{rgb(182, 182, 182);{rgb(203, 203, 203);{rgb(216, 216, 216);{rgb(238, 238, 238);{rgb(242, 242, 242);{rgb(255, 255, 255);".split("{"));
...
c.push("rgb(91, 15, 0);{rgb(102, 0, 0);{rgb(120, 63, 4);{rgb(127, 96, 0);{rgb(39, 78, 19);{rgb(12, 52, 61);{rgb(28, 69, 135);{rgb(7, 55, 99);{rgb(32, 18, 77);{rgb(76, 17, 48);".split("{"));$(a).spectrum({color:d,showAlpha:e,showPalette:!0,showPaletteOnly:!1,clickoutFiresChange:!1,showButtons:!1,palette:c})}var a=n;n={};a.props=n;var m=a.api.debug.getLogger("prochart.gui.props"),s="",e=[],k=[],w=[],r=a.api.layout.getbuttonStyle();n.gui={viewProps:function(){E();s="General Properties";a.commonutils.func.detectmob()?
D("test",s):B("test",s);var b=a.patterns.props.form;$("#chart-dialog").html(b);x();y();u();z();$("#color-opacity-volume").slider({min:0,max:100});b=[];b.push("color-grid-vertical","color-grid-hotizontal","color-watermark");for(var d=0;d<b.length;d++)A($("#"+b[d]),"#225437");f("#control-grid-vertical","#color-grid-vertical",null,null,null);f("#control-grid-hotizontal","#color-grid-hotizontal",null,null,null);$("#color-opacity-watermark").slider({min:0,max:100});F();G();a.chart.IsVolumeEnabled()||$(".properties-tabs").find(".volume-property-tab").css("display",
"none");"undefined"!=typeof a.localizationobj&&a.localizationobj.gui.updateFromDataLang($("#chart-dialog"));$("#chart-dialog").dialog("open")},viewPriceOnly:function(b,d){E();s=d.GetSymbol();a.commonutils.func.detectmob()?D("test",s):B("test",s);var c=a.patterns.props.priceonlyform;$("#chart-dialog").html(c);x();y();u();z();"undefined"!=typeof a.localizationobj&&a.localizationobj.gui.updateFromDataLang($("#chart-dialog"));$("#chart-dialog").dialog("open")},viewVolumeOnly:function(){}};n.init={};return n}
;
...
function ProChart_InitTradingCentral(q){function r(){var b=h.init.styleConfigpath,a=$.Deferred();if(e.navigator.XMLHttpRequest()){var g=new XMLHttpRequest;g.open("get",b);g.onload=function(){var f=$.parseJSON(g.responseText);$.parseJSON(g.responseText);h.init.styleConfig=f;h.init.styleConfigNeedRequest=!1;m();a.resolve(f)};g.send();return a}$.ajax({url:b,dataType:"json",data:{},async:!0}).done(function(f){h.init.styleConfig=f;h.init.styleConfigNeedRequest=!1;m();a.resolve(f)});return a.promise()}
function m(){l.debug("getTC_Data");var b=n,a=$.Deferred();if(e.navigator.XMLHttpRequest()){var g=new XMLHttpRequest;g.open("get",b);g.onload=function(){var f=g.responseText,b=$.parseXML(f);p(b);e.panels.gui.updateInfomsg(!0,h.init.dataLegend);a.resolve(f);e.preloadobj.endPreload()};g.send();return a}$.ajax({url:b,type:"GET",dataType:"xml",data:{},async:!0}).done(function(b){l.debug("XML:",b);p(b);e.panels.gui.updateInfomsg(!0,h.init.dataLegend);a.resolve(b);e.preloadobj.endPreload()});return a.promise()}
function p(b){var a,g,f=null;try{f=e.pivotLib.GetCleanDataObject()}catch(m){return null}var f=f.data[0],k=f.pivot,c=$(b).find("chartlevels");if(0<c.length){for(var c=c[0].childNodes,d=0;d<c.length;d++)switch(c[d].nodeName){case "resistance1":k.res1=parseFloat(c[d].textContent);break;case "resistance2":k.res2=parseFloat(c[d].textContent);break;case "resistance3":k.res3=parseFloat(c[d].textContent);break;case "support1":k.sup1=parseFloat(c[d].textContent);break;case "support2":k.sup2=parseFloat(c[d].textContent);
break;case "support3":k.sup3=parseFloat(c[d].textContent);break;case "pivot":k.pivot=parseFloat(c[d].textContent);break;case "last":k.valueC=parseFloat(c[d].textContent)}c=$(b).find("header");if(0<c.length)for(c=c[0].childNodes,g=a=null,d=0;d<c.length;d++)switch(c[d].nodeName){case "date":a=c[d].textContent;a=a.substr(0,4)+"-"+a.substr(4,2)+"-"+a.substr(6,2);break;case "hour":g=c[d].textContent+":00"}k.term=$(b).find("term").text();k.dateB=e.chart.GetDateEpoch(a+" "+g);g=e.chart.GetNumOfCandles();
k.dateC=e.chart.getDateByIndex(g-1,!0);k.dateA=e.chart.getDateByIndex(g-7,!0);a=5;switch(e.chart.GetTimeScale().toLowerCase()){case "1t":a=1;blnBoundRight=!0;break;case "1s":a=1;blnBoundRight=!0;break;case "10s":a=1;blnBoundRight=!0;break;case "1m":a=30;break;case "5m":a=42;break;case "10m":a=21;break;case "15m":a=14;break;case "30m":a=7;break;case "60m":a=5;break;case "2h":a=5;break;case "4h":a=1;break;case "6h":a=1;break;case "8h":a=1;break;case "12h":a=1;break;case "1d":a=1;break;case "1w":a=15;
break;case "1n":a=7}k.targetdate=e.chart.getDateByIndex(g-1+a,!0);l.debug("objDataItem",f);e.pivotLib.PerformTCLogicOnData(f);e.pivotLib.RenderTC(h.init.styleConfig,f)}else l.debug("Error","No ALERT found for your criteria. error_instrument."),h.init.dataLegend="No ALERT found for your criteria. error_instrument.",e.preloadobj.endPreload();f=$(b).find("story");b="";if(0<f.length){c=f[0].childNodes;for(d=0;d<c.length;d++)switch(c[d].nodeName){case "title":b=b+"<h2>"+c[d].textContent+"</h2>";break;
case "summary":b=b+"<h3>"+c[d].textContent+"</h3>";break;case "paragraph":b=b+"<p>"+c[d].textContent+"</p>"}h.init.dataLegend=b;l.debug("Legend",b)}}var e=q,h={};e.tradingCentral=h;var n="",l=e.api.debug.getLogger("prochart.signals.tradingcentral");h.gui={};h.api={render:function(b){n=b;e.preloadobj.startPreload();l.debug("Render begin");h.init.styleConfigNeedRequest?r():m()},hide:function(){"undefined"!=typeof e.pivotLib&&(e.pivotLib.ClearView(),e.panels.gui.updateInfomsg(!1,""))}};h.init={styleConfig:null,
styleConfigpath:"tradingcentral.config.js",styleConfigNeedRequest:!0,dataLegend:""};return h};
function ProChart_InitSigmaInvest(J){function v(b){for(var c=0;c<d.toolbaradvobj.gui.groupproperties.length;c++){var e=d.toolbaradvobj.gui.groupproperties[c];if(e.id==b)return e}return null}function y(a){z=a;d.preloadobj.startPreload();k.debug("Render begin");if(b.init.alreadyLoaded)A();else{var c=$.Deferred();$.when(K(),L(),M(),N(),d.patterns.setPatterns(h.patters)).done(function(){b.init.alreadyLoaded=!0;var a=b.init.svg.svgpath;d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"point1"});
d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"point2"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"point3"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"point4"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"point5"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"point6"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"point7"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"point8"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,
svgid:"point9"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"focus-all"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"focus-vertical"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"focus-horizontal"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"nopoint"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"events2"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"events3"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"events4"});
d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"events5"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"events6"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"change_way"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"events3-part1"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"pop-right"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"pop-center"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"pop-left"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,
svgid:"pop-right2"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"pop-center2"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"pop-left2"});d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"oval"});for(var f=0;10>=f;f++)d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"down"+f}),d.toolbaradvobj.svg.gui.svgiconsSetItem({svgfile:a,svgid:"up"+f});O();a={type:"sigmainvest",dragcallback:"sigmainvest-drag-float"};b.init.layout.data&&(b.init.layout.data&&b.init.layout.data.floatingpanel&&
(a.floatingpanel=jQuery.extend(!0,{},b.init.layout.data.floatingpanel)),b.init.layout.data&&b.init.layout.data.toolbars&&(a.toolbars=jQuery.extend(!0,[],b.init.layout.data.toolbars)));b.localstorage.floatpanel.read();b.localstorage.floatpanel.data.top&&b.localstorage.floatpanel.data.bottom&&b.localstorage.floatpanel.data.right&&b.localstorage.floatpanel.data.left&&(a.position={top:b.localstorage.floatpanel.data.top,left:b.localstorage.floatpanel.data.left,right:b.localstorage.floatpanel.data.right,
bottom:b.localstorage.floatpanel.data.bottom});b.init.floatpanel.guiid=d.floatingpanels.gui.add(a);if(b.init.layout.data&&b.init.layout.data.toolbars)for(a=0;a<b.init.layout.data.toolbars.length;a++)if(b.init.layout.data.toolbars[a].items)for(var f=b.init.layout.data.toolbars[a].items,g=0;g<f.length;g++)"space"==f[g].type&&"caption"==f[g].type||$.prochartcache.get("#"+b.init.floatpanel.guiid,'button[tid="'+f[g].id+'"]'),"button-group"==f[g].type&&b.init.floatpanel.button_groups.push({id:f[g].id});
a=v("group-story-button");b.localstorage.story.read();$.prochartcache.get("#"+b.init.floatpanel.guiid,".sigmaimvest-story")&&(b.localstorage.story.data.panel_height&b.localstorage.story.data.panel_height&&($.prochartcache.get("#"+b.init.floatpanel.guiid,".sigmaimvest-story").height(b.localstorage.story.data.panel_height),$.prochartcache.get("#"+b.init.floatpanel.guiid,".sigmaimvest-story").width(b.localstorage.story.data.panel_width),a&&(a.group.size.width&&(a.group.size.width=b.localstorage.story.data.panel_width),
a.group.size.height&&(a.group.size.height=b.localstorage.story.data.panel_height))),b.localstorage.story.data.panel_possition&&a&&a.group&&(a.group.possition=b.localstorage.story.data.panel_possition),b.localstorage.story.data.panel_style&&$.prochartcache.get("#"+b.init.floatpanel.guiid,".se-story-content ")&&$.prochartcache.get("#"+b.init.floatpanel.guiid,".se-story-content ").removeClass("se-story-content-style2 se-story-content-style3 se-story-content-style1").addClass(b.localstorage.story.data.panel_style),
b.localstorage.story.data.panel_fontsize&&$.prochartcache.get("#"+b.init.floatpanel.guiid,".se-story-content > div")&&$.prochartcache.get("#"+b.init.floatpanel.guiid,".se-story-content > div").css({"font-size":b.localstorage.story.data.panel_fontsize}),b.localstorage.story.data.panel_alignh&&a&&a.group.alignh&&(a.group.alignh=b.localstorage.story.data.panel_alignh));a=v("group-events-button");b.localstorage.story.data.panel_possition&&a&&a.group&&(a.group.possition=b.localstorage.story.data.panel_possition);
A();c.resolve()});return c.promise()}}function B(a){if(b.init.pivot.library)y(a);else{var c="?"+Math.floor(102320*Math.random()+1),e=document.createElement("link");e.type="text/css";e.rel="stylesheet";e.href=d.guiinit.rootpath+"/ChartSignals/sigmatrend/inner.class.css"+c;document.getElementsByTagName("head")[0].appendChild(e);for(var c={"sigmainvest.pivot":d.guiinit.rootpath+"/ChartSignals/sigmatrend/sandr.lib/pivot.lib.js"+c,"sigmainvest.canvasimage":d.guiinit.rootpath+"/ChartSignals/sigmatrend/images.lib/images.lib.js"+
c},e={},f=Object.keys(c),g=0;g<f.length;g++){var h=f[g];e[h]=c[h]}requirejs.config({paths:e});c=Object.keys(e);require(c,function(){b.init.pivot.library=new SigmaTrendEventsLibrary(d);b.init.canvasimage.library=new SigmaTrendImagesLibrary;y(a)})}}function K(){var a=b.init.pivot.configpath?b.init.pivot.configpath:h.styleConfigpath,c=$.Deferred();if(d.navigator.XMLHttpRequest()){var e=new XMLHttpRequest;e.open("get",a);e.onload=function(){var a=$.parseJSON(e.responseText);$.parseJSON(e.responseText);
b.init.pivot.config=a;c.resolve(a)};e.send();return c}$.ajax({url:a,dataType:"json",data:{},async:!0}).done(function(a){b.init.pivot.config=a;c.resolve(a)}).fail(function(a,b){c.resolve()});return c.promise()}function M(){var a=b.init.canvasimage.configpath?b.init.canvasimage.configpath:h.canvasimage_configpath,c=$.Deferred();if(d.navigator.XMLHttpRequest()){var e=new XMLHttpRequest;e.open("get",a);e.onload=function(){var a=$.parseJSON(e.responseText);$.parseJSON(e.responseText);b.init.canvasimage.config=
a;c.resolve(a)};e.send();return c}$.ajax({url:a,dataType:"json",data:{},async:!0}).done(function(a){b.init.canvasimage.config=a;c.resolve(a)}).fail(function(a,b){c.resolve()});return c.promise()}function L(){var a=b.init.layout.layoutpath?b.init.layout.layoutpath:h.layoutpath,c=$.Deferred();if(d.navigator.XMLHttpRequest()){var e=new XMLHttpRequest;e.open("get",a);e.onload=function(){var a=$.parseJSON(e.responseText);$.parseJSON(e.responseText);b.init.layout.data=a;c.resolve(a)};e.send();return c}$.ajax({url:a,
dataType:"json",data:{},async:!0}).done(function(a){b.init.layout.data=a;c.resolve(a)}).fail(function(a,b){c.resolve()});return c.promise()}function N(){var a="?"+Math.floor(102320*Math.random()+1),a=d.guiinit.rootpath+"/ChartSignals/sigmatrend/icons.svg"+a,b=$.Deferred();if(d.navigator.XMLHttpRequest()){var e=new XMLHttpRequest;e.open("get",a);e.onload=function(){var a=e.responseText,d=$.parseXML(a);C(d);b.resolve(a)};e.send();return b}$.ajax({url:a,type:"GET",dataType:"xml",data:{},async:!0}).done(function(a){k.debug("XML:",
a);C(a);b.resolve(a)});return b.promise()}function C(a){a=$(a).find("symbol");for(var c=0;c<a.length;c++){var d=a[c],f=d.attributes.viewBox.value.split(" "),g=d.attributes.id.value;obj_svg={width:f[2],height:f[3],top:f[0],left:f[1],paths:[]};paths=d.children;for(d=0;d<paths.length;d++)obj_path={d:paths[d].attributes.d.value},obj_svg.paths.push(obj_path);b.init.svg_objects.add(g,obj_svg)}}function O(){d.events.multicallback.setCallback("sigmainvest-drag-float","dragg",function(a){if(a.status)switch(a.status){case "resizing":b.localstorage.floatpanel.data.top=
a.position.top;b.localstorage.floatpanel.data.left=a.position.left;b.localstorage.floatpanel.data.right=a.position.right;b.localstorage.floatpanel.data.bottom=a.position.bottom;break;case "completed":p=null,b.localstorage.floatpanel.save()}});d.events.multicallback.setCallback("sigmainvest_story_resize","resize",function(a){console.log("resize",a);if(a.status)switch(a.status){case "started":p={width:$.prochartcache.get("#"+b.init.floatpanel.guiid+" .sigmaimvest-story").width(),height:$.prochartcache.get("#"+
b.init.floatpanel.guiid+" .sigmaimvest-story").height(),left:$.prochartcache.get("#"+b.init.floatpanel.guiid+" .sigmaimvest-story").offset().left,right:$.prochartcache.get("#"+b.init.floatpanel.guiid+" .sigmaimvest-story").offset().right};break;case "resizing":p&&($.prochartcache.get("#"+b.init.floatpanel.guiid+" .sigmaimvest-story").height(p.height-a.position.deltaY),$.prochartcache.get("#"+b.init.floatpanel.guiid+" .sigmaimvest-story").width(p.width-a.position.deltaX),a.position.grouppropes&&"center"===
a.position.grouppropes.align&&($.prochartcache.get("#"+b.init.floatpanel.guiid+" .sigmaimvest-story").offset({left:p.left+a.position.deltaX/2}),$.prochartcache.get("#"+b.init.floatpanel.guiid+" .sigmaimvest-story .tlb-array").css({left:"50%"})),b.localstorage.story.data.panel_width=p.width-a.position.deltaX,b.localstorage.story.data.panel_height=p.height-a.position.deltaY);break;case "completed":p=null,b.localstorage.story.save()}});d.events.multicallback.setCallback("ChangeTimeframe","sigmainvest_pivot",
function(a){b.init.urlobj.timescale=a.timescale;k.debug("ChangeTimeframe",a.timescale)});d.events.multicallback.setCallback("ChangeSymbol","sigmainvest_pivot",function(a){b.init.urlobj.symbol=a.symbol.id;k.debug("ChangeSymbol",a.symbol.id)});d.events.multicallback.setCallback("LoadedData","sigmainvest_pivot",function(a){b.init.floatpanel.visibly&&(b.init.urlobj.timescale=a.timescale,b.init.urlobj.symbol=a.symbolid,a=b.init.urlobj.getUrlPath(),B(a))});d.events.multicallback.setCallback("sigmainvest_test",
"event1",function(a){t()});d.events.multicallback.setCallback("sigmainvest-changeway","event1",function(a){$.prochartcache.get("#"+b.init.floatpanel.guiid+' button[callbackfamily="sigmainvest-changeway"] .se_changeway')&&(a=$.prochartcache.get("#"+b.init.floatpanel.guiid+' button[callbackfamily="sigmainvest-changeway"] .se_changeway').attr("class"),a=a.match(/status_way_top/i)?a.replace(/ status_way_top/g,"")+" status_way_bottom":a.replace(/ status_way_bottom/g,"")+" status_way_top",$.prochartcache.get("#"+
b.init.floatpanel.guiid+' button[callbackfamily="sigmainvest-changeway"] .se_changeway').attr("class",a));for(a=0;a<d.toolbaradvobj.gui.groupproperties.length;a++)for(var c=d.toolbaradvobj.gui.groupproperties[a],e=0;e<b.init.floatpanel.button_groups.length;e++)c.id==b.init.floatpanel.button_groups[e].id&&(c.group.possition="bottom"==c.group.possition?"top":"bottom",b.localstorage.story.data.panel_possition=c.group.possition,b.localstorage.story.save());for(a=0;a<b.init.floatpanel.button_groups.length;a++)$.prochartcache.get("#"+
b.init.floatpanel.guiid,'button[tid="'+b.init.floatpanel.button_groups[a].id+'"]').parent().find(".tlb-button-groups ")&&"none"!=$.prochartcache.get("#"+b.init.floatpanel.guiid,'button[tid="'+b.init.floatpanel.button_groups[a].id+'"]').parent().find(".tlb-button-groups ").css("display")&&d.toolbaradvobj.gui.showGroup($.prochartcache.get("#"+b.init.floatpanel.guiid,'button[tid="'+b.init.floatpanel.button_groups[a].id+'"]').parent())});d.events.multicallback.setCallback("sigmainvest-story-config","event1",
function(a){switch(a.id){case "increased-font":$.prochartcache.get("#"+b.init.floatpanel.guiid,".se-story-content > div")&&($.prochartcache.get("#"+b.init.floatpanel.guiid,".se-story-content > div").css({"font-size":"+=1"}),b.localstorage.story.data.panel_fontsize=$.prochartcache.get("#"+b.init.floatpanel.guiid,".se-story-content > div").css("font-size"),b.localstorage.story.save());break;case "decreased-font":$.prochartcache.get("#"+b.init.floatpanel.guiid,".se-story-content > div")&&($.prochartcache.get("#"+
b.init.floatpanel.guiid,".se-story-content > div").css({"font-size":"-=1"}),b.localstorage.story.data.panel_fontsize=$.prochartcache.get("#"+b.init.floatpanel.guiid,".se-story-content > div").css("font-size"),b.localstorage.story.save());break;case "change-style-1":$.prochartcache.get("#"+b.init.floatpanel.guiid,".se-story-content ")&&($.prochartcache.get("#"+b.init.floatpanel.guiid,".se-story-content ").removeClass("se-story-content-style2 se-story-content-style3 se-story-content-style1").addClass("se-story-content-style1"),
b.localstorage.story.data.panel_style="se-story-content-style1",b.localstorage.story.save());break;case "change-style-2":$.prochartcache.get("#"+b.init.floatpanel.guiid,".se-story-content ")&&($.prochartcache.get("#"+b.init.floatpanel.guiid,".se-story-content ").removeClass("se-story-content-style2 se-story-content-style3 se-story-content-style1").addClass("se-story-content-style2"),b.localstorage.story.data.panel_style="se-story-content-style2",b.localstorage.story.save());break;case "change-style-3":$.prochartcache.get("#"+
b.init.floatpanel.guiid,".se-story-content ")&&($.prochartcache.get("#"+b.init.floatpanel.guiid,".se-story-content ").removeClass("se-story-content-style2 se-story-content-style3 se-story-content-style1").addClass("se-story-content-style3"),b.localstorage.story.data.panel_style="se-story-content-style3",b.localstorage.story.save());break;case "pop-right":case "pop-left":case "pop-center":a=a.id.split("-")[1];for(var c=0;c<d.toolbaradvobj.gui.groupproperties.length;c++){var e=d.toolbaradvobj.gui.groupproperties[c];
"group-story-button"==e.id&&(e.group.alignh=a)}b.localstorage.story.data.panel_alignh=a;b.localstorage.story.save();$.prochartcache.get("#"+b.init.floatpanel.guiid,'button[tid="group-story-button"]').parent().find(".tlb-button-groups ")&&"none"!=$.prochartcache.get("#"+b.init.floatpanel.guiid,'button[tid="group-story-button"]').parent().find(".tlb-button-groups ").css("display")&&d.toolbaradvobj.gui.showGroup($.prochartcache.get("#"+b.init.floatpanel.guiid,'button[tid="group-story-button"]').parent())}});
d.events.multicallback.setCallback("sigmainvest_change_symbol","event1",function(a){d.chart.ChangeSymbolAndTimeScale({id:a.callbackarg.symbolID,name:a.callbackarg.symbolName,precision:a.callbackarg.precision},a.callbackarg.timescale.toUpperCase())});d.events.multicallback.setCallback("sigmainvest","event1",function(a){switch(a.id){case "focus-vertical":if(b.init.pivot.library){var c=b.init.pivot.library.IsZoomedOnAllPriceRates();b.init.pivot.library.ZoomOnAllPriceRates(!c);D({key:a.id,status:!c})}break;
case "focus-horizontal":b.init.pivot.library&&b.init.pivot.library.ZoomOnAllDateRange();break;case "rsi-point":if(b.init.pivot.components&&b.init.pivot.components.rsi){c=b.init.pivot.components.rsi;if(!c.HasData())break;c.IsVisible()||c.Show(!0);c.Zoom()}break;case "rsi-show":if(b.init.pivot.components&&b.init.pivot.components.rsi){c=b.init.pivot.components.rsi;if(!c.HasData())break;c.IsVisible()?c.Show(!1):c.Show(!0)}break;case "pivot-show":if(b.init.pivot.components&&b.init.pivot.components.pivot){c=
b.init.pivot.components.pivot;if(!c.HasData())break;c.IsVisible()?c.Show(!1):c.Show(!0)}break;case "pivot-point":if(b.init.pivot.components&&b.init.pivot.components.pivot){c=b.init.pivot.components.pivot;if(!c.HasData())break;c.IsVisible()||c.Show(!0);c.Zoom()}break;case "sma-show":if(b.init.pivot.components&&b.init.pivot.components.sma){c=b.init.pivot.components.sma;if(!c.HasData())break;c.IsVisible()?c.Show(!1):c.Show(!0);console.log("objSMA",a)}break;case "sma-point":if(b.init.pivot.components&&
b.init.pivot.components.sma){c=b.init.pivot.components.sma;if(!c.HasData())break;c.IsVisible()||c.Show(!0);c.Zoom()}break;case "cspattern-show":if(b.init.pivot.components&&b.init.pivot.components.cspattern){c=b.init.pivot.components.cspattern;if(!c.HasData())break;c.IsVisible()?c.Show(!1):c.Show(!0)}break;case "cspattern-point":if(b.init.pivot.components&&b.init.pivot.components.cspattern){c=b.init.pivot.components.cspattern;if(!c.HasData())break;c.IsVisible()||c.Show(!0);c.Zoom()}break;case "bbands-show":if(b.init.pivot.components&&
b.init.pivot.components.bbands){c=b.init.pivot.components.bbands;if(!c.HasData())break;c.IsVisible()?c.Show(!1):c.Show(!0)}break;case "bbands-point":if(b.init.pivot.components&&b.init.pivot.components.bbands){c=b.init.pivot.components.bbands;if(!c.HasData())break;c.IsVisible()||c.Show(!0);c.Zoom()}break;case "chartpattern-show":if(b.init.pivot.components&&b.init.pivot.components.chartpattern){c=b.init.pivot.components.chartpattern;if(!c.HasData())break;c.IsVisible()?c.Show(!1):c.Show(!0)}break;case "chartpattern-point":if(b.init.pivot.components&&
b.init.pivot.components.chartpattern){c=b.init.pivot.components.chartpattern;if(!c.HasData())break;c.IsVisible()||c.Show(!0);c.Zoom()}break;case "fibopattern-show":if(b.init.pivot.components&&b.init.pivot.components.fibopattern){c=b.init.pivot.components.fibopattern;if(!c.HasData())break;c.IsVisible()?c.Show(!1):c.Show(!0)}break;case "fibopattern-point":if(b.init.pivot.components&&b.init.pivot.components.fibopattern){c=b.init.pivot.components.fibopattern;if(!c.HasData())break;c.IsVisible()||c.Show(!0);
c.Zoom()}}"focus-vertical"!=a.id&&"focus-horizontal"!=a.id&&E()})}function t(){var a=b.init.eventobj.url,c=$.Deferred();if(d.navigator.XMLHttpRequest()){var e=new XMLHttpRequest;e.open("jsonp",a);e.onload=function(){var a=$.parseJSON(e.responseText);$.parseJSON(e.responseText);F(a);c.resolve(a)};e.send();return c}$.ajax({url:a,dataType:"jsonp",data:{},async:!0}).done(function(a){F(a);c.resolve(a)}).fail(function(a,b){c.resolve()});return c.promise()}function F(a){if($.prochartcache.get("#"+b.init.floatpanel.guiid,
"  .sigmaevents-events")){for(var c=b.init.eventobj.eventsUpdate,e=0;e<c.length;e++)$.prochartcache.del("#"+c[e].id+" .si_event_expiration"),$.prochartcache.del("#"+c[e].id+" .si-event-button");var f="",e={items:[]};b.init.eventobj.eventsUpdate=[];if(a.events){for(f=0;f<a.events.length;f++){var g=a.events[f],q=d.commonutils.func.returnShortUniqID();b.init.eventobj.eventsUpdate.push({id:q,expiration:g.expiration});var u=G(g.expiration),q={type:"custom-item",pattern:d.patterns[h.patters.name].eventitem,
values:[{key:"%id%",val:q},{key:"%css-svg%",val:""},{key:"%inline-css-svg%",val:(-1==g.direction?"cs-fill-red":1==g.direction?"cs-fill-green":"cs-fill-black")+" hw16"},{key:"%inline-css-svg%",val:""},{key:"%svg-file%",val:b.init.svg.svgpath},{key:"%svg-id%",val:(-1==g.direction?"down":1==g.direction?"up":"n")+g.sortValue},{key:"%symbol%",val:g.name},{key:"%timeframe%",val:g.timescale},{key:"%t1%",val:0<u.d?u.d+"d":u.h+"h"},{key:"%t2%",val:0<u.d?u.h+"h":u.m+"m"}],callback:"sigmainvest_change_symbol",
callbackarg:{symbolID:g.id,timescale:g.timescale,precision:g.precision,symbolName:g.name}};console.log(q.values[5],g.direction,q.values[2],q.values[0]);e.items.push(q)}f=d.commonutils.func.returnShortUniqID();b.init.eventobj.eventsLastUpdateTume={id:f};a={type:"custom-item",pattern:d.patterns[h.patters.name].eventitemlastupdate,values:[{key:"%id%",val:f},{key:"%css%",val:""},{key:"%inline-css-svg%",val:"svg-small-icon"},{key:"%svg-file%",val:b.init.svg.svgpath},{key:"%svg-id%",val:"clock-update2"},
{key:"%lastupdate_content%",val:d.chart.formatDate(a.updated,!0)}]};e.items.unshift(a);f=d.toolbaradvobj.gui.insertItems2Group(e)}$.prochartcache.get("#"+b.init.floatpanel.guiid,"  .sigmaevents-events").html(f);d.toolbaradvobj.gui.updatePartEvents("#"+b.init.floatpanel.guiid+' [callbackfamily="sigmainvest_change_symbol"]');a=b.init.eventobj.eventsUpdate;for(e=0;e<c.length;e++)$.prochartcache.get("#"+a[e].id+" .si_event_expiration"),$.prochartcache.get("#"+a[e].id+" .si-event-button");b.init.timer.id=
setTimeout(function(){H()},0);if($.prochartcache.get("#"+b.init.floatpanel.guiid+' button[tid="group-events-button"] .chart-svg-icon')){var m=$.prochartcache.get("#"+b.init.floatpanel.guiid+' button[tid="group-events-button"] .chart-svg-icon').attr("class"),c=m+" se-reloader_events_run";$.prochartcache.get("#"+b.init.floatpanel.guiid+' button[tid="group-events-button"] .chart-svg-icon').attr("class",c);b.init.timer.idalert=setTimeout(function(){$.prochartcache.get("#"+b.init.floatpanel.guiid+' button[tid="group-events-button"] .chart-svg-icon').attr("class",
m)},1E4)}}}function H(){b.init.timer.step<b.init.timer.maxStep?(b.init.timer.step+=1,P(),b.init.timer.id=setTimeout(function(){H()},b.init.timer.interval)):(b.init.timer.step=b.init.timer.step=0,t())}function P(){for(var a=b.init.eventobj.eventsUpdate,c=0;c<a.length;c++)if(0<=a[c].expiration){a[c].expiration-=1;var e=G(a[c].expiration),e=(0<a[c].expiration?d.patterns[h.patters.name].expiration:d.patterns[h.patters.name].empty).replace(/%t1%/g,0<e.d?e.d+"d":e.h+"h").replace(/%t2%/g,0<e.d?e.h+"h":e.m+
"m");$.prochartcache.get("#"+a[c].id+" .si_event_expiration")&&$.prochartcache.get("#"+a[c].id+" .si_event_expiration").html(e);0>=a[c].expiration&&$.prochartcache.get("#"+a[c].id+" .si-event-button")&&$.prochartcache.get("#"+a[c].id+" .si-event-button").addClass("event_aleady_expire")}}function G(a){if(0<a){var b=Math.floor(a/1440),e=(a-1440*b)/60;a=Math.floor(e);e=Math.round(60*(e-a));return{d:b,h:d.commonutils.func.pub(a,2),m:d.commonutils.func.pub(e,2)}}return{d:0,h:0,m:0}}function A(){k.debug("getSigmaInvest_Data");
var a=z,b=$.Deferred();if(d.navigator.XMLHttpRequest()){var e=new XMLHttpRequest;e.open("jsonp",a);e.onload=function(){var a=e.responseText;I(a);b.resolve(a);d.preloadobj.endPreload()};e.send();return b}$.ajax({url:a,type:"GET",contentType:"application/json; charset=utf-8",dataType:"jsonp",data:{},async:!0}).done(function(a){I(a);b.resolve(a);d.preloadobj.endPreload()}).fail(function(a,d){b.resolve()});return b.promise()}function I(a){k.debug("Json:",a);Q(a);if($.prochartcache.get("#"+b.init.floatpanel.guiid,
'[tid="item-sigmaimvest-story-content"]'))for(a=b.init.story.formattedPreTitle+b.init.story.formattedTitleAlt+b.init.story.formattedStory,$.prochartcache.get("#"+b.init.floatpanel.guiid,'[tid="item-sigmaimvest-story-content"]').html(a),a=0;a<b.init.story.canvas_array.length;a++){var c=b.init.story.canvas_array[a].data,e=b.init.canvasimage.config,f=$("#"+b.init.story.canvas_array[a].id);f&&f[0]&&b.init.canvasimage.library.Render(f[0],e,c)}E();b.init.floatpanel.visibly=!0;d.floatingpanels.gui.show({type:"sigmainvest"});
b.init.timer.id?k.debug("Timer exist, not need Update EVENTS "):(k.debug("Timer not exist, Update EVENTS now"),t())}function Q(a){function c(a){a="story_"+a.toLowerCase();return d.patterns[h.patters.name]&&d.patterns[h.patters.name][a]?d.patterns[h.patters.name][a]:"%text%"}function e(a){for(var e=Object.keys(b.init.story.source_values),f=0;f<e.length;f++){var g="%"+e[f]+"%",h=b.init.story.source_values[e[f]];switch(e[f]){case "CreatedVal":h=d.chart.formatDate(parseFloat(h))}h=c(e[f]).replace(/%text%/g,
h);a=a.replace(new RegExp(g,"g"),h)}return a}function f(a,c){for(var e=a,f=Object.keys(b.init.story.source_types),g=0;g<f.length;g++){var l="%"+f[g]+"%",m=b.init.story.source_types[f[g]],n=!1,q=null;if(c)for(var k=0;k<c.length;k++)if(c[k].key==f[g]){n=!0;q=k;break}k="";k=n?d.patterns[h.patters.name].story_typehelp.replace(/%id%/g,c[q].id).replace(/%text%/g,m).replace(/%svg%/g,d.toolbaradvobj.svg.gui.svgiconsGetItem({icon:"question"})):d.patterns[h.patters.name].story_type.replace(/%text%/g,m);e=e.replace(new RegExp(l,
"g"),k)}return e}function g(a){if(b.init.story.source_description)for(var c=0;c<b.init.story.source_description.length;c++)if(b.init.story.source_description[c].key==a)return b.init.story.source_description[c].text;return null}function q(a){for(var c=Object.keys(b.init.story.source_types),d=[],e=0;e<c.length;e++)a.match(new RegExp("%"+c[e]+"%","g"))&&d.push({key:c[e],value:b.init.story.source_types[c[e]]});return d}function u(){var a=[];if(b.init.story.source_description)for(var c=0;c<b.init.story.source_description.length;c++)a.push({key:b.init.story.source_description[c].key,
id:d.commonutils.func.returnShortUniqID()});return a}b.init.pivot.components=b.init.pivot.library.Render(b.init.pivot.config,a);var m=[];b.init.dataIStory=jQuery.extend(!0,{},a.istory);if(a.istory){b.init.story.source_values=a.istory.values;b.init.story.source_content=a.istory.content;b.init.story.source_title=a.istory.title;b.init.story.source_types=a.istory.types;b.init.story.source_symbolname=a.istory.symbolname;b.init.story.source_timescale=a.istory.timescale;b.init.story.source_updatetime=a.istory.updatetime;
b.init.story.source_summary=a.istory.summary;b.init.story.source_score=a.istory.score;b.init.story.source_direction=a.istory.direction;b.init.story.source_description=a.istory.description;b.init.story.canvas_array=[];b.init.story.formattedStory="";b.init.story.formattedSummary="";b.init.story.formattedTitle="";b.init.story.formattedTitleAlt="";a=b.init.story.source_content;for(var l=0;l<a.length;l++){var w=a[l].type;switch(w){case "p":case "warning":case "info":var n=a[l].text,r="",k=q(n),p=u(),n=
e(n);if(k)for(var x=0;x<k.length;x++){var s=g(k[x].key);s&&(r+=d.patterns[h.patters.name].story_description.replace(/%title%/g,k[x].value).replace(/%id%/g,function(){for(var a=0;a<p.length;a++)if(p[a].key==k[x].key)return p[a].id;return""}).replace(/%text%/g,s))}n=f(n,p);s=d.patterns[h.patters.name].story_paragraph;"warning"==w&&(s=d.patterns[h.patters.name].story_warning);b.init.story.formattedStory=b.init.story.formattedStory+s.replace(/%class%/g,"se-story-"+w).replace(/%svg-file%/g,b.init.svg.svgpath).replace(/%svg-id%/g,
"attention").replace(/%text%/g,n)+r;break;case "caption":n=a[l].text;n=f(n,p);b.init.story.formattedStory+=d.patterns[h.patters.name].story_caption.replace(/%text%/g,n);break;case "delimiter":b.init.story.formattedStory+=d.patterns[h.patters.name].story_delimiter;break;case "canvas":w=a[l].data;n=d.commonutils.func.returnShortUniqID();r="";if(a[l].legend&&0<a[l].legend.length)for(s=0;s<a[l].legend.length;s++)var t=a[l].legend[s],v=b.init.canvasimage.getStylebyPath(t.color),r=r+d.patterns[h.patters.name].canvas_legend_item.replace(/%svg-file%/g,
b.init.svg.svgpath).replace(/%svgstyle%/g,"fill:"+(v?v:"#ffffff")).replace(/%svg-id%/g,"oval-border2").replace(/%legenditem%/g,t.text);b.init.story.formattedStory+=d.patterns[h.patters.name].story_canvas.replace(/%svg-id%/g,"point"+a[l].markerID).replace(/%legend%/g,r).replace(/%svg-file%/g,b.init.svg.svgpath).replace(/%caption%/g,a[l].caption).replace(/%canvasid%/g,n);m.push({id:n,data:w})}}b.init.story.canvas_array=m;m=b.init.story.source_title;m=e(m);m=f(m);b.init.story.formattedTitle=c("title").replace(/%text%/g,
m);b.init.story.formattedPreTitle=d.patterns[h.patters.name].story_pretitle.replace(/%text%/g,"Sigma Trend Analytics presents smart technical analysis for:");b.init.story.formattedTitleAlt=d.patterns[h.patters.name].story_title_alt.replace(/%svgicon%/g,(1==b.init.story.source_direction?"up":"down")+b.init.story.source_score).replace(/%svgpath%/g,h.svgpath).replace(/%symbol%/g,b.init.story.source_symbolname).replace(/%timescale%/g,d.localizationobj.gui.returnLocalizationString("menu.timescale."+b.init.story.source_timescale.toUpperCase())).replace(/%localizetimescale%/g,
b.init.story.source_timescale.toUpperCase()).replace(/%updatetime%/g,d.chart.formatDate(parseFloat(b.init.story.source_updatetime),!0));m=b.init.story.source_summary;for(a=0;a<m.length;a++)switch(m[a].type){case "p":l=m[a].text,l=e(l),l=f(l),b.init.story.formattedSummary+=c("paragraph").replace(/%text%/g,l)}}else b.init.story.formattedStory="",b.init.story.formattedSummary="",b.init.story.formattedTitle="",b.init.story.formattedTitleAlt="",b.init.story.canvas_array=[]}function E(){for(var a="rsi pivot sma cspattern bbands chartpattern fibopattern".split(" "),
c="rsi-show pivot-show sma-show cspattern-show bbands-show chartpattern-show fibopattern-show".split(" "),e="rsi-point pivot-point sma-point cspattern-point bbands-point chartpattern-point fibopattern-point".split(" "),f=0;f<a.length;f++){var g=b.init.pivot.components[a[f]].IsVisible(),h=b.init.pivot.components[a[f]].HasData(),k=b.init.pivot.components[a[f]].GetMarkerNumber(),m=h?b.init.pivot.components[a[f]].GetDirection():null,l=c[f],p=e[f],n=g,g=k,k=b.init.svg.svgpath,g=h?"point"+g:"nopoint",r=
n?d.api.toolbar.props.on_color:d.api.toolbar.props.off_color,n=n?d.api.toolbar.props.on_backroundcolor:d.api.toolbar.props.off_backroundcolor,m=1==m?d.api.toolbar.props.up_color:d.api.toolbar.props.down_color,r=h?r:d.api.toolbar.props.noactive_color;if($.prochartcache.get("#"+b.init.floatpanel.guiid,'button[tid="'+l+'"]')){var t={color:r,"background-color":n,"border-bottom-color":m,"border-bottom-width":h?"4px":"0px","border-bottom-style":"solid"};$.prochartcache.get("#"+b.init.floatpanel.guiid,'button[tid="'+
l+'"]').css(t)}$.prochartcache.get("#"+b.init.floatpanel.guiid,'button[tid="'+p+'"]')&&(l={fill:r,"background-color":n,visibility:h?"0":"hidden","border-bottom-color":m,"border-bottom-width":h?"4px":"0px","border-bottom-style":"solid"},$.prochartcache.get("#"+b.init.floatpanel.guiid,'button[tid="'+p+'"]').find("use").attr("xlink:href",k+"#"+g),$.prochartcache.get("#"+b.init.floatpanel.guiid,'button[tid="'+p+'"]').css(l),$.prochartcache.get("#"+b.init.floatpanel.guiid,'button[tid="'+p+'"]').animate({width:h?
"30px":"0px"},400))}b.init.pivot.library&&(a=b.init.pivot.library.IsZoomedOnAllPriceRates(),D({key:"focus-vertical",status:a}))}function D(a){if($.prochartcache.get("#"+b.init.floatpanel.guiid,'button[tid="'+a.key+'"]')){var c={fill:a.status?d.api.toolbar.props.on_color:d.api.toolbar.props.off_color,"background-color":a.status?d.api.toolbar.props.on_backroundcolor:d.api.toolbar.props.off_backroundcolor};$.prochartcache.get("#"+b.init.floatpanel.guiid,'button[tid="'+a.key+'"]').css(c)}}var d=J,b={};
d.sigmaInvest=b;var z="",k=d.api.debug.getLogger("prochart.signals.sigmainvest");b.gui={};b.api={render:function(a){b.init.urlobj.symbol=a.symbol;b.init.urlobj.timescale=a.timescale;b.init.urlobj.url=a.url;a=b.init.urlobj.getUrlPath();B(a)},hide:function(){b.init.pivot.library&&(b.init.pivot.library.ClearView(),d.panels.gui.updateInfomsg(!1,"",!0),d.floatingpanels.gui.hide({type:"sigmainvest"}),b.init.timer.id&&(clearTimeout(b.init.timer.id),k.debug("Clear Timer "),b.init.timer.id=null),b.init.floatpanel.visibly=
!1)}};var h={styleConfigpath:"/ChartSignals/sigmatrend/sigmatrend.config.js",styleIndicatorsConfigpath:"/ChartSignals/sigmatrend/indicators.lib/indicators.config.js",stylePatternsConfigpath:"/ChartSignals/sigmatrend/patterns.lib/patterns.config.js",stylePivotConfigpath:"/ChartSignals/sigmatrend/sandr.lib/pivot.config.js",styleImagesConfigpath:"/ChartSignals/sigmatrend/images.lib/images.config.js",styleChartConfigpath:"/ChartSignals/sigmatrend/chart.lib/chart.config.js",canvasimage_configpath:"/ChartSignals/sigmatrend/images.lib/images.config.js",
layoutpath:"/ChartSignals/sigmatrend/inner.panel.layout.js",svgpath:"/ChartSignals/sigmatrend/icons.svg",patters:{url:"/ChartSignals/sigmatrend/patterns/events.patterns.htm",name:"sigmaInvest",patterns:[{key:"sigmainvest-event-item",name:"eventitem"},{key:"sigmainvest-event-expiration",name:"expiration"},{key:"sigmainvest-event-expiration-noblank",name:"finishexpiration"},{key:"sigmainvest-event-expiration-empty",name:"empty"},{key:"sigmainvest-story",name:"story"},{key:"sigmainvest-event-item-lastupdate",
name:"eventitemlastupdate"},{key:"sigmainvest-story-symbolval",name:"story_symbolval"},{key:"sigmainvest-story-createdval",name:"story_createdval"},{key:"sigmainvest-story-targetval",name:"story_targetval"},{key:"sigmainvest-story-targetval1",name:"story_targetval1"},{key:"sigmainvest-story-targetval2",name:"story_targetval2"},{key:"sigmainvest-story-targetval3",name:"story_targetval3"},{key:"sigmainvest-story-altval1",name:"story_altval1"},{key:"sigmainvest-story-altval2",name:"story_altval2"},{key:"sigmainvest-story-altval3",
name:"story_altval3"},{key:"sigmainvest-story-quality",name:"story_quality"},{key:"sigmainvest-story-paragraph",name:"story_paragraph"},{key:"sigmainvest-story-warning",name:"story_warning"},{key:"sigmainvest-story-title",name:"story_title"},{key:"sigmainvest-story-alertstrength",name:"story_alertstrength"},{key:"sigmainvest-story-title-alt",name:"story_title_alt"},{key:"sigmainvest-story-pretitle",name:"story_pretitle"},{key:"sigmainvest-story-header",name:"story_header"},{key:"sigmainvest-story-description",
name:"story_description"},{key:"sigmainvest-story-value",name:"story_value"},{key:"sigmainvest-story-type",name:"story_type"},{key:"sigmainvest-story-typehelp",name:"story_typehelp"},{key:"sigmainvest-story-caption",name:"story_caption"},{key:"sigmainvest-story-delimiter",name:"story_delimiter"},{key:"sigmainvest-story-canvas",name:"story_canvas"},{key:"sigmainvest-story-canvas-legend",name:"canvas_legend"},{key:"sigmainvest-story-canvas-legend-item",name:"canvas_legend_item"}]}};Object.defineProperty(b,
"init",{value:{},writable:!1,configurable:!1});Object.defineProperty(b.init,"alreadyLoaded",{set:function(a){this.stored_library=a},get:function(){return this.stored_library}});Object.defineProperty(b.init,"story",{value:{},writable:!1,configurable:!1});Object.defineProperties(b.init.story,{source_content:{set:function(a){this.stored_source_content=a},get:function(){return this.stored_source_content}},source_summary:{set:function(a){this.stored_source_summary=a},get:function(){return this.stored_source_summary}},
source_values:{set:function(a){this.stored_source_values=a},get:function(){return this.stored_source_values}},source_types:{set:function(a){this.stored_source_types=a},get:function(){return this.stored_source_types}},source_title:{set:function(a){this.stored_source_title=a},get:function(){return this.stored_source_title}},source_updatetime:{set:function(a){this.stored_source_updatetime=a},get:function(){return this.stored_source_updatetime}},source_timescale:{set:function(a){this.stored_source_timescale=
a},get:function(){return this.stored_source_timescale}},source_symbolname:{set:function(a){this.stored_source_symbolname=a},get:function(){return this.stored_source_symbolname}},source_direction:{set:function(a){this.stored_source_direction=a},get:function(){return this.stored_source_direction}},source_score:{set:function(a){this.stored_source_score=a},get:function(){return this.stored_source_score}},source_description:{set:function(a){this.stored_source_description=a},get:function(){return this.stored_source_description}},
formattedStory:{set:function(a){this.stored_formattedStory=a},get:function(){return this.stored_formattedStory}},formatteddTitle:{set:function(a){this.stored_formatteddTitle=a},get:function(){return this.stored_formatteddTitle}},formattedPreTitle:{set:function(a){this.stored_formattedPreTitle=a},get:function(){return this.stored_formattedPreTitle}},formattedSummary:{set:function(a){this.stored_formattedSummary=a},get:function(){return this.stored_formattedSummary}},canvas_array:{set:function(a){this.stored_canvas_array=
a},get:function(){return this.stored_canvas_array}}});Object.defineProperty(b.init,"floatpanel",{value:{},writable:!1,configurable:!1});Object.defineProperties(b.init.floatpanel,{library:{guiid:function(a){this.stored_guiid=a},get:function(){return this.stored_guiid}},visibly:{set:function(a){this.stored_visibly=a},get:function(){return this.stored_visibly?this.stored_visibly:!1}}});Object.defineProperty(b.init.floatpanel,"button_groups",{value:[],writable:!1,configurable:!1});Object.defineProperty(b.init,
"canvasimage",{value:{},writable:!1,configurable:!1});Object.defineProperties(b.init.canvasimage,{library:{set:function(a){this.stored_library=a},get:function(){return this.stored_library}},config:{set:function(a){this.stored_config=a},get:function(){return this.stored_config}},configpath:{set:function(a){this.stored_configpath=a},get:function(){return this.stored_configpath}}});Object.defineProperty(b.init.canvasimage,"getStylebyPath",{value:function(a){return this.stored_config?Object.getProchartByString(this.stored_config,
a):null},writable:!1,configurable:!1});Object.defineProperty(b.init,"layout",{value:{},writable:!1,configurable:!1});Object.defineProperties(b.init.layout,{data:{set:function(a){this.stored_data=a},get:function(){return this.stored_data}},layoutpath:{set:function(a){this.stored_layoutpath=a},get:function(){return this.stored_layoutpath}}});Object.defineProperty(b.init,"pivot",{value:{},writable:!1,configurable:!1});Object.defineProperties(b.init.pivot,{library:{set:function(a){this.stored_library=
a},get:function(){return this.stored_library}},components:{set:function(a){this.stored_components=a},get:function(){return this.stored_components}},config:{set:function(a){this.stored_config=a},get:function(){return this.stored_config}},configpath:{set:function(a){this.stored_configpath=a},get:function(){return this.stored_configpath}}});Object.defineProperty(b.init,"urlobj",{value:{},writable:!1,configurable:!1});Object.defineProperties(b.init.urlobj,{template:{set:function(a){this.stored_template=
a},get:function(){return this.stored_template?this.stored_template:"%url%?asset=%symbol%&timescale=%timescale%"}},symbol:{set:function(a){this.stored_symbol=a},get:function(){return this.stored_symbol}},timescale:{set:function(a){this.stored_timescale=a},get:function(){return this.stored_timescale}}});Object.defineProperty(b.init.urlobj,"getUrlPath",{value:function(){return b.init.urlobj.template.replace(/%url%/g,b.init.urlobj.url).replace(/%symbol%/g,b.init.urlobj.symbol).replace(/%timescale%/g,
b.init.urlobj.timescale)},writable:!1,configurable:!1});Object.defineProperty(b.init,"eventobj",{value:{},writable:!1,configurable:!1});Object.defineProperties(b.init.eventobj,{url:{set:function(a){this.stored_url=a},get:function(){return this.stored_url?this.stored_url:"http://data.sigmatrend.com/signals.py/gettopevents?top=10&sorttype=eventtopscore"}},eventsUpdate:{set:function(a){this.stored_eventsUpdate=a},get:function(){return this.stored_eventsUpdate?this.stored_eventsUpdate:[]}},eventsLastUpdateTume:{set:function(a){this.stored_eventsLastUpdateTume=
a},get:function(){return this.stored_eventsUpdate?this.stored_eventsLastUpdateTume:{id:null}}}});Object.defineProperty(b.init,"svg",{value:{},writable:!1,configurable:!1});Object.defineProperties(b.init.svg,{svgpath:{set:function(a){this.stored_svgpath=a},get:function(){return this.stored_svgpath?this.stored_svgpath:h.svgpath}}});Object.defineProperty(b.init,"svg_objects",{value:{},writable:!1,configurable:!1});Object.defineProperty(b.init.svg_objects,"add",{value:function(a,b){this.stored_svg_object_array||
(this.stored_svg_object_array={});this.stored_svg_object_array[a]=b},writable:!1,configurable:!1});Object.defineProperty(b.init.svg_objects,"get",{value:function(a){return this.stored_svg_object_array&&this.stored_svg_object_array[a]?this.stored_svg_object_array[a]:null},writable:!1,configurable:!1});Object.defineProperty(b.init,"timer",{value:{},writable:!1,configurable:!1});Object.defineProperties(b.init.timer,{id:{set:function(a){this.stored_id=a},get:function(){return this.stored_id}},step:{set:function(a){this.stored_step=
a},get:function(){return this.stored_step?this.stored_step:0}},maxStep:{set:function(a){this.stored_maxStep=a},get:function(){return this.stored_maxStep?this.stored_maxStep:2}},interval:{set:function(a){this.stored_interval=a},get:function(){return this.stored_interval?this.stored_interval:6E4}}});Object.defineProperty(b,"localstorage",{value:{},writable:!1,configurable:!1});Object.defineProperty(b.localstorage,"story",{value:{},writable:!1,configurable:!1});Object.defineProperty(b.localstorage.story,
"data",{value:{},writable:!1,configurable:!1});Object.defineProperty(b.localstorage.story,"read",{value:function(){var a=d.api.localstorage.readValue({module:"sigmainvest",key:"story"});if(a)for(var c=Object.keys(a),e=0;e<c.length;e++)b.localstorage.story.data[c[e]]=a[c[e]]},writable:!1,configurable:!1});Object.defineProperty(b.localstorage.story,"save",{value:function(){d.api.localstorage.saveValue({module:"sigmainvest",key:"story",value:b.localstorage.story.data})},writable:!1,configurable:!1});
Object.defineProperties(b.localstorage.story.data,{panel_width:{set:function(a){this.stored_panel_width=a},get:function(){return this.stored_panel_width}},panel_height:{set:function(a){this.stored_panel_height=a},get:function(){return this.stored_panel_height}},panel_possition:{set:function(a){this.stored_panel_possition=a},get:function(){return this.stored_panel_possition}},panel_align:{set:function(a){this.stored_panel_align=a},get:function(){return this.stored_panel_align}},panel_style:{set:function(a){this.stored_panel_style=
a},get:function(){return this.stored_panel_style}},panel_fontsize:{set:function(a){this.stored_panel_fontsize=a},get:function(){return this.stored_panel_fontsize}}});Object.defineProperty(b.localstorage,"floatpanel",{value:{},writable:!1,configurable:!1});Object.defineProperty(b.localstorage.floatpanel,"data",{value:{},writable:!1,configurable:!1});Object.defineProperty(b.localstorage.floatpanel,"read",{value:function(){var a=d.api.localstorage.readValue({module:"sigmainvest",key:"floatpanel"});if(a)for(var c=
Object.keys(a),e=0;e<c.length;e++)b.localstorage.floatpanel.data[c[e]]=a[c[e]]},writable:!1,configurable:!1});Object.defineProperty(b.localstorage.floatpanel,"save",{value:function(){d.api.localstorage.saveValue({module:"sigmainvest",key:"floatpanel",value:b.localstorage.floatpanel.data})},writable:!1,configurable:!1});Object.defineProperties(b.localstorage.floatpanel.data,{top:{set:function(a){this.stored_top=a},get:function(){return this.stored_top}},left:{set:function(a){this.stored_left=a},get:function(){return this.stored_left}},
right:{set:function(a){this.stored_right=a},get:function(){return this.stored_right}},bottom:{set:function(a){this.stored_bottom=a},get:function(){return this.stored_bottom}}});var p=null;return b};
...
b.r).replace("%g%",b.g).replace("%b%",b.b).replace("%a%",a/100);$("#color-area-up").spectrum("set",a)})}function y(){for(var a=[],b=h.GetDrawType(),d=0;d<c.init.comparecharttype.length;d++)a.push(c.init.comparecharttype[d].id);0<a.length&&!1==(0<=a.indexOf(b)?!0:!1)&&(b=a[0],h.SetDrawType(b));colorsContr=[];chkboxContr=[];switch(b){case "columns":colorsContr.push({ctr:"color-columns-column",json:"fill"},{ctr:"color-columns-border",json:"stroke"},{ctr:"colorfont-columns-border",json:"fontColor"},{ctr:"color-columns-flat-column",
json:"fill"});chkboxContr.push({ctr:"control-columns-border",json:"borderVisible"});break;case "histogram":colorsContr.push({ctr:"color-histogram-border",json:"stroke"},{ctr:"colorfont-histogram",json:"fontColor"});break;case "dots":colorsContr.push({ctr:"color-dots-candles",json:"fill"},{ctr:"color-dots-border",json:"stroke"},{ctr:"colorfont-dots",json:"fontColor"});break;case "line":colorsContr.push({ctr:"color-line-line",json:"stroke"},{ctr:"colorfont-line",json:"fontColor"});break;case "area":colorsContr.push({ctr:"color-area-line",
json:"stroke"},{ctr:"colorfont-are-line",json:"fontColor"},{ctr:"color-area-up",json:"fill",opacityctr:"color-opacity-area"})}var a=h.GetStyle(),f;for(f in colorsContr){var d=$("#"+colorsContr[f].ctr),e=z(a,colorsContr[f].json);$(d).spectrum({color:e,showPalette:!0,showPaletteOnly:!1,clickoutFiresChange:!1,showButtons:!1,palette:["rgb(0, 0, 0);{rgb(66, 66, 66);{rgb(101, 101, 101);{rgb(152, 152, 152);{rgb(182, 182, 182);{rgb(203, 203, 203);{rgb(216, 216, 216);{rgb(238, 238, 238);{rgb(242, 242, 242);{rgb(255, 255, 255);".split("{"),
"rgb(151, 0, 0);{rgb(255, 0, 0);{rgb(255, 152, 0);{rgb(255, 255, 0);{rgb(0, 255, 0);{rgb(0, 255, 255);{rgb(73, 133, 231);{rgb(0, 0, 255);{rgb(152, 0, 255);{rgb(255, 0, 255);".split("{"),"rgb(230, 184, 175);{rgb(244, 204, 204);{rgb(252, 229, 205);{rgb(255, 242, 204);{rgb(217, 234, 211);{rgb(208, 224, 227);{rgb(201, 218, 248);{rgb(207, 226, 243);{rgb(217, 210, 233);{rgb(234, 209, 220);".split("{"),"rgb(221, 126, 107);{rgb(234, 153, 153);{rgb(249, 203, 156);{rgb(255, 229, 153);{rgb(182, 215, 168);{rgb(162, 196, 201);{rgb(164, 194, 244);{rgb(159, 197, 232);{rgb(180, 167, 214);{rgb(213, 166, 189);".split("{"),
"rgb(204, 65, 37);{rgb(224, 102, 102);{rgb(246, 178, 107);{rgb(255, 217, 102);{rgb(147, 196, 125);{rgb(118, 165, 175);{rgb(109, 158, 235);{rgb(111, 168, 220);{rgb(142, 124, 195);{rgb(194, 123, 160);".split("{"),"rgb(166, 28, 0);{rgb(204, 0, 0);{rgb(230, 145, 56);{rgb(241, 194, 50);{rgb(106, 168, 79);{rgb(69, 129, 142);{rgb(60, 120, 216);{rgb(61, 133, 198);{rgb(103, 78, 167);{rgb(166, 77, 121);".split("{"),"rgb(133, 32, 12);{rgb(153, 0, 0);{rgb(180, 95, 6);{rgb(191, 144, 0);{rgb(56, 118, 29);{rgb(19, 79, 92);{rgb(17, 85, 204);{rgb(11, 83, 148);{rgb(53, 28, 117);{rgb(116, 27, 71);".split("{"),
"rgb(91, 15, 0);{rgb(102, 0, 0);{rgb(120, 63, 4);{rgb(127, 96, 0);{rgb(39, 78, 19);{rgb(12, 52, 61);{rgb(28, 69, 135);{rgb(7, 55, 99);{rgb(32, 18, 77);{rgb(76, 17, 48);".split("{")]})}for(var g in chkboxContr){f=z(a,chkboxContr[g].json);if(null==f)break;"true"==f.toLowerCase()?$("#"+chkboxContr[g].ctr).attr("checked",!0):$("#"+chkboxContr[g].ctr).removeAttr("checked")}switch(b){case "line":b=a.strokeWidth;$("#borderwidth-line-line").slider("option","value",b);break;case "histogram":b=a.strokeWidth;
$("#borderwidth-histogram-line").slider("option","value",b);break;case "area":b=a.strokeWidth,$("#borderwidth-area-line").slider("option","value",b),b=$("#color-area-up").spectrum("get").alpha,g=100,isNaN(parseFloat(b))||(g=100*b),$("#color-opacity-area").slider("option","value")!=g&&$("#color-opacity-area").slider("option","value",g)}}function n(a,b,d,f,e,g){$(a).on("click",function(a){var l=$(this);a=$(this).attr("id");l.is(":checked")?(null!=g&&$(g).slider("enable"),null!=e&&$(e).slider("enable"),
null!=b&&$(b).spectrum("enable"),null!=d&&$(d).spectrum("enable"),null!=f&&$(f).spectrum("enable")):(null!=g&&$(g).slider("disable"),null!=e&&$(e).slider("disable"),null!=b&&$(b).spectrum("disable"),null!=d&&$(d).spectrum("disable"),null!=f&&$(f).spectrum("disable"));var l=l.is(":checked"),k;for(k in chkboxContr)if(chkboxContr[k].ctr==a){var X=h.GetStyle();t(X,chkboxContr[k].json,l?"true":"false");m&&c.chart.Redraw()}})}function z(a,b){var c=b.split(".");return 1==c.length?a[c[0]]:"undefined"!=typeof a[c[0]]?
z(a[c[0]],c.slice(1).join(".")):null}function t(a,b,c){b=b.split(".");1==b.length&&(a[b[0]]=c);"undefined"!=typeof a[b[0]]&&t(a[b[0]],b.slice(1).join("."),c)}function C(a,b,d){function f(a){$(a).find(".spectrum-color").each(function(){$(this).spectrum("destroy")})}function p(a){var b=c.patterns.common.eye_orange.replace(/%icon-source%/g,e.icon_source).replace(/%icon-prefix%/g,e.icon_prefix);$(a).find(".ui-dialog-buttonset").prepend(b).on("click",function(){var a=$(".chart-ui-dialog.compares-dialog").css("opacity"),
a=1==a?.5:1,b=1==a?"":2;$(".chart-ui-dialog.compares-dialog").css("opacity",a);$(this).css("opacity",b)})}a="Close";var g=b,h="";"undefined"==typeof d&&(d="");"undefined"!=typeof c.localizationobj&&(a=c.localizationobj.gui.returnLocalizationString("dialogs.common.button-close","Close"),g=c.localizationobj.gui.returnLocalizationString("dialogs.ta.title",b),g+=d);"undefined"!=typeof c.init.TemplateName&&(h=c.init.TemplateName);b="";"rtl"==c.localizationobj.gui.returnCurrentLanguage().direction&&(b=
"dir-rtl");$('<div id="chart-dialog" title="'+g+'"></div>').insertAfter("body");$("#chart-dialog").dialog({dialogClass:"chart-ui-dialog compares-dialog "+h+" "+b,draggable:!0,autoOpen:!1,resizable:!1,closeOnEscape:!0,width:"auto",modal:!0,open:function(a,b){p($(this).parent());$(".ui-widget-overlay").last().addClass("chart-ui-widget-overlay");if(c.api.props){var d=c.api.props.chart.gui.layout.zindex_dialog;$(".chart-ui-widget-overlay").css({"z-index":d});$(".chart-ui-dialog").css({"z-index":d})}$(".ui-widget-overlay").bind("click",
function(){$("#chart-dialog").dialog("close")});"undefined"!=typeof c.preloadobj&&c.preloadobj.endPreload()},close:function(a,b){f($(this).parent());$("#chart-dialog").remove();$("div.chart-ui-dialog.compares-dialog  adv-buttons."+e.icon_prefix+"eye-orange").off().remove();$("div.chart-ui-dialog.compares-dialog").off().remove();$(this).off().empty().remove()},buttons:[{id:"btn-dialogs-close",text:a,click:function(){$(this).dialog("close")}}]})}function D(){$(".properties-tabs").delegate("a","click",
function(){var a=$(this).parents(".dialog_level"),b=$(a).find(".properties-tabs a").index(this);$(a).find(".main-properties").each(function(){$(this).css("display","none")});$(a).find(".properties-tabs-label").each(function(){$(this).removeClass("active")});$(a).find(".main-properties").eq(b).css("display","block");$(this).addClass("active")})}function N(){$(".dynamic-tabs a").on("click",function(){var a=$(this).parents(".dynamic-tabs"),b=$(a).find(".dynamic-tabs-label").index(this),c=0==b?"star-majors":
"star-compare",f=0==b?"star-compare":"star-majors";u=b;$(".compares-list").find("."+f).each(function(){$(this).css("display","none")});$(".compares-list").find("."+c).each(function(){$(this).css("display","block")});$(a).find(".dynamic-tabs-label").each(function(){$(this).removeClass("active")});$(this).addClass("active")});switch(k){case "compares-favorites":case "compares":$(".dynamic-tabs a:eq(1)").trigger("click");break;case "majors-favorites":case "majors":$(".dynamic-tabs a:eq(0)").trigger("click")}}
function G(a,b,c){for(var f=$("#dlg-compares .main-page").eq(a).find(".title_level"),e=0;e<f.length;e++)$(f[e]).removeClass("active"),e>a&&$(f[e]).css("display","none");"undefined"==typeof b&&(b="");"undefined"==typeof c&&(c="");$(f[a]).find("a").html(b+" "+c);$(f[a]).css("display","block").addClass("active")}function O(){$(" .title_level").delegate("a","click",function(){for(var a=$(this).parents(".main-page"),b=$(a).find(".title_level a").index(this),c=$(a).find(".dialog_level"),f=0;f<c.length;f++){var e=
f==b?"block":"none";$(c[f]).css("display",e)}a=$(a).find(".title_level");for(f=b+1;f<a.length;f++)$(a[f]).css("display","none").removeClass("active");$(a[b]).addClass("active")})}function P(){$("#main-compare-browser > li").on("click",function(){var a=$("#main-compare-browser > li").index(this),b=$(this).attr("id");$("#main-compare-browser > li").removeClass("browser-item-selected");$("#main-compare-browser #"+b).addClass("browser-item-selected");for(var b=$("#chart-dialog .main-page"),c=0;c<b.length;c++){var e=
c==a?"block":"none";$(b[c]).css("display",e)}a=$(this).html();G(0,a)})}function B(){"undefined"!=typeof c.preloadobj&&c.preloadobj.startPreload()}var c=s;s={};c.compares=s;c.api.debug.getLogger("prochart.gui.compare");var v="",k="compares";c.symbolslist=null;var u=0,e=c.api.layout.getbuttonStyle();m=!1;h=null;var r=[];s.gui={viewCompares:function(a){k="undefined"==typeof a?"compares":a;A()},viewMajors:function(a){k="undefined"==typeof a?"majors":a;A()},openCompareSymbol:function(a,b){B();var d="&nbsp;"+
b.GetSymbolName();h=b;m=!0;C("",v,d);d=c.patterns.ta.detailsform;$("#chart-dialog").html(d);H();I();y();J();"undefined"!=typeof c.localizationobj&&c.localizationobj.gui.updateFromDataLang($("#chart-dialog"));$("#chart-dialog").dialog("open")},findSymbols:E,callbackonFindSymbols:function(a,b,d){$("#comparesgroup-symbols  ul.compares-list").html("");a=0==u?"block":"none";b=1==u?"block":"none";r=[];var f=[],h=[];d.data.forEach(function(a){h=h.concat(a.symbols)});$.each(h,function(a,c){-1===$.inArray(c.id,
f)&&(f.push(c.id),r.push(c))});f=[];h=[];d=r;for(var g=$("#comparesgroup-symbols   ul.compares-list"),k=0;k<d.length;k++){var l=d[k].id,m=d[k].description,n=d[k].name,l=c.patterns.ta.findsymbol.replace(/%id%/g,l).replace(/%idx%/g,l).replace(/%icon-source%/g,e.icon_source).replace(/%icon-prefix%/g,e.icon_prefix).replace(/%caption%/g,m).replace(/%name%/g,n).replace(/%showMajors%/g,a).replace(/%type-class%/g,1==u?" opencompare ":" changesymbol ").replace(/%showCompare%/g,b),l=T(d[k].id)?l.replace(/%starcompare%/g,
e.icon_prefix+"startenabled-icon"):l.replace(/%starcompare%/g,e.icon_prefix+"stardisabled-icon"),l=U(d[k].id)?l.replace(/%starmajor%/g,e.icon_prefix+"startenabled-icon"):l.replace(/%starmajor%/g,e.icon_prefix+"stardisabled-icon");$(g).append(l)}$(g).find(".li-compare .change-symbol-favorite").off("click").on("click",function(){var a=$(this).parent().attr("idx"),b=q(a);c.chart.ChangeSymbol(jQuery.extend(!0,{},b));if(typeof c.events.onDialogSymbolChange==typeof Function)c.events.onDialogSymbolChange(a,
b,$("#chart-dialog"))});$(g).find(".li-compare .changesymbol").off("click").on("click",function(){var a=$(this).parent().attr("idx"),b=q(a);c.chart.ChangeSymbol(jQuery.extend(!0,{},b));if(typeof c.events.onDialogSymbolChange==typeof Function)c.events.onDialogSymbolChange(a,b,$("#chart-dialog"))});$(g).find(".li-compare .opencompare").off("click").on("click",function(){var a=$(this).parent().attr("idx"),b=q(a);c.chart.AddCompareSymbol(b);if(typeof c.events.onDialogCompareAdd==typeof Function)c.events.onDialogCompareAdd(a,
b,$("#chart-dialog"))});$(g).find(".li-compare .a-property-favorite").off("click").on("click",function(){var a=$(this).parent().attr("idx"),a=q(a);F(a)});$(g).find(".li-compare .star-compare.star-button").off("click").on("click",function(a){a.stopPropagation();a=$(this).parent().attr("idx");$(this).parent().attr("n");$(this).parent().attr("d");$(this).hasClass(e.icon_prefix+"stardisabled-icon")?($(this).addClass(e.icon_prefix+"startenabled-icon").removeClass(e.icon_prefix+"stardisabled-icon"),a=q(a),
...
"stardisabled-icon"),a=q(a),a=jQuery.extend(!0,{},a),"undefined"!=typeof c.init.majors&&(c.init.gui.majorsAddObj(a),x())):($(this).removeClass(e.icon_prefix+"startenabled-icon").addClass(e.icon_prefix+"stardisabled-icon"),L(a))});$(".compares-list .li-compare .a-add-favorite").on("click",function(){var a=$(this).parent().attr("id").replace("compare-",""),b=q(a);5<=c.api.debug.level&&console.log(b);c.chart.AddCompareSymbol(b);if(typeof c.events.onDialogCompareAdd==typeof Function)c.events.onDialogCompareAdd(a,
b,$("#chart-dialog"))});a=$("#chart-dialog").find(".chart-search-preload");Q(a)}};return s};
...
function ProChart_InitSvgToolbar(e){var b={};Object.defineProperty(b,"gui",{value:{},writable:!1,configurable:!1});Object.defineProperty(b,"init",{value:{},writable:!1,configurable:!1});Object.defineProperties(b.init,{svgfile:{set:function(a){this.stored_svgfile=a},get:function(){return this.stored_svgfile}},svgstyle:{set:function(a){this.stored_svgstyle=a},get:function(){return this.stored_svgstyle}},svgspanstyle:{set:function(a){this.stored_svgspanstyle=a},get:function(){return this.stored_svgspanstyle}},
svgclass:{set:function(a){this.stored_svgclass=a},get:function(){return this.stored_svgclass}}});Object.defineProperty(b.gui,"svgicons",{value:{},writable:!1,configurable:!1});Object.defineProperty(b.gui,"svgiconsSetItem",{value:function(a){b.gui.svgicons[a.svgid]={svgfile:a.svgfile?a.svgfile:null,svgspanstyle:a.svgspanstyle?a.svgspanstyle:null,svgcssclass:a.svgcssclass?a.svgcssclass:null,svgstyle:a.svgstyle?a.svgstyle:null}},writable:!1,configurable:!1});Object.defineProperty(b.gui,"svgiconsGetItem",
{value:function(a){var c=null;a.svgid&&b.gui.svgicons[a.svgid]&&(c=a.svgid);!c&&a.icon&&b.gui.svgicons[a.icon]&&(c=a.icon);!c&&a.id&&b.gui.svgicons[a.id]&&(c=a.id);if(c){var d=b.gui.svgicons[c],f='style="%style%"'.replace(/%style%/g,a.svgstyle?a.svgstyle:d.svgstyle?d.svgstyle:b.init.svgstyle),g='style="%style%"'.replace(/%style%/g,a.svgspanstyle?a.svgspanstyle:d.svgspanstyle?d.svgspanstyle:b.init.svgspanstyle);return e.patterns.toolbar.toolbar_replace_icon_target.replace(/%svgspanstyle%/g,g).replace(/%svgclass%/g,
(d.svgcssclass?d.svgcssclass+b.init.svgclass:b.init.svgclass)+(a.svgclass?a.svgclass:"")).replace(/%svgstyle%/g,f).replace(/%svgfile%/g,a.svgfile?a.svgfile:d.svgfile?d.svgfile:b.init.svgfile).replace(/%svgid%/g,c)}c='style="%style%"'.replace(/%style%/g,a.svgstyle?a.svgstyle:b.init.svgstyle);d='style="%style%"'.replace(/%style%/g,a.svgspanstyle?a.svgspanstyle:b.init.svgspanstyle);return e.patterns.toolbar.toolbar_replace_icon_target.replace(/%svgspanstyle%/g,d).replace(/%svgclass%/g,a.svgclass?a.svgclass+
b.init.svgclass:b.init.svgclass).replace(/%svgstyle%/g,c).replace(/%svgfile%/g,a.svgfile?a.svgfile:b.init.svgfile).replace(/%svgid%/g,a.svgid?a.svgid:a.icon?a.icon:a.id)},writable:!1,configurable:!1});b.init.svgfile=e.guiinit.rootpathRelative+e.guiinit.customSVGSpriteFile?e.guiinit.customSVGSpriteFile:"/ChartUI/css/svg/symbol-icons.svg";b.init.svgstyle="width:18px; height:18px;";b.init.svgspanstyle="background-image:none !important;";b.init.svgclass=" chart-svg-icon";return b};
...
"/ChartUI/js.common/jquery.ui.1.10.3/jquery-ui"+c+".js"+b,"jquery.draggable":a.init.rootpath+"/ChartUI/js.common/utils/prochart.jquery.draggable"+c+".js"+b,panels:a.init.rootpath+"/ChartUI/gui/panels/prochart.gui.panels"+c+".js"+b,floatingpanels:a.init.rootpath+"/ChartUI/gui/panels/prochart.gui.floatingpanels"+c+".js"+b,"activity.indicator":a.init.rootpath+"/ChartUI/js.common/activity.indicator/activity-indicator"+c+".js"+b,splitter_horizontal:a.init.rootpath+"/ChartUI/js.common/utils/prochart.splitter.horizontal"+
c+".js"+b,drags:a.init.rootpath+"/ChartUI/js.common/utils/prochart.drags"+c+".js"+b,"jquery.resize":a.init.rootpath+"/ChartUI/js.common/detect.resize/prochart.jquery.resize"+c+".js"+b,localization:a.init.rootpath+"/ChartUI/localization/prochart.gui.localization"+c+".js"+b,init:a.init.rootpath+"/ChartUI/init/prochart.init"+c+".js"+b,action:a.init.rootpath+"/ChartUI/actions/prochart.gui.actions"+c+".js"+b,header:a.init.rootpath+"/ChartUI/gui/header/prochart.gui.header"+c+".js"+b,alert:a.init.rootpath+
"/ChartUI/gui/alert/prochart.gui.alert"+c+".js"+b,msg:a.init.rootpath+"/ChartUI/gui/alert/prochart.gui.msg"+c+".js"+b,menu:a.init.rootpath+"/ChartUI/gui/menu/prochart.gui.menu"+c+".js"+b,community:a.init.rootpath+"/ChartUI/gui/community/prochart.gui.community"+c+".js"+b,messages:a.init.rootpath+"/ChartUI/gui/msg/prochart.gui.messages"+c+".js"+b,signals:a.init.rootpath+"/ChartUI/gui/signals/prochart.gui.signals"+c+".js"+b,compare:a.init.rootpath+"/ChartUI/gui/ta/prochart.gui.compare"+c+".js"+b,indicators:a.init.rootpath+
"/ChartUI/gui/indicators/prochart.gui.indicators"+c+".js"+b,system:a.init.rootpath+"/ChartUI/gui/systems/prochart.gui.systems"+c+".js"+b,props:a.init.rootpath+"/ChartUI/gui/props/prochart.gui.props"+c+".js"+b,customerkey:m+"/CustomerKey"+c+".js"+b,trade:a.init.rootpath+"/ChartUI/gui/trade/prochart.gui.trade"+c+".js"+b,color:a.init.rootpath+"/ChartUI/gui/color/spectrum"+c+".js"+b,utils_numeric:a.init.rootpath+"/ChartUI/js.common/utils/prochart.jquery.numeric"+c+".js"+b,utils_cache:a.init.rootpath+
"/ChartUI/js.common/utils/prochart.jquery.cache"+c+".js"+b,utils_station:a.init.rootpath+"/ChartUI/js.common/utils/prochart.station"+c+".js"+b,utils_common:a.init.rootpath+"/ChartUI/js.common/utils/prochart.common.utils"+c+".js"+b,utils_hoverintent:a.init.rootpath+"/ChartUI/js.common/utils/prochart.jquery.hoverIntent"+c+".js"+b,leked:a.init.rootpath+"/ChartCore/js/prochart.leked"+c+".js"+b,hook_lz:a.init.rootpath+"/ChartCore/js/lzstring"+c+".js"+b,hook_event:a.init.rootpath+"/ChartCore/js/hookevent"+
c+".js"+b,draw:a.init.rootpath+"/ChartUI/gui/draw/prochart.gui.draw"+c+".js"+b,zoom:a.init.rootpath+"/ChartUI/gui/zoom/prochart.gui.zoom"+c+".js"+b,"prochart.class":a.init.rootpath+"/ChartUI/init/prochart.class"+c+".js"+b,patterns:a.init.rootpath+"/ChartUI/gui/patterns/prochart.patterns"+c+".js"+b,layout:a.init.rootpath+"/ChartUI/layouts/prochart.gui.layout"+c+".js"+b,"templates.sys":a.init.rootpath+"/ChartUI/layouts/prochart.templates.sys.min.js"+b,preload:a.init.rootpath+"/ChartUI/preload/prochart.gui.preload"+
c+".js"+b,"init.adv":a.init.rootpath+"/ChartUI/init/prochart.init.adv.min.js"+b,toolbaradv:a.init.rootpath+"/ChartUI/gui/toolbar/prochart.gui.toolbar.adv"+c+".js"+b,"toolbaradv.svg":a.init.rootpath+"/ChartUI/gui/toolbar/prochart.gui.toolbar.svg"+c+".js"+b,api:a.init.rootpath+"/ChartAPI/prochart.api"+c+".js"+b,global:a.init.rootpath+"/ChartAPI/prochart.api.global"+c+".js"+b,"api.events":a.init.rootpath+"/ChartAPI/prochart.api.events"+c+".js"+b,"api.init":a.init.rootpath+"/ChartAPI/prochart.api.init"+
c+".js"+b,"api.actions":a.init.rootpath+"/ChartAPI/prochart.api.actions"+c+".js"+b,"api.commondata":a.init.rootpath+"/ChartAPI/prochart.api.commondata"+c+".js"+b,"api.bi":a.init.rootpath+"/ChartAPI/prochart.api.bi"+c+".js"+b,"api.props":a.init.rootpath+"/ChartAPI/prochart.api.props"+c+".js"+b,"api.localstorage":a.init.rootpath+"/ChartAPI/prochart.api.localstorage"+c+".js"+b,"api.header":a.init.rootpath+"/ChartUI/gui/header/prochart.api.header"+c+".js"+b,"api.layout":a.init.rootpath+"/ChartUI/layouts/prochart.api.layout"+
c+".js"+b,"api.menu":a.init.rootpath+"/ChartUI/gui/menu/prochart.api.menu"+c+".js"+b,"api.zoom":a.init.rootpath+"/ChartUI/gui/zoom/prochart.api.zoom"+c+".js"+b,"api.toolbar":a.init.rootpath+"/ChartUI/gui/toolbar/prochart.api.toolbar"+c+".js"+b,"api.chart":a.init.rootpath+"/ChartUI/gui/chart/prochart.api.chart"+c+".js"+b,"api.panels":a.init.rootpath+"/ChartUI/gui/panels/prochart.api.panels"+c+".js"+b,"api.alert":a.init.rootpath+"/ChartUI/gui/alert/prochart.api.alert"+c+".js"+b,tradingcentral:a.init.rootpath+
"/ChartUI/gui/signals/prochart.gui.tradingcentral"+c+".js"+b,sigmainvest:a.init.rootpath+"/ChartUI/gui/signals/prochart.gui.sigmainvest"+c+".js"+b,plugs:a.init.rootpath+"/Plugs/prochart.gui.plugs"+c+".js"+b};g={"jquery.ui.css":a.init.rootpath+"/ChartUI/css/jquery-ui.custom"+c+".css"+b,"main.css":a.init.rootpath+"/ChartUI/css/prochart.main"+c+".css"+b,"jquery.css":a.init.rootpath+"/ChartUI/css/prochart.jquery"+c+".css"+b,"dialogs.css":a.init.rootpath+"/ChartUI/css/prochart.dialogs"+c+".css"+b,"chart.css":a.init.rootpath+
"/ChartUI/css/prochart.chart"+c+".css"+b,"color.css":a.init.rootpath+"/ChartUI/css/spectrum"+c+".css"+b,"plugs.css":a.init.rootpath+"/Plugs/plugs"+c+".css"+b,"zoom.css":a.init.rootpath+"/ChartUI/gui/zoom/js.library/iThing2"+c+".css"+b,"iconchart.css":a.init.rootpath+"/ChartUI/css/prochart.iconchart"+c+".css"+b};!1==a.guiinit.trade&&delete e.trade;!1==a.guiinit.toolbox&&delete e.toolbox;!1==a.guiinit.menu&&delete e.menu;!1==a.guiinit.toolbar&&delete e.toolbar;!1==a.guiinit.zoom&&(delete e.zoom,delete e.zoom_slider,
delete e["zoom.css"]);!1==a.guiinit.system&&delete e.system;!1==a.guiinit.draw&&delete e.draw;!1==a.guiinit.props&&delete e.props;!1==a.guiinit.header&&delete e.header;!1==a.guiinit.indicators&&delete e.indicators;!1==a.guiinit.community&&delete e.community;!1==a.guiinit.compare&&delete e.compare;!1==a.guiinit.messages&&delete e.messages;!1==a.guiinit.indicators&!1==a.guiinit.draw&!1==a.guiinit.props&&(delete e.color,delete e["dialogs.css"],delete e["color.css"]);e.touch=a.init.rootpath+"/ChartUI/js.common/touch/touch.surface"+
c+".js"+b;window.JSON||(e.json2=a.init.rootpath+"/ChartUI/js.common/jons2/jons2"+c+".js"+b);if(0==a.init.layoutcss.length)g["layout1.css"]=a.init.rootpath+"/ChartUI/layouts/layout1/layout"+c+".css"+b;else for(f=0;f<a.init.layoutcss.length;f++)g["layout"+f+".css"]=a.init.rootpath+"/ChartUI/layouts/"+a.init.layoutcss[f]+"/layout"+c+".css"+b;for(f=0;f<a.init.loadertemplates.length;f++){var k=a.init.loadertemplates[f],h=k.template,k=k.layout;if("undefined"!=typeof h&&"undefined"!=typeof k){var l=a.init.rootpath+
"/ChartUI/layouts/"+k+"/templates/"+h+"/template"+c+".css"+b;s(g,l)||(g[k+"_"+h]=l)}}for(var f=0;f<a.init.loaderjs.length;f++)c=a.init.loaderjs[f],s(e,c)||(e["js.temp"+f]=c);for(c=0;c<a.init.loadercss.length;c++)b=a.init.loadercss[c],s(g,b)||(g["css.temp."+c]=b);for(c=0;c<a.init.loaderremovefrom.length;c++)b=a.init.loaderremovefrom[c],"undefined"!=typeof e[b.key]&&delete e[b.key];for(c=0;c<a.init.loaderremovefrom.length;c++)b=a.init.loaderremovefrom[c],"undefined"!=typeof e[b]&&delete e[b];c=Object.keys(g);
for(b=0;b<c.length;b++)f=c[b],h=document.createElement("link"),h.type="text/css",h.rel="stylesheet",h.href=g[f],document.getElementsByTagName("head")[0].appendChild(h);g={};c=Object.keys(d);for(b=0;b<c.length;b++)f=c[b],"undefined"==typeof d[f]&&console.log(f),g[f]=d[f];d=Object.keys(e);for(c=0;c<d.length;c++)b=d[c],"undefined"==typeof e[b]&&console.log(b),g[b]=e[b];requirejs.config({paths:g,shim:{core1:{deps:["core2"]},core4:{deps:["core1"]},core3:{deps:["core1"]},core7:{deps:["core1"]}}});e=Object.keys(g);
require(e,function(){"function"==typeof a.LoaderInitComplete&&$(document).ready(function(){a.LoaderInitComplete()})})}}function r(){if("undefined"!=typeof n&&null!=n){var c=".min";a.init.minifier||(c="");var b=!1==a.init.cache?"?"+Math.floor(3100*Math.random()+1):"",d="v"+p+"k"+q,e="c"+t+"b"+u;window.GlobProchartObject.versionbuild.guiversion=d;window.GlobProchartObject.versionbuild.coreversion=e;var b=""==b?"?"+d:b+d,e={"core.combine":(0==a.init.corecombine_folder_path.length?m:a.init.corecombine_folder_path)+
"/"+(0==a.init.corecombine_file_name.length?"core.combine"+c+".js":a.init.corecombine_file_name)+b+e},g="";a.init.gzip&&(g=".gz");d={"jquery.ui":a.init.rootpath+"/ChartUI/js.common/jquery.ui.1.10.3/jquery-ui"+c+".js"+b,"gui.js.combine":(0==a.init.guicombine_folder_path.length?a.init.rootpath+"/ChartUI/init":a.init.objectLoader.init.guicombine_folder_path)+"/"+(0==a.init.guicombine_file_name.length?"gui.combine"+c+".js":a.init.guicombine_file_name)+b};g={"gui.css.combine":a.init.rootpath+"/ChartUI/css/gui.combine"+
c+".css"+g+b};if(0==a.init.layoutcss.length)g["layout1.css"]=a.init.rootpath+"/ChartUI/layouts/layout1/layout"+c+".css"+b;else for(var f=0;f<a.init.layoutcss.length;f++)g["layout"+f+".css"]=a.init.rootpath+"/ChartUI/layouts/"+a.init.layoutcss[f]+"/layout"+c+".css"+b;for(f=0;f<a.init.loadertemplates.length;f++){var k=a.init.loadertemplates[f],h=k.template,k=k.layout;if("undefined"!=typeof h&&"undefined"!=typeof k){var l=a.init.rootpath+"/ChartUI/layouts/"+k+"/templates/"+h+"/template"+c+".css"+b;s(g,
l)||(g[k+"_"+h]=l)}}for(c=0;c<a.init.loaderjs.length;c++)b=a.init.loaderjs[c],s(d,b)||(d["js.temp"+c]=b);for(c=0;c<a.init.loadercss.length;c++)b=a.init.loadercss[c],s(d,b)||(g["css.temp."+c]=b);for(c=0;c<a.init.loaderremovefrom.length;c++)b=a.init.loaderremovefrom[c],"undefined"!=typeof d[b.key]&&delete d[b.key];c=Object.keys(g);for(b=0;b<c.length;b++)f=c[b],h=document.createElement("link"),h.type="text/css",h.rel="stylesheet",h.href=g[f],document.getElementsByTagName("head")[0].appendChild(h);g=
{};c=Object.keys(e);for(b=0;b<c.length;b++)f=c[b],"undefined"==typeof e[f]&&console.log(f),g[f]=e[f];e=Object.keys(d);for(c=0;c<e.length;c++)b=e[c],"undefined"==typeof d[b]&&console.log(b),g[b]=d[b];requirejs.config({paths:g});d=Object.keys(g);require(d,function(){"function"==typeof a.LoaderInitComplete&&$(document).ready(function(){a.LoaderInitComplete()})})}}function s(a,b){for(var d in a)if(a[d]==b)return!0;return!1}function z(){var c=""==a.init.timeupdateVersiongui?"?"+(new Date).getTime():"?"+
a.init.timeupdateVersiongui,c=a.init.rootpath+"/ChartUI/version/prochart.version.json.js"+c,b=$.Deferred();if(a.navigator.XMLHttpRequest()){var d=new XMLHttpRequest;d.open("get",c);d.onreadystatechange=function(){if(4==d.readyState&&(200==d.status||304==d.status)){var a=$.parseJSON(d.responseText);$.parseJSON(d.responseText);p=a.guiversionbuild;q=a.customerversion;b.resolve(a)}};d.send()}else $.ajax({url:c,dataType:"json",data:{},type:"get",async:!0,error:function(a,c){q=p="0"}}).done(function(a){p=
a.guiversionbuild;q=a.customerversion;b.resolve(a)});return b.promise()}function y(){var c=""==a.init.timeupdateVersioncore?"?"+(new Date).getTime():"?"+a.init.timeupdateVersioncore,c=m+"/version/prochart.version.json.js"+c;$.support.cors=!0;var b=$.Deferred();if(a.navigator.XMLHttpRequest()){var d=new XMLHttpRequest;d.open("get",c);d.onreadystatechange=function(){if(4==d.readyState&&(200==d.status||304==d.status)){var a=$.parseJSON(d.responseText);$.parseJSON(d.responseText);t=a.guiversionbuild;
u=a.customerversion;v=a.files;b.resolve(a)}};d.send()}else $.ajax({type:"GET",url:c,processData:!0,data:{},async:!0,dataType:"json",error:function(a,c){}}).done(function(a){t=a.guiversionbuild;u=a.customerversion;v=a.files;b.resolve(a)});return b.promise()}var a={LoaderInit:function(a){$.support.cors=!0;jQuery.support.cors=!0;w("default")},LoaderInitCombine:function(){$.support.cors=!0;jQuery.support.cors=!0;w("combine")},LoaderInitCombineCompact:function(){$.support.cors=!0;jQuery.support.cors=!0;
w("combine")},LoaderInitComplete:null,init:{rootpath:"",corepath:"",minifier:!0,loadercss:[],loaderjs:[],loadertemplates:[],yepnope_errorTimeout:12E4,cache:!0,onlyliteload:!1,layoutcss:[],loaderreplacepath:[],loaderremovefrom:[],timeupdateVersiongui:"",timeupdateVersioncore:"",gzip:!1,getrequirejs:!0,requirejs_version:"2.3.5",corecombine_folder_path:"",corecombine_file_name:"",guicombine_folder_path:"",guicombine_file_name:""}};"undefined"==typeof window.GlobProchartObject&&(window.GlobProchartObject=
{},Object.defineProperty(window.GlobProchartObject,"versionbuild",{value:{},writable:!1,configurable:!1}),Object.defineProperty(window.GlobProchartObject.versionbuild,"guiversion",{value:null,writable:!0,configurable:!1}),Object.defineProperty(window.GlobProchartObject.versionbuild,"guiversionbuild",{value:null,writable:!0,configurable:!1}),Object.defineProperty(window.GlobProchartObject.versionbuild,"guicustomerversion",{value:null,writable:!0,configurable:!1}),Object.defineProperty(window.GlobProchartObject.versionbuild,
"coreversion",{value:null,writable:!0,configurable:!1}),Object.defineProperty(window.GlobProchartObject.versionbuild,"coreversionbuild",{value:null,writable:!0,configurable:!1}),Object.defineProperty(window.GlobProchartObject.versionbuild,"corecustomerversion",{value:null,writable:!0,configurable:!1}),Object.defineProperty(window.GlobProchartObject.versionbuild,"corefiles",{value:null,writable:!0,configurable:!1}));u=t="pr";v=0;q=p="pr";var n=null;Object.defineProperty(a,"versionbuild",{value:{},
...
navigator.appName&&"XMLHttpRequest"in window&&null!==window.XMLHttpRequest&&a.navigator.properties.detectIE<=a.navigator.properties.xdrMinIE||a.navigator.properties.alvaysXMLHttpRequest}};var x=[],m="";a.navigator.properties.detectIE=function(){var a=window.navigator.userAgent,b=a.indexOf("MSIE ");if(0<b)return parseInt(a.substring(b+5,a.indexOf(".",b)),10);if(0<a.indexOf("Trident/"))return b=a.indexOf("rv:"),parseInt(a.substring(b+3,a.indexOf(".",b)),10);b=a.indexOf("Edge/");return 0<b?parseInt(a.substring(b+
5,a.indexOf(".",b)),10):!1}();return a};
...
function ProChart_InitPatterns(G,h){function H(a,m){b[a.name]||(Object.defineProperty(d,a.name,{get:function(){return b[a.name]},set:function(c){b[a.name]=c}}),Object.defineProperty(b,a.name,{value:{},writable:!0,configurable:!0}));if(a.patterns)for(var k=0;k<a.patterns.length;k++){var l=a.patterns[k].name,I=a.patterns[k].key;Object.defineProperty(d,l,{get:function(){return b[a.name][l]},set:function(c){b[a.name][l]=c}});b[a.name][l]=c(m,I)}}function J(){function a(a){n(a)}function b(a){try{window.GlobProchartObject[l]=
a}catch(c){}if("undefined"!=typeof h){var m=prochartstation.get(h,"allpatterns");if(null!=m){for(var d=0;d<m.length;d++){var k=m[d];if("function"==typeof k["function"])k["function"](a);k.deferred.resolve()}prochartstation.del(h,"allpatterns")}}}var c=!1==f.guiinit.cache?"?"+f.version.gui.name+(new Date).getTime():"?"+f.version.gui.name,l=f.guiinit.rootpath+"/ChartUI/gui/patterns/allpatterns.combine.min.htm"+c,d=$.Deferred();try{if("undefined"!=typeof window.GlobProchartObject[l])return n(window.GlobProchartObject[l]),
d.resolve()}catch(g){}if("undefined"!=typeof h)if(null==prochartstation.get(h,"allpatterns"))prochartstation.set(h,"allpatterns",[]);else return c={deferred:d,"function":a},prochartstation.get(h,"allpatterns").push(c),d.promise();if(f.navigator.XMLHttpRequest()){var e=new XMLHttpRequest;e.open("get",l);e.onload=function(){var a=e.responseText;n(a);b(a);d.resolve(a)};e.send()}else $.ajax({type:"GET",async:!0,dataType:"html",url:l}).done(function(a){n(a);b(a);d.resolve(a)});return d.promise()}function K(){function a(a){p(a)}
function b(a){try{window.GlobProchartObject[d]=a}catch(c){}if("undefined"!=typeof h){var m=prochartstation.get(h,"custompanelpattern");if(null!=m){for(var e=0;e<m.length;e++){var k=m[e];if("function"==typeof k["function"])k["function"](a);k.deferred.resolve()}prochartstation.del(h,"custompanelpattern")}}}var c=!1==f.guiinit.cache?"?"+f.version.gui.name+(new Date).getTime():"?"+f.version.gui.name,d=f.apiinit.customPanelPatternFile+c,e=$.Deferred();try{if("undefined"!=typeof window.GlobProchartObject[d])return p(window.GlobProchartObject[d]),
e.resolve()}catch(g){}if("undefined"!=typeof h)if(null==prochartstation.get(h,"custompanelpattern"))prochartstation.set(h,"custompanelpattern",[]);else return c={deferred:e,"function":a},prochartstation.get(h,"custompanelpattern").push(c),e.promise();if(f.navigator.XMLHttpRequest()){var n=new XMLHttpRequest;n.open("get",d);n.onload=function(){var a=n.responseText;p(a);b(a);e.resolve(a)};n.send()}else $.ajax({type:"GET",async:!0,dataType:"html",url:d}).done(function(a){p(a);b(a);e.resolve(a)});return e.promise()}
function n(a){q(a);r(a);s(a);t(a);u(a);v(a);w(a);p(a);x(a);y(a);z(a);A(a);b.trade.form=c(a,"trade_form");B(a);C(a);D(a);E(a)}function E(a){b.common.eye_orange=c(a,"eye-orange-pattern");b.common.alreadyread=!0}function q(a){b.alert.alert=c(a,"alert-pattern");b.alert.alertgroup=c(a,"alert-group-pattern");b.alert.alert_news_article=c(a,"alert-news-article");b.alert.alert_candlesticks_patterns=c(a,"alert-candlesticks-patterns");b.alert.alert_dividends=c(a,"alert-dividends");b.alert.alert_economic=c(a,
"alert-economic");b.alert.alert_splitstock=c(a,"alert-splitstock");b.alert.alert_investing=c(a,"alert-investing");b.alert.alreadyread=!0}function r(a){b.msg.alert=c(a,"msg-pattern");b.msg.alreadyread=!0}function s(a){b.community.form=c(a,"comminity-form");b.community.alreadyread=!0}function t(a){b.draw.fan=c(a,"fan-pattern");b.draw.square_trendline=c(a,"square-trendline-pattern");b.draw.square_levels=c(a,"square-levels-pattern");b.draw.fiboarc_trendline=c(a,"fiboarc-trendline-pattern");b.draw.fiboarc_levels=
c(a,"fiboarc-levels-pattern");b.draw.fibo_trendline=c(a,"fibo-trendline-pattern");b.draw.fibo_levels=c(a,"fibo-levels-pattern");b.draw.fork_trendline=c(a,"fork-trendline-pattern");b.draw.fork_levels=c(a,"fork-levels-pattern");b.draw.linereg_trendline=c(a,"linereg-trendline-pattern");b.draw.linereg_levels=c(a,"linereg-levels-pattern");b.draw.coordinates=c(a,"coordinates_pattern");b.draw.border_style=c(a,"border-style-pattern");b.draw.shapeform=c(a,"shape-pattern-form");b.draw.fiboform=c(a,"fibo-pattern-form");
b.draw.forkform=c(a,"fork-pattern-form");b.draw.circlelineform=c(a,"circleline-pattern-form");b.draw.timezoneform=c(a,"timezone-pattern-form");b.draw.squareform=c(a,"square-pattern-form");b.draw.linearregform=c(a,"linearreg-pattern-form");b.draw.lineform=c(a,"line-pattern-form");b.draw.linearregform=c(a,"linearreg-pattern-form");b.draw.parallelform=c(a,"parallel-pattern-form");b.draw.textform=c(a,"text-pattern-form");b.draw.vlineform=c(a,"vline-pattern-form");b.draw.fanform=c(a,"fan-pattern-form");
b.draw.alreadyread=!0}function u(a){b.header.containter=c(a,"header-container");b.header.searchbutton=c(a,"header-searchbutton");b.header.symboltitle=c(a,"header-symboltitle");b.header.symbolsearch=c(a,"header-symbolsearch");b.header.search_output_list=c(a,"template-search-output-list");b.header.search_main_properties=c(a,"template-search-main-properties");b.header.search_properties_tabs_label=c(a,"template-search-properties-tabs-label");b.header.search_notfound=c(a,"template-search-notfound");b.header.search_properties_filter_values=
c(a,"template-search-properties-filter-values");b.header.timeframe=c(a,"header-timeframe");b.header.lastupdate=c(a,"header-lastupdate");b.header.communic=c(a,"header-communic");b.header.htmlcontainer=c(a,"header-htmlcontainer");b.header.toolbar=c(a,"header-toolbar");b.header.toolbar=b.header.toolbar.replace(/%=""/g,"%")}function v(a){b.indicators.panelsform=c(a,"panels-container");b.indicators.panelstr=c(a,"panels-tr-container");b.indicators.indicatorform=c(a,"indicator-container");b.indicators.indicator_style=
c(a,"indicator-style");b.indicators.indicator_level=c(a,"indicator-level");b.indicators.indicator_source=c(a,"indicator-source");b.indicators.indicator_style_default=c(a,"indicator-style-default");b.indicators.indicator_style_columns=c(a,"indicator-style-columns");b.indicators.indicatorsform=c(a,"indicators-form-pattern");b.indicators.indicatorsform_row=c(a,"indicarors-form-row-pattern");b.indicators.indicatorsform_favorites_row=c(a,"indicators-form-favorites-row-pattern");b.indicators.indicator_button_settings=
c(a,"indicators-button-settings-pattern");b.indicators.alreadyread=1}function w(a){b.menu.containter=c(a,"menu-container");b.menu.menu_item=c(a,"menu-item");b.menu.menu_item_group=c(a,"menu-item-group");b.menu.menu_timeframe=c(a,"menu-timeframe");b.menu.menu_timeframe_text=c(a,"menu-timeframe-text");b.menu.menu_majors=c(a,"menu-majors");b.menu.menu_majors2=c(a,"menu-majors2");b.menu.menu_charttype=c(a,"menu-charttype");b.menu.menu_indicators=c(a,"menu-indicators");b.menu.menu_compares=c(a,"menu-compares");
b.menu.menu_more=c(a,"menu-more");b.menu.menu_localizations=c(a,"menu-localizations");b.menu.menu_item_image=c(a,"menu-item-image");b.menu.menu_more_item=c(a,"menu-more-item");b.menu.menu_more_item_group=c(a,"menu-more-item-group");b.menu.alreadyread=!0}function p(a){b.panels.containter=c(a,"panel_containe");b.panels.price=c(a,"panel_price");b.panels.study=c(a,"panel_study");b.panels.splitter=c(a,"panel_splitter");b.panels.legend_price=c(a,"legend_price");b.panels.legend_study=c(a,"legend_study");
b.panels.legend_compare=c(a,"legend_compare");b.panels.legend_plugin=c(a,"legend_plugin");b.panels.signal=c(a,"signal");b.panels.htmlcontainer=c(a,"htmlcontainer");b.panels.toolbar=c(a,"panels-toolbar");b.panels.legend_signaltc=c(a,"legend_signaltc");b.panels.floatingpanel_container=c(a,"floatingpanel-container");b.panels.price=b.panels.price.replace(/%=""/g,"%");b.panels.study=b.panels.study.replace(/%=""/g,"%")}function x(a){b.props.form=c(a,"propery-form");b.props.priceonlyform=c(a,"priceonly-form");
b.props.alreadyread=!0}function y(a){b.systems.systemsform=c(a,"systems-form");b.systems.systemssaveform=c(a,"systemssave-form");b.systems.systems_list_open=c(a,"system-systems-list-open");b.systems.systems_list_save=c(a,"system-systems-list-save");b.systems.alreadyread=!0}function z(a){b.ta.addform=c(a,"ta_add_form");b.ta.comparesform=c(a,"ta_compares_form");b.ta.detailsform=c(a,"ta_details_form");b.ta.findsymbol=c(a,"find-symbol-pattern");b.ta.majorsfavorites=c(a,"majors-favorites-pattern");b.ta.majorsfavorites=
c(a,"majors-favorites-pattern");b.ta.comparefavorites=c(a,"compare-favorites-pattern");b.ta.alreadyread=!0}function A(a){b.toolbar.containter=c(a,"toolbar_container");b.toolbar.toolbar=c(a,"toolbar_toolbar");b.toolbar.button_timeframe=c(a,"toolbar-button-timeframe");b.toolbar.button_timeframe_text=c(a,"toolbar-button-timeframe-text");b.toolbar.space=c(a,"toolbar-space");b.toolbar.button_charttype=c(a,"toolbar-button-charttype");b.toolbar.caption=c(a,"toolbar-caption");b.toolbar.button=c(a,"toolbar-button");
b.toolbar.button_custom=c(a,"toolbar-button-custom");b.toolbar.toolbar_more=c(a,"toolbar-more");b.toolbar.toolbar_more_item=c(a,"toolbar-more-item");b.toolbar.toolbar_button_group=c(a,"toolbar-button-group");b.toolbar.item=c(a,"toolbar-item");b.toolbar.item_noicon=c(a,"toolbar-item-noicon");b.toolbar.toolbar_more_item_timeframe_text=c(a,"toolbar-more-item-timeframe-text");b.toolbar.toolbar_button_group_timeframe_text=c(a,"toolbar-button-group-timeframe-text");b.toolbar.toolbar_button_group_text=c(a,
"toolbar-button-group-text");b.toolbar.button_timeframe_inner=c(a,"toolbar-button-timeframe-inner");b.toolbar.button_timeframe_text_inner=c(a,"toolbar-button-timeframe-text-inner");b.toolbar.button_timeframe_more_inner=c(a,"toolbar-button-timeframe-more-inner");b.toolbar.replace_icon_source=c(a,"toolbar-replace-icon-source").replace(/\n/g,"").trim();b.toolbar.toolbar_replace_icon_target=c(a,"toolbar-replace-icon-target");b.toolbar.item_container=c(a,"toolbar-item-container");b.toolbar.group_corner=
c(a,"toolbar-group-corner")}function B(a){b.zoom.containter=c(a,"zoom-container");b.zoom.chart_container=c(a,"zoom-chart-container");b.zoom.slider=c(a,"zoom-slider");b.zoom.date_range=c(a,"zoom-date-range");b.zoom.toolbox=c(a,"zoom-toolbox-pattern")}function C(a){b.plugs.cspattern=c(a,"cspattern-container");b.plugs.fibonacci=c(a,"fibonacci-container");b.plugs.pattern=c(a,"pattern-container");b.plugs.pivot=c(a,"pivot-container");b.plugs.delim=c(a,"delim-container");b.plugs.top=c(a,"top-container");
b.plugs.topitem=c(a,"topitem-container")}function D(a){b.signals.container=c(a,"signal-container");b.signals.info_mesg=c(a,"signal-info-message");b.signals.alreadyread=!0}function L(){var a=$.Deferred();$.when(g("/ChartUI/gui/patterns/alert.patterns.htm","alert"),g("/ChartUI/gui/patterns/community.patterns.htm","community"),g("/ChartUI/gui/patterns/draw.patterns.htm","draw"),g("/ChartUI/gui/patterns/header.patterns.htm","header"),g("/ChartUI/gui/patterns/indicators.patterns.htm","indicators"),g("/ChartUI/gui/patterns/menu.patterns.htm",
"menu"),g("/ChartUI/gui/patterns/msg.patterns.htm","msg"),g("/ChartUI/gui/patterns/panel.patterns.htm","panel"),g("/ChartUI/gui/patterns/props.patterns.htm","props"),g("/ChartUI/gui/patterns/systems.patterns.htm","systems"),g("/ChartUI/gui/patterns/ta.patterns.htm","ta"),g("/ChartUI/gui/patterns/toolbar.patterns.htm","toolbar"),g("/ChartUI/gui/patterns/trade.patterns.htm","trade"),g("/ChartUI/gui/patterns/zoom.patterns.htm","zoom"),g("/ChartUI/gui/patterns/plugs.patterns.htm","plugs"),g("/ChartUI/gui/patterns/common.patterns.htm",
"common"),g("/ChartUI/gui/patterns/signals.patterns.htm","signals")).done(function(){a.resolve()});return a.promise()}function g(a,b){var c=!1==f.guiinit.cache?"?"+f.version.gui.name+(new Date).getTime():"?"+f.version.gui.name,c=f.guiinit.rootpath+a+c,d=$.Deferred();if(f.navigator.XMLHttpRequest()){var e=new XMLHttpRequest;e.open("get",c);e.onload=function(){var a=e.responseText;F(a,b);d.resolve(a)};e.send()}else $.ajax({type:"GET",async:!0,dataType:"html",url:c}).done(function(a){F(a,b);d.resolve(a)});
return d.promise()}function F(a,d){switch(d){case "alert":q(a);e.debug(d,"pattern   after read");break;case "msg":r(a);e.debug(d,"pattern   after read");break;case "community":s(a);e.debug(d,"pattern   after read");break;case "draw":t(a);e.debug(d,"pattern   after read");break;case "header":u(a);e.debug(d,"pattern   after read");break;case "indicators":v(a);e.debug(d,"pattern   after read");break;case "menu":w(a);e.debug(d,"pattern   after read");break;case "panel":p(a);e.debug(d,"pattern   after read");
break;case "props":x(a);e.debug(d,"pattern   after read");break;case "systems":y(a);e.debug(d,"pattern   after read");break;case "ta":z(a);e.debug(d,"pattern   after read");break;case "toolbar":A(a);e.debug(d,"pattern   after read");break;case "trade":b.trade.form=c(a,"trade_form");e.debug(d,"pattern   after read");break;case "zoom":B(a);e.debug(d,"pattern   after read");break;case "plugs":C(a);break;case "common":E(a);break;case "signals":D(a)}}function c(a,b){var c="",d=a.indexOf("<"+b+">"),e=("<"+
b+">").length,f=a.indexOf("</"+b+">");-1!=d&&-1!=f&&f>d+e&&(c=a.substring(d+e,f));return c}var f=G,d={};f.patterns=d;var e=f.api.debug.getLogger("prochart.gui.patterns");d.status={alredyloadded:!1};d.gui={initPatterns:function(){var a=$.Deferred();!0==f.apiinit.patterncombine?$.when(J()).done(function(){e.debug(b);a.resolve()}):$.when(L()).done(function(){e.debug(b);a.resolve()});return a.promise()},initCustomPanelPatterns:function(){var a=$.Deferred();$.when(K()).done(function(){e.debug(b);a.resolve()});
return a.promise()}};Object.defineProperty(d.gui,"returnPatterByPath",{value:function(a){if(a){var b=null,c=f.patterns;a=a.split(".");for(var d=0;d<a.length;d++)if(b=c[a[d]])c=b;else return null;return b}},writable:!1,configurable:!1});Object.defineProperty(d.gui,"patterns",{get:function(){return b}});Object.defineProperty(d,"alert",{get:function(){return b.alert},set:function(a){b.alert=a}});Object.defineProperty(d,"chart",{get:function(){return b.chart},set:function(a){b.chart=a}});Object.defineProperty(d,
"community",{get:function(){return b.community},set:function(a){b.community=a}});Object.defineProperty(d,"draw",{get:function(){return b.draw},set:function(a){b.draw=a}});Object.defineProperty(d,"header",{get:function(){return b.header},set:function(a){b.menu=a}});Object.defineProperty(d,"indicators",{get:function(){return b.indicators},set:function(a){b.indicators=a}});Object.defineProperty(d,"menu",{get:function(){return b.menu},set:function(a){b.menu=a}});Object.defineProperty(d,"msg",{get:function(){return b.msg},
set:function(a){b.msg=a}});Object.defineProperty(d,"panels",{get:function(){return b.panels},set:function(a){b.panels=a}});Object.defineProperty(d,"props",{get:function(){return b.props},set:function(a){b.props=a}});Object.defineProperty(d,"signals",{get:function(){return b.signals},set:function(a){b.signals=a}});Object.defineProperty(d,"systems",{get:function(){return b.systems},set:function(a){b.systems=a}});Object.defineProperty(d,"ta",{get:function(){return b.ta},set:function(a){b.ta=a}});Object.defineProperty(d,
"toolbar",{get:function(){return b.toolbar},set:function(a){b.toolbar=a}});Object.defineProperty(d,"trade",{get:function(){return b.trade},set:function(a){b.trade=a}});Object.defineProperty(d,"zoom",{get:function(){return b.zoom},set:function(a){b.zoom=a}});Object.defineProperty(d,"layout",{get:function(){return b.layout},set:function(a){b.layout=a}});Object.defineProperty(d,"plugs",{get:function(){return b.plugs},set:function(a){b.plugs=a}});Object.defineProperty(d,"common",{get:function(){return b.common},
set:function(a){b.common=a}});Object.defineProperty(d,"allpatterns",{get:function(){return jQuery.extend({},b)},set:function(a){b=jQuery.extend({},a);d.status.alredyloadded=!0}});Object.defineProperty(d,"setPatterns",{value:function(a){var b=$.Deferred(),c=a.url;if(f.navigator.XMLHttpRequest()){var d=new XMLHttpRequest;d.paatternParams=a;d.open("get",c);d.onload=function(){b.resolve(d.responseText)};d.send()}else $.ajax({type:"GET",async:!0,dataType:"html",paatternParams:a,url:c}).done(function(a){H(this.paatternParams,
a);b.resolve(a)});return b.promise()},writable:!1,configurable:!1});var b={alert:{},chart:{},community:{},draw:{},header:{},indicators:{},menu:{},msg:{},panels:{},props:{},signals:{},systems:{},ta:{},toolbar:{},trade:{},zoom:{},layout:{},plugs:{},common:{}};Function.prototype.extractComment=function(){var a=this.toString(),b=a.indexOf("/*!"),c=a.lastIndexOf("*/");return a.slice(b+3,-(a.length-c))};return d};
...
function ProChart_InitCommonUtils(v){function w(a,c){for(var e="position z-index pointer-events more left right top bottom width height view".split(" "),b="",d=Object.keys(a),f=0;f<d.length;f++){var h=d[f],m;a:{for(m=0;m<e.length;m++)if(e[m]==h){m=!0;break a}m=!1}m||(b=b+h+":"+a[h]+"; ")}"undefined"!=typeof a.position&&(b=b+"position:"+a.position+"; ");"undefined"!=typeof a["z-index"]&&(b=b+"z-index:"+a["z-index"]+"; ");"undefined"!=typeof a["pointer-events"]&&(b=b+"pointer-events:"+a["pointer-events"]+
"; ");"undefined"!=typeof a.more&&(b+=a.more);"undefined"!=typeof a.left&&(b=b+"left :"+a.left+(isNaN(a.left)?"":c)+"; ");"undefined"!=typeof a.right&&(b=b+"right :"+a.right+(isNaN(a.right)?"":c)+"; ");"undefined"!=typeof a.top&&(b=b+"top :"+a.top+(isNaN(a.top)?"":c)+"; ");"undefined"!=typeof a.bottom&&(b=b+"bottom :"+a.bottom+(isNaN(a.bottom)?"":c)+"; ");"undefined"!=typeof a.width&&(b=b+"width :"+a.width+(isNaN(a.width)?"":c)+"; ");"undefined"!=typeof a.height&&(b=b+"height :"+a.height+(isNaN(a.height)?
"":c)+"; ");"undefined"!=typeof a.view&&!0!=a.view&&(b+="display : none; ");return b}function x(a){if(null==a||0==a.trim().length)return[0,0,0];a=a.trim().toLowerCase();var c=a.match(/^#([0-9a-f]{3})$/i);if(c)return c=c[1],[17*parseInt(c.charAt(0),16),17*parseInt(c.charAt(1),16),17*parseInt(c.charAt(2),16),1];if(c=a.match(/^#([0-9a-f]{6})$/i))return c=c[1],[parseInt(c.substr(0,2),16),parseInt(c.substr(2,2),16),parseInt(c.substr(4,2),16),1];if(c=a.match(/^rgba\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+.*\d*)\s*\)$/i)||
a.match(/^rgba\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)$/i))return[c[1],c[2],c[3],void 0===c[4]?1:c[4]];if(c=a.match(/^rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)$/i))return[c[1],c[2],c[3],1];if(0==a.indexOf("hsl")){c=a;"string"==typeof c&&(c=c.match(/(\d+(\.\d+)?)/g));a=c[0]/360;var e=c[1]/100,b=c[2]/100,c=void 0===c[3]?1:c[3],d,f;if(0==e)d=Math.round(255*b),f=[d,d,d,c];else{e=.5>b?b*(1+e):b+e-b*e;b=2*b-e;f=[0,0,0];for(var h=0;3>h;h++)d=a+1/3*-(h-1),0>d&&d++,1<d&&d--,d=1>6*d?b+6*(e-b)*d:1>2*d?
e:2>3*d?b+(e-b)*(2/3-d)*6:b,f[h]=Math.round(255*d)}f.push(c);return f}return[0,0,0]}function y(a,c){var e=c.split(".");return 1==e.length?a[e[0]]:"undefined"!=typeof a[e[0]]?y(a[e[0]],e.slice(1).join(".")):null}function z(a,c,e){c=c.split(".");1==c.length&&(a[c[0]]=e);"undefined"!=typeof a[c[0]]&&z(a[c[0]],c.slice(1).join("."),e)}(function(a){a.fn.hasScrollBar=function(){return this.get(0)?this.get(0).scrollHeight>this.innerHeight():!1}})(jQuery);(function(a){a.fn.widthScrollBar=function(){return this.get(0)?
this.get(0).offsetWidth-this.get(0).clientWidth:20}})(jQuery);var u={};v.commonutils=u;u.func={parseColorString:x,getKeybyPath:function(a,c){var e,b,d=0,f;a=a||window;for(b=(e=c&&c.split("."))&&e.length;d<b&&a;)f=e[d],a="function"==typeof a.get?a.get(f):a[f],d++;d<b&&(a=null);return a},returnShortUniqID:function(){return Math.uuid(8)},intersection_difference:function(a,c){var e=[],b=[];a.map(function(a){0<=c.indexOf(a)?e.push(a):b.push(a)});return{res1:e,res2:b}},valueForKey:y,updateValueByKey:z,
sleep:function(a){for(var c=(new Date).getTime();(new Date).getTime()<c+a;);},sleep2:function(a){for(var c=(new Date).getTime(),e=0;1E7>e&&!((new Date).getTime()-c>a);e++);},loadCSS:function(a){var c=$("<link>");$("head").append(c);c.attr({rel:"stylesheet",type:"text/css",href:a})},initColor:function(a,c,e,b){"undefined"==typeof b&&(b=!1);e=[];b&&e.push("rgba(0, 0, 0, 0);{rgba(0, 0, 0, 0.1);{rgba(0, 0, 0, 0.2);{rgba(0, 0, 0, 0.3);{rgba(0, 0, 0, 0.4);{rgba(0, 0, 0, 0.5);{rgba(0, 0, 0, 0.6);{rgba(0, 0, 0, 0.7);{rgba(0, 0, 0, 0.8);{rgba(0, 0, 0, 0.9);".split("{"));
e.push("rgb(0, 0, 0);{rgb(66, 66, 66);{rgb(101, 101, 101);{rgb(152, 152, 152);{rgb(182, 182, 182);{rgb(203, 203, 203);{rgb(216, 216, 216);{rgb(238, 238, 238);{rgb(242, 242, 242);{rgb(255, 255, 255);".split("{"));e.push("rgb(151, 0, 0);{rgb(255, 0, 0);{rgb(255, 152, 0);{rgb(255, 255, 0);{rgb(0, 255, 0);{rgb(0, 255, 255);{rgb(73, 133, 231);{rgb(0, 0, 255);{rgb(152, 0, 255);{rgb(255, 0, 255);".split("{"));e.push("rgb(230, 184, 175);{rgb(244, 204, 204);{rgb(252, 229, 205);{rgb(255, 242, 204);{rgb(217, 234, 211);{rgb(208, 224, 227);{rgb(201, 218, 248);{rgb(207, 226, 243);{rgb(217, 210, 233);{rgb(234, 209, 220);".split("{"));
e.push("rgb(221, 126, 107);{rgb(234, 153, 153);{rgb(249, 203, 156);{rgb(255, 229, 153);{rgb(182, 215, 168);{rgb(162, 196, 201);{rgb(164, 194, 244);{rgb(159, 197, 232);{rgb(180, 167, 214);{rgb(213, 166, 189);".split("{"));e.push("rgb(204, 65, 37);{rgb(224, 102, 102);{rgb(246, 178, 107);{rgb(255, 217, 102);{rgb(147, 196, 125);{rgb(118, 165, 175);{rgb(109, 158, 235);{rgb(111, 168, 220);{rgb(142, 124, 195);{rgb(194, 123, 160);".split("{"));e.push("rgb(166, 28, 0);{rgb(204, 0, 0);{rgb(230, 145, 56);{rgb(241, 194, 50);{rgb(106, 168, 79);{rgb(69, 129, 142);{rgb(60, 120, 216);{rgb(61, 133, 198);{rgb(103, 78, 167);{rgb(166, 77, 121);".split("{"));
e.push("rgb(133, 32, 12);{rgb(153, 0, 0);{rgb(180, 95, 6);{rgb(191, 144, 0);{rgb(56, 118, 29);{rgb(19, 79, 92);{rgb(17, 85, 204);{rgb(11, 83, 148);{rgb(53, 28, 117);{rgb(116, 27, 71);".split("{"));e.push("rgb(91, 15, 0);{rgb(102, 0, 0);{rgb(120, 63, 4);{rgb(127, 96, 0);{rgb(39, 78, 19);{rgb(12, 52, 61);{rgb(28, 69, 135);{rgb(7, 55, 99);{rgb(32, 18, 77);{rgb(76, 17, 48);".split("{"));$(a).spectrum({color:c,showAlpha:b,showPalette:!0,showPaletteOnly:!1,clickoutFiresChange:!1,showButtons:!1,palette:e})},
toBool:function(a,c){if("undefined"==typeof a)return c;switch(a){case !0:case "true":return!0;case !1:case "false":return!1;default:return c}},getBlockStyle:function(a,c){var e=w(a,c);return""!=e?"style='"+e+"'":""},getPartStyle:w,LightenDarkenColor:function(a,c,e){try{var b=x(a),d=b[0],f=b[1],h=b[2];if(e)if(128<=(299*d+587*f+114*h)/1E3){if(0<c)return a}else if(0>c)return a;var d=parseInt(d*(100+c)/100),f=parseInt(f*(100+c)/100),h=parseInt(h*(100+c)/100),d=255>d?d:255,f=255>f?f:255,h=255>h?h:255,
m=1==d.toString(16).length?"0"+d.toString(16):d.toString(16),r=1==f.toString(16).length?"0"+f.toString(16):f.toString(16),s=1==h.toString(16).length?"0"+h.toString(16):h.toString(16);return"#"+m+r+s}catch(t){return a}},detectmob:function(){if(typeof v.events.onDetectMobileMode==typeof Function)return v.events.onDetectMobileMode();var a=!0;return(a=$(window).width()>$(window).height()?!0:!1)?800>=window.innerWidth&&600>=window.innerHeight?!0:!1:800>=window.innerHeight&&600>=window.innerWidth?!0:!1},
SHA1:function(a){function c(a,b){return a<<b|a>>>32-b}function e(a){var b="",c,d;for(c=7;0<=c;c--)d=a>>>4*c&15,b+=d.toString(16);return b}var b,d,f=Array(80),h=1732584193,m=4023233417,r=2562383102,s=271733878,t=3285377520,g,k,l,n,p;a=function(a){a=a.replace(/\r\n/g,"\n");for(var b="",c=0;c<a.length;c++){var d=a.charCodeAt(c);128>d?b+=String.fromCharCode(d):(127<d&&2048>d?b+=String.fromCharCode(d>>6|192):(b+=String.fromCharCode(d>>12|224),b+=String.fromCharCode(d>>6&63|128)),b+=String.fromCharCode(d&
63|128))}return b}(a);g=a.length;var q=[];for(b=0;b<g-3;b+=4)d=a.charCodeAt(b)<<24|a.charCodeAt(b+1)<<16|a.charCodeAt(b+2)<<8|a.charCodeAt(b+3),q.push(d);switch(g%4){case 0:b=2147483648;break;case 1:b=a.charCodeAt(g-1)<<24|8388608;break;case 2:b=a.charCodeAt(g-2)<<24|a.charCodeAt(g-1)<<16|32768;break;case 3:b=a.charCodeAt(g-3)<<24|a.charCodeAt(g-2)<<16|a.charCodeAt(g-1)<<8|128}for(q.push(b);14!=q.length%16;)q.push(0);q.push(g>>>29);q.push(g<<3&4294967295);for(a=0;a<q.length;a+=16){for(b=0;16>b;b++)f[b]=
q[a+b];for(b=16;79>=b;b++)f[b]=c(f[b-3]^f[b-8]^f[b-14]^f[b-16],1);d=h;g=m;k=r;l=s;n=t;for(b=0;19>=b;b++)p=c(d,5)+(g&k|~g&l)+n+f[b]+1518500249&4294967295,n=l,l=k,k=c(g,30),g=d,d=p;for(b=20;39>=b;b++)p=c(d,5)+(g^k^l)+n+f[b]+1859775393&4294967295,n=l,l=k,k=c(g,30),g=d,d=p;for(b=40;59>=b;b++)p=c(d,5)+(g&k|g&l|k&l)+n+f[b]+2400959708&4294967295,n=l,l=k,k=c(g,30),g=d,d=p;for(b=60;79>=b;b++)p=c(d,5)+(g^k^l)+n+f[b]+3395469782&4294967295,n=l,l=k,k=c(g,30),g=d,d=p;h=h+d&4294967295;m=m+g&4294967295;r=r+k&4294967295;
s=s+l&4294967295;t=t+n&4294967295}p=e(h)+e(m)+e(r)+e(s)+e(t);return p.toLowerCase()}};Object.defineProperty(u.func,"pub",{value:function(a,c){for(a=String(a);a.length<(c||2);)a="0"+a;return a},writable:!1,configurable:!1});(function(){var a="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("");Math.uuid=function(c,e){var b=[],d;e=e||a.length;if(c)for(d=0;d<c;d++)b[d]=a[0|Math.random()*e];else{var f;b[8]=b[13]=b[18]=b[23]="-";b[14]="4";for(d=0;36>d;d++)b[d]||(f=0|16*Math.random(),
b[d]=a[19==d?f&3|8:f])}return b.join("")};Math.uuidFast=function(){for(var c=Array(36),e=0,b,d=0;36>d;d++)8==d||13==d||18==d||23==d?c[d]="-":14==d?c[d]="4":(2>=e&&(e=33554432+16777216*Math.random()|0),b=e&15,e>>=4,c[d]=a[19==d?b&3|8:b]);return c.join("")};Math.uuidCompact=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var e=16*Math.random()|0;return("x"==a?e:e&3|8).toString(16)})}})();return u};
...
function ProChart_InitFloatingPanels(n){function p(a,c){function b(a){e.chart.LockMouseEvents(!0);a=a||window.event;a.preventDefault();h=a.clientX;k=a.clientY;e.events.multicallback.runCallback(c,{status:"started"});document.onmouseup=d;document.onmousemove=g}function g(b){b=b||window.event;b.preventDefault();l=h-b.clientX;m=k-b.clientY;h=b.clientX;k=b.clientY;a.style.top=a.offsetTop-m+"px";a.style.left=a.offsetLeft-l+"px";a.style.bottom="auto";a.style.right="auto";e.events.multicallback.runCallback(c,
{status:"resizing",position:{top:a.style.top,left:a.style.left,bottom:a.style.bottom,right:a.style.right}})}function d(){document.onmouseup=null;document.onmousemove=null;e.chart.LockMouseEvents(!1);e.events.multicallback.runCallback(c,{status:"completed"})}var l=0,m=0,h=0,k=0;document.getElementById(a.id+"left")&&(document.getElementById(a.id+"left").onmousedown=b);document.getElementById(a.id+"right")&&(document.getElementById(a.id+"right").onmousedown=b)}var e=n,b={};e.floatingpanels=b;var q=/=""/g;
Object.defineProperty(b,"gui",{value:{},writable:!1,configurable:!1});Object.defineProperty(b.gui,"add",{value:function(a){for(var c=b.gui.panels.length-1;0<=c;c--)if(b.gui.panels[c].type==a.type)return $("#"+b.gui.panels[c].guid).css("display","flex"),b.gui.panels[c].guid;$.prochartcache.get(e.init.chartcontainer);$.prochartcache.get("#"+e.currenlayout.layout.guiniid);c=$.prochartcache.get(e.parent,".htmlchart ");if(e.patterns.panels.floatingpanel_container){var f=e.commonutils.func.returnShortUniqID(),
g=e.toolbaradvobj.gui.insertToolbar(a),d="";a.position&&(a.position.top&&(d=d+"top:"+a.position.top+";"),a.position.left&&(d=d+"left:"+a.position.left+";"),a.position.right&&(d=d+"right:"+a.position.right+";"),a.position.bottom&&(d=d+"bottom:"+a.position.bottom+";"),d&&(d="style='"+d+"'"));d=e.patterns.panels.floatingpanel_container.replace(q,"").replace(/%style%/g,d).replace(/%id%/g,f).replace(/%idleft%/g,f+"left").replace(/%idright%/g,f+"right").replace(/%css%/g,a.type).replace(/%html%/g,g.returnstring);
c.prepend(d);e.toolbaradvobj.gui.insertToolbarEvents(a,g.additionaEvents);b.gui.panels.push({type:a.type,guid:f});p(document.getElementById(f),a.dragcallback);return f}},writable:!1,configurable:!1});Object.defineProperty(b.gui,"del",{value:function(a){for(var c=b.gui.panels.length-1;0<=c;c--)b.gui.panels[c].type==a.type&&($("#"+b.gui.panels[c].guid).remove(),b.gui.panels.splice(c,1))},writable:!1,configurable:!1});Object.defineProperty(b.gui,"hide",{value:function(a){for(var c=b.gui.panels.length-
1;0<=c;c--)b.gui.panels[c].type==a.type&&$("#"+b.gui.panels[c].guid).css("display","none")},writable:!1,configurable:!1});Object.defineProperty(b.gui,"show",{value:function(a){for(var c=b.gui.panels.length-1;0<=c;c--)b.gui.panels[c].type==a.type&&$("#"+b.gui.panels[c].guid).css("display","flex")},writable:!1,configurable:!1});Object.defineProperty(b.gui,"panels",{value:[],writable:!0,configurable:!1});return b};
