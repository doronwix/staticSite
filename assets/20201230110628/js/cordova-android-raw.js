    ...
    define("cordova/pluginloader", function (require, exports, module) {
        ...
        */
        ...
        exports.load = function (callback) {
            // disable this code because cordova.js never found
            /*
            ...
            if (pathPrefix === null) {
                ...
                console.log('Found cordova.js:' + pathPrefix);
            }
            */
            /*
                The next 2 lines of code are a replacement for original cordova code:
                Original code was loading cordova_plugins.js file and after that the code inside each plug-in independent file.
                We add the file code inside of this file.
            */
            var pathPrefix = '';
...
/**
 * 
 * AppRight API for Javascript
 *
 */

var iOSUserAgents = ['ipad', 'iphone', 'ipod'];

// added to init. plugin when cordova is ready on device
document.addEventListener("deviceready", onDeviceReady, false);
function onDeviceReady() {
    if (AppRight.isSupportedDevice()) {
...
var AppRight = {
    isSupportedDevice: function () {
        return AppRight.isAndroidDevice() || AppRight.isiOSDevice();
    },
    ...
    sendNow: function () {
        if (AppRight.isSupportedDevice())
            cordova.exec(AppRight.success, AppRight.failure, "AppRightPlugin", "sendNow", []);
    },

    reportException: function (exception) {
        if (AppRight.isSupportedDevice())
            cordova.exec(AppRight.success, AppRight.failure, "AppRightPlugin", "reportException", [exception.message, exception.stack, exception.name]);
    },
    ...
    reportBug: function (msg) {
        if (AppRight.isSupportedDevice()) {
            try {
                ...
                cordova.exec(AppRight.success, AppRight.failure, "AppRightPlugin", "reportBug", [msg, e.stack]);
            }
        }
    },
    ...
    addMarker: function (msg) {
        if (AppRight.isSupportedDevice())
            try {
                ...
                cordova.exec(AppRight.success, AppRight.failure, "AppRightPlugin", "addMarker", [msg, e.stack]);
            }
    }
};
...
window.onerror = function (msg, url, line) {
    if (AppRight.isSupportedDevice()) {
        cordova.exec(AppRight.success, AppRight.failure, "AppRightPlugin", "reportJsError", [msg, url, line]);
    }
};
//# sourceMappingURL=cordova-android-raw.js.map