    ...
    define("cordova", function (require, exports, module) {
        ...
        cordova.define('cordova/plugin_list', function (require, exports, module) {
            ...
            // TOP OF METADATA
            {
                ...
                "cordova-plugin-fingerprint-aio": "1.3.6",
    ...
    define("cordova/pluginloader", function (require, exports, module) {
        ...
        */
        ...
        exports.load = function (callback) {
            // test eyal - original code
            /*
            var pathPrefix = findCordovaPath();
            if (pathPrefix === null) {
                console.log('Eyal2 Could not find cordova.js script tag. Plugin loading may fail.');
                pathPrefix = '';
            }
...
cordova.define("cordova-plugin-fingerprint-aio.Fingerprint", function(require, exports, module) {
	...
	Fingerprint.prototype.IsDeviceSupportFingerprint = function (successCallback, errorCallback) {
	  cordova.exec(
	    successCallback,
	    errorCallback,
	    "Fingerprint",
	    "IsDeviceSupportFingerprint",
	    [{}]
	  );
	};

	Fingerprint.prototype.SetToken = function (params, successCallback, errorCallback) {
	  cordova.exec(
	    successCallback,
	    errorCallback,
	    "Fingerprint",
	...
	Fingerprint.prototype.GetToken = function (successCallback, errorCallback) {
	  cordova.exec(
	    successCallback,
	    errorCallback,
	    "Fingerprint",
	...
	Fingerprint.prototype.DeleteToken = function (successCallback, errorCallback) {
	  cordova.exec(
	    successCallback,
	    errorCallback,
	    "Fingerprint",
	...
	Fingerprint.prototype.scanCancel = function (successCallback, errorCallback) {
	  cordova.exec(
	    successCallback,
	    errorCallback,
	    "Fingerprint",
...
//# sourceMappingURL=cordova-android-raw-5.1.1.js.map