...
define('userflow/UserFlowBroker6',
    [
        'require',
    ...
    function (require) {
        ...
        function computeFlow() {
            ...
            if (customer.prop.isSeamless) { //#1
                ...
                if (AMLStatus !== eAMLStatus.Restricted && !commonFlow.isFraud() && commonFlow.isOnlineTrading()) { // #4.TRUE
                    if (CDDStatus !== eCDDStatus.NotComplete &&
                        foundInList(KYCStatus, [eKYCStatus.Passed, eKYCStatus.FailedAware, eKYCStatus.NotRequired, eKYCStatus.GaveUp])) {  // #4.TRUE.1
                        canDepositFlow();
            ...
            // Is Quiz hidden
            if ((SMState.KycStatus() !== eKYCStatus.Failed && SMState.KycStatus() !== eKYCStatus.FailedAware)
                || (SMState.IsQuizPassed() === false && SMState.KycStatus() !== eKYCStatus.Failed)
                || SMState.KycReviewStatus() === eKYCReviewStatus.Unsuitable) {
            ...
            if (generalInfoComplete && quizzPassed && AMLStatus === eAMLStatus.Approved) {
