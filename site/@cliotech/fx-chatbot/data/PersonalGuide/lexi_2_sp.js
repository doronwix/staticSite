[
   {
    "emilyMessage": {
      "title": "Hola, soy Lexi, tu guía personal,",
    ...
    "messages": [
      ...
      ],
      {
        "choices": [
          {
            "goto": 11,
            "postback": "Dame el tour completo<br> (10 minutos)",
            "text": "Dame el tour completo<br> (10 minutos)",
            "type": "button",
            "id": 1
          },
          {
  ...
  },
  {
    "messages": [
      [
        "Recuerda, <b>siempre puedes retirar tu depósito, sin cargos, sin preguntas, 100% libre de riesgos.</b> No pierdas esta excepcional oportunidad de capitalizar tu inversión.",
        5
      ],
      "...",
      {
    ...
    "messages": [
      {
        "choices": [
          ...
          },
          {
            ...
            "postback": "¿No estás 100% seguro? Realiza un tour por <br>la plataforma",
            "text": "¿No estás 100% seguro? Realiza un tour por <br>la plataforma",
            "type": "buton",
            "id": 1001
          }
        ],
    ...
    "messages": [
      {
        "choices": [
          ...
          },
          {
            ...
            "postback": "¿No estás 100% seguro? Realiza un tour por la plataforma",
            "text": "¿No estás 100% seguro? Realiza un tour por la plataforma",
            "type": "buton",
            "id": 1001
          }
        ],
